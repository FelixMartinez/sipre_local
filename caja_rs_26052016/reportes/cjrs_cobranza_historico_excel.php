...
while ($row = mysql_fetch_assoc($rs)) {
	...
	$objPHPExcel->getActiveSheet()->setCellValue("C".$contFila, date("d-m-Y",strtotime($row['fechaRegistroFactura'])));
	...
	$objPHPExcel->getActiveSheet()->setCellValue("I".$contFila, date("d-m-Y",strtotime($row['fechapago'])));
