			...
			while ($rowDetalle = mysql_fetch_assoc($rsDetalle)){
				...
				if ($condicionPago == 0)
					...
					$condicionPago = 'Contado';
						...
						$pdf->Cell($arrayTamCol[1],12,date("d-m-Y", strtotime($fechaNotaCredito)),'LR',0,'C',true);
						$pdf->Cell($arrayTamCol[2],12,date("d-m-Y", strtotime($fechaRegistroFactura)),'LR',0,'C',true);
