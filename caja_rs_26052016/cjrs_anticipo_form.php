...
<head>
	...
	function abrirDivFlotante2(nomObjeto, verTabla, valor, valor2) {
		...
		if (verTabla == "tblAnticipoNotaCreditoChequeTransferencia") {
			...
			if (inArray(valor, ['ANTICIPO','FACTURA','NOTA DEBITO'])) {
	...
	function validarFrmAnticipo(){
		...
		if (parseNumRafk(byId('txtTotalAnticipo').value) == parseNumRafk(byId('txtMontoPorPagar').value) && !byId('cbx2')) {
		...
		if (error == true) {
			...
			xajax_guardarAnticipo(xajax.getFormValues('frmDcto'),xajax.getFormValues('frmDetallePago'),xajax.getFormValues('frmListaPagos'),xajax.getFormValues('frmListaDctoPagado'));
		}
	}
		...
		if (parseFloat(saldo) < parseFloat(monto)) {
			...
			if (inArray(valor, ['ANTICIPO','FACTURA','NOTA DEBITO'])) {
				...
				if (parseFloat(montoFaltaPorPagar) >= parseFloat(monto)) {
					...
					alert("El monto a pagar no puede ser mayor que el saldo del cheque");
				}
			} else {
	...
	function validarFrmDeposito() {
		if (byId('txtSaldoDepositoBancario').value == 0) {
			xajax_insertarPago(xajax.getFormValues('frmListaPagos'), xajax.getFormValues('frmDetallePago'), xajax.getFormValues('frmDeposito'), xajax.getFormValues('frmDcto'));
		} else {
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
						...
						<tr>
							...
							<fieldset><legend class="legend">Observación</legend>
                                ...
                                <tr align="left">
                                    ...
                                    <td><textarea name="txtObservacionAnticipo" id="txtObservacionAnticipo" cols="60" rows="2"></textarea></td>
                                </tr>
                                </table>
							</fieldset>
							</td>
							...
							<fieldset><legend class="legend">Anticipo</legend>
								...
								<tr align="left" class="trResaltarTotal">
									<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Monto:</td>
                                    <td id="tdTotalRegistroMoneda"></td>
									<td><input type="text" id="txtTotalAnticipo" name="txtTotalAnticipo" size="20" style="text-align:right" onblur="setFormatoRafk(this,2); xajax_calcularPagos(xajax.getFormValues('frmListaPagos'), xajax.getFormValues('frmListaDctoPagado'), xajax.getFormValues('frmDcto'))"/></td>
								</tr>
                                <tr align="left" class="trResaltarTotal3">
                                    <td align="right" class="tituloCampo">Saldo Disponible:</td>
                ...
                <tr>
                    <td>
                        ...
                        <tr id="trItmPieDctoPagado" class="trResaltarTotal">
                            ...
                            <td><input type="text" id="txtTotalDctoPagados" name="txtTotalDctoPagados" class="inputSinFondo" readonly="readonly" style="text-align:right" value="0.00"/></td>
                            <td></td>
                        </tr>
                        <tr class="trResaltarTotal3">
		...
		<tr align="right">
			<td colspan="8"><hr>
				<button type="button" id="btnGuardar" name="btnGuardar" onclick="validarFrmAnticipo();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_save.png"/></td><td>&nbsp;</td><td>Guardar</td></tr></table></button>
...
<div id="tblListaAnticipo" style="max-height:520px; overflow:auto; width:960px;">
	...
	<tr>
		<td>
        <form id="frmListaAnticipo" name="frmListaAnticipo" style="margin:0" onsubmit="return false;">
			<table width="100%">
			<tr>
...
<form id="frmAnticipoNotaCreditoChequeTransferencia" name="frmAnticipoNotaCreditoChequeTransferencia" onsubmit="return false;" style="margin:0">
	...
	<tr align="left">
		<td align="right" colspan="2"><hr>
			...
			<button type="submit" id="btnAceptarAnticipoNotaCreditoChequeTransferencia" name="btnAceptarAnticipoNotaCreditoChequeTransferencia" onclick="validarFrmAnticipoNotaCreditoChequeTransferencia();" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>Guardar</td></tr></table></button>
...
xajax_cargarDcto('<?php echo $_GET['id']; ?>','<?php echo $_GET['vw']; ?>');
