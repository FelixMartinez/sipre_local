...
<head>
	...
	td.tituloCampo, table tr td input[type=text]{
    ...
    <div id="divInfo">
        ...
        if ($rowAperturaCaja = mysql_fetch_array($rsAperturaCaja)){
            ...
            if (($rowAperturaCaja['fechaCierre'] != $txtFechaActual || $rowAperturaCaja['fechaAperturaCaja'] != $txtFechaActual) && !(count($arrayTipoPago) > 0)) {
                $fechaApertura = implode("-",array_reverse(explode("-",$rowAperturaCaja['fechaAperturaCaja'])));
                $fechaCierreCaja = implode("-",array_reverse(explode("-",$rowAperturaCaja['fechaCierre'])));
        ...
        <form id="form1" name="form1">
            ...
            while ($rowAperturaCaja = mysql_fetch_assoc($rsAperturaCaja)) {
                ...
                <tr align="left">
                    ...
                    <td width="22%"></td>
                    <td>&nbsp;</td>
                    <td class="tituloCampo" width="28%">Fecha Actual:</td>
                    <td width="22%">
                        <input type="text" id="txtFechaActual" name="txtFechaActual" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date("d-m-Y"); ?>"/>
                    </td>
                </tr>
                <tr align="left">
                    <td class="tituloCampo">Fecha Apertura:</td>
                    <td>
                        <input type="text" id="txtFechaApertura" name="txtFechaApertura" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date("d-m-Y",strtotime($rowAperturaCaja['fechaAperturaCaja'])); ?>"/>
                    </td>
                    <td>&nbsp;</td>
                    <td class="tituloCampo">Ejecución Apertura:</td>
                    <td>
                        <input type="text" id="txtEjecucionApertura" name="txtEjecucionApertura" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date("d-m-Y H:i:s",strtotime($rowAperturaCaja['fechaAperturaCaja']." ".$rowAperturaCaja['horaApertura'])); ?>"/>
                    </td>
                </tr>
                <tr align="left" <?php if (in_array($rowAperturaCaja['statusAperturaCaja'], array(1,2))) { echo "style=\"display:none\""; } ?>>
                    <td class="tituloCampo">Fecha Cierre:</td>
                    <td><input type="text" id="txtFechaCierre" name="txtFechaCierre" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date("d-m-Y",strtotime($rowAperturaCaja['fechaCierre'])); ?>"/></td>
                    <td>&nbsp;</td>
                    <td class="tituloCampo">Ejecución Cierre:</td>
                    <td><input type="text" id="txtEjecucionCierre" name="txtEjecucionCierre" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date("d-m-Y H:i:s",strtotime($rowAperturaCaja['fechaEjecucionCierre']." ".$rowAperturaCaja['horaEjecucionCierre'])); ?>"/></td>
                </tr>
                <tr align="left">
                    <td class="tituloCampo">Saldo Apertura:</td>
                    <td><input type="text" id="txtCargaEnEfectivo" name="txtCargaEnEfectivo" class="inputCompleto" readonly="readonly" style="text-align:right;" value="<?php echo number_format($cargaEfectivoCaja, 2, ".", ","); ?>"/></td>
                    <td>&nbsp;</td>
                    <td class="tituloCampo">Estado de Caja:</td>
                    <td><input type="text" id="txtEstadoCaja" name="txtEstadoCaja" class="<?php echo $classApertura; ?>" readonly="readonly" style="text-align:center; width:99%" value="<?php echo $rowAperturaCaja['estatus_apertura_caja']; ?>"/></td>
                </tr>
                <tr align="left">
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr align="left">
                    ...
                    <td colspan="2" rowspan="10" valign="top">
                        ...
                        <?php
                        if (isset($arrayOtro)) {
                            foreach ($arrayOtro as $indice => $valor) {
                                echo "<tr align=\"left\">".
                                    "<td class=\"tituloCampo\" width=\"52%\">".utf8_encode($arrayOtro[$indice]['descripcion'])."</td>".
                                    "<td width=\"48%\"><input type=\"text\" name=\"txtOtro".$indice."\" id=\"txtOtro".$indice."\" class=\"".$arrayOtro[$indice]['classConcepto']."\" value=\"".number_format($arrayOtro[$indice]['total_forma_pago_concepto'], 2, ".", ",")."\" style=\"text-align:right\" readonly=\"readonly\"/></td>".
                                "</tr>";
                            }
                        } ?>
                        <tr align="left">
                ...
                <tr align="left">
                    <td colspan="5"><input type="text" id="txtObservacionCierre" name="txtObservacionCierre" style="width:99%"/></td>
                </tr>
                <tr>
                   ...
                   <?php if (!(count($arrayTipoPago) > 0)) { ?>
                        <button type="button" id="btnCierreTotal" name="btnCierreTotal" onclick="window.location.href = 'cjrs_pagos_cargados_dia.php?acc=2'"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/key_go.png"/></td><td>&nbsp;</td><td>Recibos por Medio de Pago</td></tr></table></button>
                   <?php } ?>
                ...
                <br/>
                <br/>
                <table id="tabla_usuario" align="center" border="0" class="solo_print" width="860">
                <tr>
                ...
                <tr align="center" style="font-size:12px;">
                    <td>
                        ...
                        WHERE pg_usuario.id_usuario = ".$_SESSION['idUsuarioSysGts'];
                    ...
                    <td>
                        ...
                        FROM pg_cargo_departamento
                            INNER JOIN pg_empleado empleado ON (pg_cargo_departamento.id_cargo_departamento = empleado.id_cargo_departamento)
                        WHERE pg_cargo_departamento.clave_filtro = 9
                    ...
                    <td>
                        ...
                        FROM pg_cargo_departamento
                            INNER JOIN pg_empleado empleado ON (pg_cargo_departamento.id_cargo_departamento = empleado.id_cargo_departamento)
                        WHERE pg_cargo_departamento.clave_filtro = 3
                            AND empleado.activo = 1";
                        $rsEmpleado = mysql_query($queryEmpleado);
                        if (!$rsEmpleado) die(mysql_error()."<br>Error Nro: ".mysql_errno()."<br>Line: ".__LINE__);
                        if ($rowEmpleado = mysql_fetch_array($rsEmpleado)) {
...
function saldosDeCierre($montoApertura){
	...
	global $arrayTipoPago, $arrayCobranza, $arrayOtro;
	...
	while ($row = mysql_fetch_assoc($rs)) {
		$arrayOtro[$row['id_concepto']] = array(
			...
			"classConcepto" => ((in_array($row['id_concepto'], array(6,7,8))) ? "inputCompletoErrado2" : "inputCompleto"));
	}
			...
			if ($totalRowsPago > 0) {
				...
				while ($rowPago = mysql_fetch_array($rsPago)) {
					...
					switch($idFormaPago){
						...
						case 5 : $txtTotalTDC = $montoTotal; break;
						...
						case 11 :
							$txtTotalOtrosPago += (in_array($rowPago['id_concepto'], array(6,7,8))) ? 0 : $rowPago['montoPagado'];
	...
	$rsNumeros = mysql_query($queryNumeros);
	if (!$rsNumeros) die(mysql_error()."<br>Error Nro: ".mysql_errno()."<br>Line: ".__LINE__);
	...
	$rsNumerosNotaCredito = mysql_query($queryNumerosNotaCredito);
	if (!$rsNumerosNotaCredito) die(mysql_error()."<br>Error Nro: ".mysql_errno()."<br>Line: ".__LINE__);
