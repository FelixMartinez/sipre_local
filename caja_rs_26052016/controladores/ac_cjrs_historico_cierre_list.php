...
function formVerificacionPortadaCaja($idApertura, $idCierre, $fechaCierre){
	...
	$objResponse->assign("txtFechaCierre","value",date("d-m-Y",strtotime($fechaCierre)));
...
function listaCierre($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"center\" class=\"textoNegrita_10px\">".date("d-m-Y", strtotime($row['fechaAperturaCaja']))."</td>";
			$htmlTb .= "<td>".utf8_encode($row['empleado_apertura'])."</td>";
			$htmlTb .= "<td align=\"center\">";
				$htmlTb .= date("d-m-Y", strtotime($row['ejecucion_apertura']))."<br>";
				$htmlTb .= date("H:i:s", strtotime($row['ejecucion_apertura']));
			$htmlTb .= "</td>";
			$htmlTb .= "<td>".utf8_encode($row['empleado_cierre'])."</td>";
			$htmlTb .= "<td align=\"center\">";
				$htmlTb .= date("d-m-Y", strtotime($row['ejecucion_cierre']))."<br>";
				$htmlTb .= date("H:i:s", strtotime($row['ejecucion_cierre']));
			$htmlTb .= "</td>";
			$htmlTb .= "<td align=\"right\">".number_format($row['saldoCaja'], 2, ".", ",")."</td>";
