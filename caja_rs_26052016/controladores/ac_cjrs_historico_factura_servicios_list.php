...
function cargaLstVendedor($selId = "") {
	...
	WHERE cxc_fact.idDepartamentoOrigenFactura IN (1)
...
function exportarFactura($frmBuscar) {
	...
	$objResponse->script("window.open('reportes/cjrs_factura_historico_s_excel.php?valBusq=".$valBusq."','_self');");
...
function imprimirFactura($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjrs_factura_historico_s_pdf.php?valBusq=%s&lstOrientacionPDF=%s',890,550)", $valBusq, $frmBuscar['lstOrientacionPDF']));
...
function listaFactura($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaFactura", "16%", $pageNum, "nombre_cliente", $campOrd, $tpOrd, $valBusq, $maxRows, "Cliente");
