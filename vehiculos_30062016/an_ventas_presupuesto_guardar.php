...
if ($idPresupuesto > 0) {
	...
	$sql = "INSERT INTO an_presupuesto (numeracion_presupuesto, id_empresa, id_cliente, id_uni_bas, asesor_ventas, estado, fecha, precio_venta, monto_descuento, porcentaje_iva, porcentaje_impuesto_lujo, tipo_inicial, porcentaje_inicial, monto_inicial, id_banco_financiar, saldo_financiar, meses_financiar, interes_cuota_financiar, cuotas_financiar, total_accesorio, total_inicial_gastos, total_adicional_contrato, total_general, porcentaje_flat, monto_flat, empresa_accesorio, exacc1, exacc2, exacc3, exacc4, vexacc1, vexacc2, vexacc3, vexacc4, id_poliza, monto_seguro, contado_poliza, inicial_poliza, meses_poliza, cuotas_poliza, observacion)
	VALUES (".
...
window.location='an_ventas_presupuesto_editar.php?view=1&id=".$idPresupuesto."';
</script>";
?>