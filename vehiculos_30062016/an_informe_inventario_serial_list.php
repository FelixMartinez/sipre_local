...
<div id="divGeneralPorcentaje">
    ...
    <tr>
        <td class="tituloPaginaVehiculos">Informe de Inventario Final por Serial<br/><span class="texto_10px">(Inventario Mensual <?php echo $emeses[$mes].' '.$ano; ?>)</span></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr>
    	<td>
            ...
            if (count($unidades) == 0) {
                ...
                foreach ($unidades as $unidad) {
                    ...
                    if ($mes_actual1 != $unidad['mes_fecha']) {
                        ...
                        $contFila = 1;
                        echo '<tr height="24">
                            <td align="left" class="tituloCampo" colspan="9">INVENTARIO RESTANTE ASIGNACI&Oacute;N DE '.$emeses[intval($unidad['mes_fecha'])].', '.$unidad['a_fecha'].'</td>
                        </tr>';
                    } ?>
            <tr align="left" class="<?php echo $clase; ?>" height="24">
                ...
                <td align="center"><?php echo $emeses[intval($unidad['mes_fecha'])].', ',$unidad['a_fecha'] ?></td>
