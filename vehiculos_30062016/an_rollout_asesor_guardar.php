...
foreach($asesor as $iasesor) {
	...
	for($mes = 1; $mes <= 12; $mes++) {
		...
		$id = $id_rollout_asesor[$iasesor][$mes];
		$vobjetivo = getmysqlnum($objetivo[$iasesor][$mes]);
		if ($id == "") {
			//insertar
...
//window.location="an_rollout_asesor.php?unidad=<?php echo $id_uni_bas ?>&a=<?php echo $ano ?>";
