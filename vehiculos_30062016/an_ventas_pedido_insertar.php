...
|| (!validaAcceso("cj_facturacion_vehiculos_list","insertar") && $_GET['idFactura'] > 0)) {
...
<head>
    ...
    function insertarItemAdicional(ac){
		...
		"<tr align=\"left\">" +
			...
			"<td><a href=\"javascript:validarEliminarAdicional(" + p + ")\"><img border=\"0\" src=\"../img/iconos/minus.png\" alt=\"Quitar\" style=\"margin-left:2px;\"/></a>" + 
				...
				"<input type=\"hidden\" id=\"hddMontoIvaItm" + ac.id + "\" name=\"hddMontoIvaItm" + ac.id + "\" value=\"" + ac.iva + "\"/>" + 
    ...
    function ku_buscaraccesorio(e, obj) {
        if (e.keyCode == 13 || (byId(obj).value.toString().length > 0 && byId(obj).readOnly == false)){
            buscarAdicional(obj);
        }
    }
    ...
    function percent() {
		...
		for (i = 0; i < acc.length; i++) {
			...
			<?php if (in_array(idArrayPais,array(1,2))) { ?>
				byId("tblCondicionItm" + acc[i].id).style.display = 'none';
				byId("tblMostrarItm" + acc[i].id).style.display = 'none';
			<?php } ?>
		}
    ...
    function validarFrmGenerar(){
		...
		&& validarCampo('txtBuscarPresupuesto','t','') == true) {
			window.location="an_ventas_pedido_generar.php?txtBuscarPresupuesto=" + byId('txtBuscarPresupuesto').value + "&txtIdEmpresa=" + byId('txtIdEmpresa').value;
		} else {
        	...
        	<td>
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <td id="tdUnidadBasica" width="100%">
                                <input type="text" id="modelo" name="modelo" autocomplete="off" class="inputCompletoHabilitado" onkeyup="ku_buscarVehiculo(event,this.id);"/>
                ...
                <tr>
                    ...
                    <fieldset id="fieldsetVentaUnidad"><legend class="legend">Venta de la Unidad</legend>
                        ...
                        <tr align="right">
                            <td class="tituloCampo" nowrap="nowrap">Inicial:
                        ...
                        <tr align="right" class="trResaltarTotal">
                            <td class="tituloCampo">Total Inicial, Adicionales:</td>
                            <td></td>
                    ...
                    <fieldset id="fieldsetFormaPago"><legend class="legend">Forma de Pago</legend>
                        <table border="0" width="100%">
                        <tr align="right">
                            <td class="tituloCampo" width="30%">Anticipo:</td>
                            <td width="34%"></td>
                        ...
                        <tr align="right">
                            <td class="tituloCampo">Complemento Inicial:</td>
                            <td></td>
                            ...
                            <td colspan="3">
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td><label id="lblSinBancoFinanciar"><input type="checkbox" id="cbxSinBancoFinanciar" name="cbxSinBancoFinanciar" onclick="xajax_asignarSinBancoFinanciar(xajax.getFormValues('frmPedido'));" value="1"/>Sin entidad bancaria</label></td>
                                            <td>&nbsp;</td>
                                            <td>
                        ...
                        <tr align="right">
                            <td class="tituloCampo">Financiamiento:</td>
                    ...
                    <fieldset><legend class="legend">Seguro</legend>
                        ...
                        <tr align="right">
                            <td class="tituloCampo" width="30%">Contado:</td>
                            <td width="34%"></td>
                            <td width="6%"></td>
                        ...
                        <tr align="right">
                            <td class="tituloCampo">Inicial:</td>
                            <td></td>
                            <td></td>
                            <td><input type="text" id="txtInicialPoliza" name="txtInicialPoliza" class="inputCompletoHabilitado" onchange="setFormatoRafk(this, 2); percent();" style="text-align:right;"/></td>
                        </tr>
                        <tr align="right">
                            ...
                            <td>
                                ...
                                <tr align="right">
                                    <td>Monto:</td>
                                    <td width="100%"><input type="text" id="txtCuotasPoliza" name="txtCuotasPoliza" class="inputCompletoHabilitado" onchange="setFormatoRafk(this, 2); percent();" style="text-align:right;"/></td>
                                </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <div id="accesorios">
                                    <div class="campo">
                                        ...
                                        <tr align="left">
                                            ...
                                            <td width="70%"><input type="text" id="addacc" name="addacc" autocomplete="off" onblur="closetooltip('toolacc');" onfocus="tooltip(this,'toolacc',5);" onkeyup="ku_buscaraccesorio(event, this.id);" style="width:99%;"/></td>
                ...
                <tr>
                    <td align="right" colspan="8"><hr>
                        ...
                        <button type="button" value="Cancelar" onclick="window.location='an_pedido_venta_list.php';"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
                    </td>
                </tr>
                </table>
            </td>
...
jQuery(function($){
	$("#txtFechaVenta").maskInput("99-99-9999",{placeholder:" "});
	$("#txtFechaAdministracion").maskInput("99-99-9999",{placeholder:" "});
	$("#txtFechaRetoma").maskInput("99-99-9999",{placeholder:" "});
	$("#txtFechaReserva").maskInput("99-99-9999",{placeholder:" "});
