        ...
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                        <input type="submit" id="btnBuscar" onclick="xajax_buscarPoliza(xajax.getFormValues('frmBuscar'));" value="Buscar"/>
						<input type="button" onclick="document.forms['frmBuscar'].reset(); byId('btnBuscar').click();" value="Limpiar"/>
                    </td>
                </tr>
                </table>
			</form>
...
<form id="frmPoliza" name="frmPoliza" style="margin:0" onsubmit="return false;">
    ...
    <tr>
    	<td>
            ...
            <tr>
                ...
                <td width="70%"><input type="text" id="txtNombre" name="txtNombre" size="30"/></td>
            </tr><!--
            <tr>
            ...
            <tr>
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Inicial:</td>
    ...
    <tr>
    	<td align="right">
            ...
            <input type="submit" id="btnGuardar" name="btnGuardar" onclick="validarForm();" value="Guardar">
