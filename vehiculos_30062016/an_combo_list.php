					...
					<tr>
						<td>
							<a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_divNuevoCombo(this.id,xajax.getFormValues('frmListadoAccesorio'));">
								<button type="button">
									<table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table>
								</button>
							</a>
						</td>
					</tr>
...
<div id="divFlotante" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	...
	<div style="max-height:520px; overflow:auto; width:960px">
	<table border="0" width="100%">
		<tr>
			<td>
		...
		<tr>
			<td id="tdAccesorio" name="tdAccesorio">
				...
				<form id="frmListadoAccesorio" name="frmListadoAccesorio" style="margin:0" onsubmit="return false;">
					<table border="0" width="100%">
