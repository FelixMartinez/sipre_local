    ...
    <form id="presupuesto" action="an_ventas_presupuesto_guardar.php" method="post" >
        	...
        	<td>
                ...
                <tr align="left">
                    ...
                    <td align="center" colspan="2">
                    	<strong><?php echo utf8_encode($spanCiudadLocal); ?>, <?php echo ($fecha == "") ? date("d-m-Y") : $fecha; ?></strong>
					</td>
                </tr>
                <tr align="left">
        ...
        <tr>
        	<td>
                ...
                <tr align="right">
                	<td class="tituloCampo">
                    	<label for="eporcentaje_inicial" accesskey="p">Inicial:</label>
			...
			<?php } ?>
                ...
                <tr align="right">
                	<td class="tituloCampo"><label for="totalinicial" accesskey="t">Total Inicial, Adicionales:</label>
                ...
                <tr align="right">
                    <td class="tituloCampo"><label for="totalinicialflat" accesskey="t">Total Inicial, Adicionales, FLAT:</label>
