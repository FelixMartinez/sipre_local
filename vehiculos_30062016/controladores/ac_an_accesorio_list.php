...
function guardarAccesorio($frmAccesorio, $frmListaAccesorio) {
	...
	if ($idAccesorio > 0) {
		...
		$insertSQL = sprintf("INSERT INTO an_accesorio (id_tipo_accesorio, nom_accesorio, des_accesorio, iva_accesorio, precio_accesorio, costo_accesorio, genera_comision, incluir_costo_compra_unidad, activo, id_motivo, id_cliente, id_tipo_comision, porcentaje_comision, monto_comision)
