...
function exportarKardex($frmBuscar, $tipoExportar = "EXCEL"){
	...
	switch ($tipoExportar) {
		case "EXCEL" : $objResponse->script("window.open('reportes/an_kardex_excel.php?valBusq=".$valBusq."','_self');"); break;
		...
		while ($rowDetalle = mysql_fetch_assoc($rsDetalle)) {
			...
			switch ($rowDetalle['tipoMovimiento']) {
				case 1 : // COMPRA
					...
					switch ($idModulo) {
						case 0: $aVerDctoAux = "../repuestos/reportes/iv_registro_compra_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
						case 2: $aVerDctoAux = "../vehiculos/reportes/an_registro_compra_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
					}
					...
					switch ($rowDetalle['tipo_documento_movimiento']) {
						...
						case 2 : // NOTA DE CREDITO
							$aVerDcto = sprintf("<a id=\"aVerDcto\" href=\"../cxc/cc_nota_credito_form.php?id=%s&acc=0\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Nota Crédito")."\"/><a>",
								$rowDetalle['id_documento']);
							switch ($idModulo) {
								case 0 : $aVerDctoAux = "../repuestos/reportes/iv_devolucion_venta_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
								case 1 : $aVerDctoAux = "../servicios/reportes/sa_devolucion_venta_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
								case 2 : $aVerDctoAux = "../vehiculos/reportes/an_devolucion_venta_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
								default : $aVerDctoAux = "";
							}
				...
				case 3 : // VENTA
					$aVerDcto = sprintf("<a id=\"aVerDcto\" href=\"../cxc/cc_factura_form.php?id=%s&acc=0\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Factura Venta")."\"/><a>",
						$rowDetalle['id_documento']);
					switch ($idModulo) {
						case 0 : $aVerDctoAux = "../repuestos/reportes/iv_factura_venta_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
						case 1 : $aVerDctoAux = "../servicios/reportes/sa_factura_venta_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
						case 2 : $aVerDctoAux = "../vehiculos/reportes/an_factura_venta_pdf.php?valBusq=".$rowDetalle['id_documento']; break;
						default : $aVerDctoAux = "";
					}
			...
			$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
				...
				$htmlTb .= "<td align=\"center\">".date("d-m-Y",strtotime($rowDetalle['fechaMovimiento']))."</td>";
