				...
				$htmlTb .= "<table border=\"0\" class=\"texto_9px\" width=\"100%\">";
					...
					while ($rowUniFis = mysql_fetch_assoc($rsUniFis)) {
						...
						$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
							...
							$htmlTb .= sprintf("<td align=\"center\">%s</td>", utf8_encode(date("d-m-Y",strtotime($rowUniFis['fecha_factura_proveedor']))));
							$htmlTb .= sprintf("<td align=\"center\">%s</td>", ($rowUniFis['fecha_registro_pdi'] != "") ? utf8_encode(date("d-m-Y",strtotime($rowUniFis['fecha_registro_pdi']))) : "");
							...
							$htmlTb .= sprintf("<td align=\"center\">%s</td>", utf8_encode($rowUniFis['placa']));
