...
function formUnidadFisicaAgregado($idUnidadFisica, $frmUniFisAgregado) {
	...
	while ($rowUniFisAgregado = mysql_fetch_array($rsUniFisAgregado)) {
		...
		switch ($idTipoMovimientoAgregado) {
			case 1 : // 1 = COMPRA
				switch ($idModulo) {
					case 0 : $aVerDctoAux = "javascript:verVentana(\'../repuestos/reportes/iv_registro_compra_pdf.php?valBusq=".$idDocumento."\', 960, 550);"; break;
					case 2 : $aVerDctoAux = "javascript:verVentana(\'../vehiculos/reportes/an_registro_compra_pdf.php?valBusq=".$idDocumento."\', 960, 550);"; break;
					default : $aVerDctoAux = "";
				}
