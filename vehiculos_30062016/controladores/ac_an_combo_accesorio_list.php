...
function guardarAccesorio($valForm, $valFormListaAccesorio) {
	...
	if ($valForm['hddIdAccesorio'] > 0) {
		...
		if (xvalidaAcceso($objResponse,"an_combo_accesorios_list","insertar")) {
			$insertSQL = sprintf("INSERT INTO an_accesorio (id_tipo_accesorio, nom_accesorio, des_accesorio, iva_accesorio, precio_accesorio, costo_accesorio, genera_comision, incluir_costo_compra_unidad, activo)
...
function nuevoAccesorio($nomObjeto) {
	...
	if (xvalidaAcceso($objResponse,"an_combo_accesorios_list","insertar")) {
		...
		byId('txtDescripcion').className = 'inputInicial';
		byId('lstPoseeIva').className = 'inputInicial';
		byId('lstActivo').className = 'inputInicial';
		byId('txtPrecio').className = 'inputInicial';
		byId('lstGeneraComision').className = 'inputInicial';");
