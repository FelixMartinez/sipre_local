...
function formCierreVenta($idFactura, $frmCierreVenta) {
	...
	if (!xvalidaAcceso($objResponse,"cj_facturacion_vehiculos_list","insertar")) { usleep(0.5 * 1000000); $objResponse->script("byId('btnCancelarCierreVenta').click();"); return $objResponse; }
...
function guardarCierreVenta($frmCierreVenta, $frmListaMovimiento) {
	...
	if (!xvalidaAcceso($objResponse,"cj_facturacion_vehiculos_list","insertar")) { return $objResponse; }
...
function insertarItemAdicional($contFila, $hddIdFacturaDet, $hddIdItmAccPed, $hddTpItmAccPed, $hddIdAccesorioItm){
	...
	if ($hddIdFacturaDet > 0) {
		...
		if ($hddTipoAccesorioItm == 3) { // 1 = Adicional, 2 = Accesorio, 3 = Contrato
			...
			$htmlContrato .= "<tr>";
            	$htmlContrato .= "<td align=\"right\" class=\"tituloCampo\" width=\"15%\"><span class=\"textoRojoNegrita\">*</span>Cliente:</td>";
				$htmlContrato .= "<td width=\"85%\">";
					$htmlContrato .= "<table cellpadding=\"0\" cellspacing=\"0\">";
					$htmlContrato .= "<tr>";
						$htmlContrato .= sprintf("<td><input type=\"text\" id=\"txtIdClienteItm%s\" name=\"txtIdClienteItm%s\" class=\"inputHabilitado\" onblur=\"xajax_asignarCliente(\'ClienteItm%s\', this.value, \'\', \'\', \'\', \'true\', \'false\');\" size=\"6\" style=\"text-align:right\" value=\"%s\"/></td>",
							$contFila, $contFila, $contFila, $rowPedidoDet['id_cliente']);
						$htmlContrato .= "<td>";
							$htmlContrato .= sprintf("<a class=\"modalImg\" id=\"aListarClienteItm\" rel=\"#divFlotante2\" onclick=\"abrirDivFlotante2(this, \'tblLista\', \'Cliente\', \'ClienteItm%s\');\">",
								$contFila);
								$htmlContrato .= "<button type=\"button\" title=\"Listar\"><img src=\"../img/iconos/help.png\"/></button>";
							$htmlContrato .= "</a>";
						$htmlContrato .= "</td>";
						$htmlContrato .= sprintf("<td><input type=\"text\" id=\"txtNombreClienteItm%s\" name=\"txtNombreClienteItm%s\" readonly=\"readonly\" size=\"40\" value=\"%s\"/></td>",
			...
			$htmlContrato .= "</tr>";
			$htmlContrato .= "<tr>";
            	$htmlContrato .= "<td align=\"right\" class=\"tituloCampo\"><span class=\"textoRojoNegrita\">*</span>Motivo:</td>";
				$htmlContrato .= "<td>";
					$htmlContrato .= "<table cellpadding=\"0\" cellspacing=\"0\">";
					$htmlContrato .= "<tr>";
						$htmlContrato .= sprintf("<td><input type=\"text\" id=\"txtIdMotivoItm%s\" name=\"txtIdMotivoItm%s\" class=\"inputHabilitado\" onblur=\"xajax_asignarMotivo(this.value, \'MotivoItm%s\', \'CC\', \'I\', \'false\');\" size=\"6\" style=\"text-align:right\" value=\"%s\"/></td>",
							$contFila, $contFila, $contFila, $rowPedidoDet['id_motivo']);
						$htmlContrato .= "<td>";
							$htmlContrato .= sprintf("<a class=\"modalImg\" id=\"aListarMotivoItm\" rel=\"#divFlotante2\" onclick=\"abrirDivFlotante2(this, \'tblListaMotivo\', \'MotivoItm%s\', \'CC\', \'I\');\">",
								$contFila);
								$htmlContrato .= "<button type=\"button\" title=\"Listar\"><img src=\"../img/iconos/help.png\"/></button>";
							$htmlContrato .= "</a>";
						$htmlContrato .= "</td>";
						$htmlContrato .= sprintf("<td><input type=\"text\" id=\"txtMotivoItm%s\" name=\"txtMotivoItm%s\" readonly=\"readonly\" size=\"40\" value=\"%s\"/></td>",
