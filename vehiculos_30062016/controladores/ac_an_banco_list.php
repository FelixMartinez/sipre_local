...
function cargarBanco($idBanco) {
	...
	if (xvalidaAcceso($objResponse,"an_banco_list","editar")) {
		$objResponse->script("
			...
			$('txtPorcentajeComisionFlat').className = 'inputInicial';
		");
		...
		$objResponse->script("
			$('tblBanco').style.display = '';
			$('tblListaFactorFinanciero').style.display = 'none';
		");
...
function cargarFactor($idFactor) {
	...
	if (xvalidaAcceso($objResponse,"an_factor","editar")) {
		$objResponse->script("
			...
			$('hddIdFactor').value = '';
			$('hddIdBancoFactor').value = '';
			
			$('txtNombreBancoFactor').className = 'inputInicial';
			$('txtTasa').className = 'inputInicial';
			$('txtMesesFactor').className = 'inputInicial';
			$('txtFactor').className = 'inputInicial';
		");
...
function formListaFactor($idBanco) {
	...
	if (xvalidaAcceso($objResponse,"an_factor")) {
		...
		$objResponse->script("
			$('tblBanco').style.display = 'none';
			$('tblListaFactorFinanciero').style.display = '';
		");
...
function listadoBanco($pageNum = 0, $campOrd = "nombreBanco", $tpOrd = "ASC", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	$objResponse->assign("tdListaBanco","innerHTML",$htmlTableIni.$htmlTf.$htmlTh.$htmlTb.$htmlTf.$htmlTableFin);
...
function listadoFactorFinanciero($pageNum = 0, $campOrd = "mes", $tpOrd = "ASC", $valBusq = "", $maxRows = 10, $totalRows = NULL) {
	...
	$objResponse->assign("tdListaFactorFinanciero","innerHTML",$htmlTableIni.$htmlTf.$htmlTh.$htmlTb.$htmlTf.$htmlTableFin);
