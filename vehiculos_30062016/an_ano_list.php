...
<div id="divGeneralVehiculos">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Año</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="xajax_formAno();" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                </tr>
                </table>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                        <input type="submit" id="btnBuscar" onclick="xajax_buscarAno(xajax.getFormValues('frmBuscar'));" value="Buscar"/>
        ...
        <tr>
            ...
            <form id="frmListaAno" name="frmListaAno" style="margin:0">
            	<div id="tdListaAno" style="width:100%"></div>
            </form>
            </td>
        </tr>
        </table>
...
<form id="frmAno" name="frmAno" style="margin:0" onsubmit="return false;">
    <table border="0" id="tblAno" width="450px">
    <tr>
    	<td>
        	<table width="100%">
            <tr>
