...
<div id="tblListaDocumento" style="max-height:520px; overflow:auto; width:960px;">
    <table border="0" width="100%">
    <tr>
        <td>
...
window.onload = function(){
	jQuery(function($){
		$("#txtFechaDesdeBuscarDocumento").maskInput("99-99-9999",{placeholder:" "});
		$("#txtFechaHastaBuscarDocumento").maskInput("99-99-9999",{placeholder:" "});
	});
