    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('iv_documento_importacion_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
					</td>
                </tr>
                </table>
...
window.onload = function(){
	jQuery(function($){
	   ...
	   $("#txtFechaDesdeBuscarRegistroCompra").maskInput("99-99-9999",{placeholder:" "});
	   $("#txtFechaHastaBuscarRegistroCompra").maskInput("99-99-9999",{placeholder:" "});
	});
