...
<form id="frmPermiso" name="frmPermiso" onsubmit="return false;" style="margin:0px">
    ...
    <tr>
    	<td>
        	<table width="100%">
            <tr align="left">
            	<td align="right" class="tituloCampo" width="32%"><span class="textoRojoNegrita noprint">*</span>Ingrese Clave:</td>
                <td width="68%">
    ...
    <tr>
    	<td align="right"><hr>
            ...
            if (byId('hddImpresion').value == 'true') {
            	window.open('an_transferencia_almacen_list.php','_self');
			} else {
