...
<head>
	...
	function calcularMonto(objAccion){
		...
		if (byId('hddIdTradeInAjusteInventario').value > 0 && (txtAllowance != txtAllowanceAnt || txtAcv != txtAcvAnt || txtPayoff != txtPayoffAnt)) {
			...
			if (txtAllowance > txtAcv) {//alert("ALLOWANCE MAYOR"); // EL ALLOWANCE ES MAYOR AL ACV
			...
			} else if (txtAcv > txtAllowance) {//alert("ACV MAYOR"); // EL ACV ES MAYOR AL ALLOWANCE
				if (txtAllowance != txtAllowanceAnt && txtAcv == txtAcvAnt) {//alert("a // VARIO EL ALLOWANCE");
			...
			if (txtCreditoNeto != txtCreditoNetoAnt) {
				if (txtAllowance > txtAllowanceAnt && txtAcv == txtAcvAnt) {
					txtMontoCxC = (txtCreditoNeto - txtCreditoNetoAnt);////////
				} else if (txtAllowance < txtAllowanceAnt && txtAcv == txtAcvAnt) {
					txtMontoCxC = (txtCreditoNeto - txtCreditoNetoAnt);////////
	...
	function calcularMonto2(objAccion){
		if (!(byId('hddIdTradeInAjusteInventario').value > 0) && objAccion == 'txtAllowance') {
			byId('txtAcv').value = byId('txtAllowance').value; 
		}
                ...
                <tr>
                    ...
                    <td>&nbsp;
                        <a class="modalImg" id="aNuevo" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblAjusteInventario', 0, 1); xajax_validarAperturaCaja();">
                            <button type="button"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img class="puntero" src="../img/iconos/generarPresupuesto.png" title="Agregar vehículo existente a Trade-In"/></td><td>&nbsp;</td><td>Registrados</td></tr></table></button>
                        </a>
                    </td>
                </tr>
                </table>
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/book_next.png"/></td><td>Volver a Generar Anticipo</td>
                            <td>&nbsp;</td>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/page.png"/></td><td>Ver Anticipo</td>
                            <td>&nbsp;</td>
...
<form id="frmUnidadFisica" name="frmUnidadFisica" style="margin:0" onsubmit="return false;">
    <div id="tblUnidadFisica" style="max-height:520px; overflow:auto; width:960px;">
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Datos de la Unidad</legend>
                        ...
                        <tr align="left">
                            ...
                            <td><input type="text" id="txtKilometraje_2" name="txtKilometraje_2" readonly="readonly" size="24"/></td>                            
                        </tr>
                        </table>
                    </fieldset>
                    </td>
                ...
                <fieldset><legend class="legend">Datos Personales</legend>
                    ...
                    <tbody><tr>
                        ...
                        <td width="85%">
                            ...
                            <tbody><tr>
                                <td><input type="text" style="text-align:right;" size="6"  name="txtIdCliente_2" id="txtIdCliente_2" /></td>
                                <td>
                                    <input type="hidden" id="hddIdEmpresa" name="hddIdEmpresa" />
                                </td>
                                <td><input type="text" size="45" readonly="readonly" name="txtNombreCliente_2" id="txtNombreCliente_2" /></td>
                            </tr>
                            </tbody></table>
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Trade In</legend>
                        ...
                        <tr style="display:none;">
                            <td align="right" class="tituloCampo" width="45%">Id Trade In:</td>
                            <td align="right" width="55%">
                                <input type="text" id="txtIdTradeIn" name="txtIdTradeIn" maxlength="12" style="text-align:right"/>
                            </td>
                        </tr>
                        <tr align="left">
                            <td align="right" class="tituloCampo">Allowance:</td>
                            <td align="right">
                                <input type="text" readonly="readonly" id="txtAllowance_2" name="txtAllowance_2" maxlength="12" style="text-align:right"/>
                                <img src="../img/iconos/information.png" style="margin-bottom:-3px;" title="Monto por el cual el vehículo será ingresado al inventario" />
                            </td>
                        </tr>
                        <tr align="left">
                            <td align="right" class="tituloCampo">Payoff:</td>
                            <td align="right">
                                <input type="text" readonly="readonly" id="txtPayoff_2" name="txtPayoff_2" maxlength="12" style="text-align:right"/>
                                <img src="../img/iconos/information.png" style="margin-bottom:-3px;" title="Monto total adeudado" />
                            </td>
                        </tr>
                        <tr align="left">
                            <td align="right" class="tituloCampo">Crédito Neto:</td>
                            <td align="right">
                                <input type="text" readonly="readonly" id="txtCreditoNeto_2" name="txtCreditoNeto_2" maxlength="12" style="text-align:right"/>
                                <img src="../img/iconos/information.png" style="margin-bottom:-3px;" title="Valor actual del vehículo para anticipo a favor del cliente &#10; Allowance - Payoff" />
                            </td>
                        </tr>
                        </table>
                    </fieldset>
                    ...
                    <fieldset><legend class="legend">Datos del Anticipo</legend>                                    
                        ...
                        <tr>
                            ...
                            <td width="60%"><input type="text" id="txtNumeroAnticipo_2" name="txtNumeroAnticipo_2" readonly="readonly" size="20" style="text-align:center"/></td>
                        </tr>
                        <tr>
                            <td align="right" class="tituloCampo">Módulo:<input type="hidden" id="hddIdModulo" name="hddIdModulo"></input></td>
                            <td id="tdlstModulo_2"></td>
                        </tr>
                        <tr>
                            <td align="right" class="tituloCampo">Monto Anticipo:</td>
                            <td><input type="text" id="txtMontoAnticipo_2" name="txtMontoAnticipo_2" readonly="readonly" size="20" style="text-align:right" /></td>
                        </tr>
                        </table>
                    </fieldset>
                    </td>
                    ...
                    <fieldset><legend class="legend">Forma de Pago</legend>
                        <table border="0" width="100%">                                    
                        <tr align="left">
                            <td align="right" class="tituloCampo" width="164">Forma de Pago:<input type="hidden" id="hddIdFormaPago" name="hddIdFormaPago"></input></td>
                            <td><input type="text" id="lstFormaPago_2" readonly="readonly"/></td>
                        </tr>
                        <tr align="left">
                            <td align="right" class="tituloCampo">Concepto de Pago:<input type="hidden" id="hddIdConceptoPago" name="hddIdConceptoPago"></input></td>
                            <td><input id="lstConceptoPago_2" readonly="readonly"/></td>
                        </tr>
                        <tr>
                            <td align="right" class="tituloCampo">Subtotal Vale:</td>
                            <td align="right"><input type="text" id="txtSubTotal_2" name="txtSubTotal_2" maxlength="12" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        </table>
                    </fieldset>
                    </td>
        ...
        <tr>
            <td>
            <fieldset><legend class="legend">Observación Vale - Anticipo</legend>
                <table border="0" width="100%">
                <tr align="left">
                    <td align="right" class="tituloCampo" rowspan="4" width="14%">Observación:</td>
                    <td rowspan="4" width="52%"><textarea id="txtObservacion_2" name="txtObservacion_2" readonly="readonly" rows="3" style="width:99%"></textarea></td>                        
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
        ...
        <tr>
            <td align="right"><hr>
                <button type="button" id="btnGenerarAnticipo" name="btnGenerarAnticipo" onclick="validarFrmUnidadFisica();">Generar Nuevo Anticipo</button>
                        ...
                        <tr>
                            ...
                            <td width="85%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a class="modalImg" id="aListarCliente" rel="#divFlotante2" onclick="abrirDivFlotante2(this, 'tblListaCliente');">
            ...
            <fieldset><legend class="legend">Unidad Física</legend>
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Trade In</legend>
                    	...
                    	<table width="100%">
                        <tr align="left">
                            <td align="right" class="tituloCampo" width="40%"><span class="textoRojoNegrita">*</span>Subtotal Vale:</td>
                            <td align="right" width="60%"><input type="text" id="txtSubTotal" name="txtSubTotal" maxlength="12" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <fieldset><legend class="legend">Datos del Anticipo</legend>
                        ...
                        <tr id="trConceptoPago">
                        	<td valign="top" width="60%">
                            	<table border="0" width="100%">
                                <tr align="left">
                                    <td align="right" class="tituloCampo" width="20%"><span class="textoRojoNegrita">*</span>Nro. Anticipo:</td>
                                    <td width="30%">
...
<form id="frmTradeInCxP" name="frmTradeInCxP" style="margin:0" onsubmit="return false;">
    <div id="tblTradeInCxP" style="max-height:520px; overflow:auto; width:960px;">
    	<table border="0" width="100%">
        <tr>
...
<div id="divFlotante2" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
    ...
    <div id="tblLista2" style="max-height:520px; overflow:auto; width:960px;">
        <table border="0" width="100%">
        ...
        <tr id="trBuscarNotaCargo">
            <td>
            <form id="frmBuscarNotaCargo" name="frmBuscarNotaCargo" style="margin:0" onsubmit="return false;">
