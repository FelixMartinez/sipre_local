	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td>
                ...
                <tr>
                    ...
                    <form id="frmListaAccesorio" name="frmListaAccesorio" style="margin:0" onsubmit="return false;">
		...
		<tr>
			<td align="right"><hr>
				...
				<button type="button" id="btnCancelar" name="btnCancelar" onclick="window.open('an_presupuesto_venta_list.php','_self');">Cancelar</button>
			</td>
		</tr>
	</table>
	</div>
...
<div id="divFlotante1" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
    ...
    <tr>
        <td>
        <form id="frmBuscarPresupuesto" name="frmBuscarPresupuesto" style="margin:0" onsubmit="return false;">
    ...
    <tr>
        <td>
        <form id="frmListaPresupuesto" name="frmListaPresupuesto" style="margin:0" onsubmit="return false;">
    ...
    <tr>
   	...
   	<div id="tblCombo" style="max-height:520px; overflow:auto; width:960px">
        <table border="0" width="100%">
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td>
                ...
                <tr>
                    <td>
                    <form id="frmObservacion" name="frmObservacion" style="margin:0" onsubmit="return false;">
                    <fieldset><legend class="legend">Accesorios</legend>
    	...
    	<td>
            <div class="wrap">
                ...
                <div class="pane">
                    ...
                    <tr>
                        <td>
                        <form id="frmBuscarCombo" name="frmBuscarCombo" style="margin:0" onsubmit="return false;">
                ...
                <div class="pane">
                    ...
                    <tr>
                        <td>
                        <form id="frmBuscarAccesorio" name="frmBuscarAccesorio" style="margin:0" onsubmit="return false;">
                            <table align="right" border="0">
                            <tr align="left">
                                <td align="right" class="tituloCampo" width="120">Criterio:</td>
