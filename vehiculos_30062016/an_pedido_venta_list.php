    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('an_ventas_pedido_insertar.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo Pedido</td></tr></table></button>
                        <button type="button" onclick="window.open('an_ventas_pedido_insertar.php?vw=i','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/book_previous.png"/></td><td>&nbsp;</td><td>Importar Presupuesto</td></tr></table></button>
                    </td>
                </tr>
                </table>
