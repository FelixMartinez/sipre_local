    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td align="right"><hr>
                ...
                <button type="button" id="btnCancelarFacturaGasto" name="btnCancelarFacturaGasto" onclick="window.open('an_documento_importacion_list.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
            </td>
        </tr>
        </table>
	</div>
...
window.onload = function(){
	jQuery(function($){
	   $("#txtFechaFacturaGasto").maskInput("99-99-9999",{placeholder:" "});
	});
