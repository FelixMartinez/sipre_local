...
imagestring($img,1,370,20,strtoupper($rowEmp['ciudad_empresa']).", ".date("d", strtotime($rowDcto['fechaCartaSolicitud']))." DE ".strtoupper($mes[date("n", strtotime($rowDcto['fechaCartaSolicitud']))])." DE ".date("Y", strtotime($rowDcto['fechaCartaSolicitud'])),$textColor);
