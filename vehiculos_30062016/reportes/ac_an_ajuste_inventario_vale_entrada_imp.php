...
function cargarValeEntrada($idValeEntrada) {
	...
	$queryUnidadFisica = sprintf("SELECT
		...
		model.id_modelo AS id_modelo,
		model.nom_modelo AS nom_modelo,
		model.des_modelo AS des_modelo,
	...
	FROM an_unidad_fisica uni_fis
		...
		LEFT JOIN an_modelo model on (uni_bas.mod_uni_bas = model.id_modelo)
	...
	$objResponse->assign("tdFechaEmision","innerHTML",date("d-m-Y",strtotime($rowValeEntrada['fecha'])));
