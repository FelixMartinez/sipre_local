...
$objPHPExcel->getActiveSheet()->getStyle("A".$contFila.":W".$contFila)->applyFromArray($styleArrayColumna);
...
while ($row = mysql_fetch_assoc($rs)) {
	...
	$objPHPExcel->getActiveSheet()->setCellValue("E".$contFila, implode("-", array_reverse(explode("-", $row['fecha_origen']))));
	$objPHPExcel->getActiveSheet()->setCellValue("F".$contFila, implode("-", array_reverse(explode("-", $row['fecha_factura_proveedor']))));
	$objPHPExcel->getActiveSheet()->setCellValue("G".$contFila, implode("-", array_reverse(explode("-", $row['fecha_vencimiento']))));
	...
	$objPHPExcel->getActiveSheet()->getStyle("A".$contFila.":W".$contFila)->applyFromArray($clase);
	...
	$objPHPExcel->getActiveSheet()->getStyle("W".$contFila)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
...
$ultimo = $contFila;
$objPHPExcel->getActiveSheet()->setAutoFilter("A".$primero.":W".$ultimo);
	
$contFila++;
$objPHPExcel->getActiveSheet()->SetCellValue("A".$contFila, "Total:");
$objPHPExcel->getActiveSheet()->setCellValue("H".$contFila, $cantFact);
$objPHPExcel->getActiveSheet()->setCellValue("R".$contFila, $arrayTotal[15]);
$objPHPExcel->getActiveSheet()->setCellValue("S".$contFila, $arrayTotal[16]);
$objPHPExcel->getActiveSheet()->setCellValue("T".$contFila, $arrayTotal[17]);
$objPHPExcel->getActiveSheet()->setCellValue("U".$contFila, $arrayTotal[18]);
$objPHPExcel->getActiveSheet()->setCellValue("V".$contFila, $arrayTotal[19]);
$objPHPExcel->getActiveSheet()->setCellValue("W".$contFila, $arrayTotal[20]);

$objPHPExcel->getActiveSheet()->getStyle("A".$contFila)->applyFromArray($styleArrayCampo);
$objPHPExcel->getActiveSheet()->getStyle("H".$contFila.":"."W".$contFila)->applyFromArray($styleArrayResaltarTotal);
$objPHPExcel->getActiveSheet()->getStyle("R".$contFila)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
$objPHPExcel->getActiveSheet()->getStyle("S".$contFila)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
$objPHPExcel->getActiveSheet()->getStyle("T".$contFila)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
$objPHPExcel->getActiveSheet()->getStyle("U".$contFila)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
...
cabeceraExcel($objPHPExcel, $idEmpresa, "W");
