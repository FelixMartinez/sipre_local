        ...
        if ($rcheck) {
            ...
            while ($rowcheck = mysql_fetch_assoc($rcheck)) {
                ...
                /*$sqlsc="select 
                    ...
                    DATE_FORMAT(an_pedido_checklist.valor,'%d-%m-%Y') as valor_date,
                    DATE_FORMAT(an_pedido_checklist.valor,'%d-%m-%Y %h:%i %p') as valor_datetime
                ...
                $sqlsc = "SELECT 
                    ...
                    DATE_FORMAT(@valorf,'%d-%m-%Y') AS valor_date,
                    DATE_FORMAT(@valorf,'%d-%m-%Y %h:%i %p') AS valor_datetime
                FROM an_checklist 
                    ...
                    while ($rowdata = mysql_fetch_assoc($rsc)) {
                        ...
                        if ($rowdata['tipo'] == 0) { // CHECK
                            ...
                            echo sprintf('
                                ...
                                $idcheck,
                                $idcheck,'%d-%m-%Y',$idcheck,$idcheck,$idcheck,
                                $idcheck,$rowdata['id_pedido_checklist'],$idcheck);
                            ...
                            echo sprintf('
                                ...
                                $idcheck,
                                $idcheck,'%d-%m-%Y %I:%M %p',$idcheck,$idcheck,$idcheck,
                                $idcheck,$rowdata['id_pedido_checklist'],$idcheck);
