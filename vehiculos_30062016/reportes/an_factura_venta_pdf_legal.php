...
imagestring($img,1,390,$posY,date("d-m-Y", strtotime($rowEncabezado['fechaRegistroFactura'])),$textColor);
...
if($rowEncabezado['fecha_nacimiento'] != NULL && $rowEncabezado['fecha_nacimiento'] != "1969-12-31" && $rowEncabezado['fecha_nacimiento'] != "0000-00-00"){
    imagestring($img,1,340,$posY,date("d-m-Y", strtotime($rowEncabezado['fecha_nacimiento'])),$textColor);    
}// LICENCIA #LIC
