...
FROM cj_cc_factura_detalle_accesorios cxc_fact_det_acc
	...
	INNER JOIN an_pedido ped_vent ON (cxc_fact.numeroPedido = ped_vent.id_pedido) %s
...
while ($row = mysql_fetch_assoc($rs)) {
	...
	$objPHPExcel->getActiveSheet()->setCellValue("K".$contFila, date("d-m-Y", strtotime($row['fecha_entrega'])));
