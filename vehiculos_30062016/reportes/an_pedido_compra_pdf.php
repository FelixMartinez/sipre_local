...
imagestring($img,1,390,$posY,": ".date("d-m-Y", strtotime($rowEncabezado['fecha_pedido'])),$textColor);
...
imagestring($img,1,390,$posY,": ".date("d-m-Y", strtotime($rowEncabezado['fecha_asignacion'])),$textColor);
