...
<div id="divFlotante1" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
    ...
    <div id="tblListaAdicional" style="max-height:520px; overflow:auto; width:960px;">
        <table border="0" width="100%">
        <tr>
            <td>
                <div class="wrap">
                    ...
                    <div class="pane">
                        ...
                        <tr>
                            <td>
                            <form id="frmBuscarAdicional" name="frmBuscarAdicional" style="margin:0" onsubmit="return false;">
                                <table align="right">
                                <tr align="left">
                        ...
                        <tr>
                            <td>
                            <form id="frmListaAdicional" name="frmListaAdicional" style="margin:0" onsubmit="return false;">
                    ...
                    <div class="pane">
                        ...
                        <tr>
                            <td>
                            <form id="frmListaPaquete" name="frmListaPaquete" style="margin:0" onsubmit="return false;">
