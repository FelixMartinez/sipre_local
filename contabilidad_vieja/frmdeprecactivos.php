...
$Arretabla3[0][0]= 'erp_automotriz.pg_departamento '; //Tabla
$Arretabla3[0][1]= 'T';
...
$Arretabla4[0][0]= 'erp_automotriz.pg_empleado 
LEFT JOIN erp_automotriz.pg_cargo_departamento ON pg_cargo_departamento.id_cargo_departamento = pg_empleado.id_cargo_departamento
LEFT JOIN erp_automotriz.pg_departamento ON pg_departamento.id_departamento = pg_cargo_departamento.id_departamento
'; //Tabla
$Arretabla4[0][1]= 'T';
