...
//	document.frmDiarios.oTablaSelect
	
    document.frmDiarios.action = "ElegirMovimientos.php";
	document.frmDiarios.method = "post"; 
	document.frmDiarios.StatusOculto.value = 'BU';
...
<table align="center" width="100%">
	...
	<?php   if ($cad != 'H' && $cad != 'I'){  ?>
        	...
        	<button name="BtnGuardar" type="button" value="Guardar" onClick="Guardar();">Guardar</button>
   		   	<button name="BtnImprimir" type="button" value="Imprimir" onClick="<?php print(" RepImprimir('$cad') ");?>">Imprimir</button>
		   	<button name="BtnBuscar" type="button" value="Buscar" onClick="<?php print("PantallaBuscar('oComprobante','$Arre2')");?>">Buscar</button>
           	<button name="BtnIncluir"  type="button" value="Incluir" onClick="Limpiar();">Incluir</button>
		   
			<?php 
			//if(VerificarAcceso($numeroMenu, 'D') == false){  
    	    	  echo "<button name='BtnEliminar' type='button' value='Eliminar' onClick='Eliminar();'>Eliminar</button>";
			//}?> 	   
	<?php   }else{  ?>
		   	<button name="BtnBuscar" type="button" value="Buscar" onClick="<?php print("PantallaBuscar('oComprobante','$Arre2')");?>">Buscar</button>
  	       	<button name="BtnImprimir" type="button" value="Imprimir" onClick="<?php print("RepImprimir('$cad')");?>">Imprimir</button>
	<?php   } ?>
	<?php 	if ($cad == 'I'){  ?>		   
	    	<button name="GenerarComprobante" type="button" value="Generar Comprobante Contable" onClick="<?php print("GenerarCom()");?>">Generar Comprobante Contable</button>
			<?php } ?>  
		</td>
	</tr>
</table>
