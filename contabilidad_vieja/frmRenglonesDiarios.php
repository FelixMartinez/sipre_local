...
function EditarRenglon(jnumero,jcodigo,jdescripcion,jdebe,jhaber,jdocumento,jDesCuenta,jOrdenRen,jCT,jDT,jIM){
		 ...
		 if (parent.document.frmDiarios.oTablaSelec.value=='H' || parent.document.frmDiarios.oTablaSelec.value=='I'){
				alert('El Comprobante es historio o importado y no puede realizar ningún tipo de modificación');			 
				return;
		 }
...
function EliminarRenglon(jnumero){
   ...
   document.frmRenglonesDiarios.sDesactivarColor.value = "SI";
      soCon = "FilaRenglon"+jnumero;
              ...
              objFila.color='while'
			  nNumero = jnumero;
     if( confirm("Desea eliminar el Renglon")){
	 		  parent.document.frmDiarios.oNumero.value= jnumero;     
     		  document.frmRenglonesDiarios.oNumero.value= jnumero;     
			  parent.document.frmDiarios.oCodigoCuenta.value= '';     
			  parent.document.frmDiarios.oDesMovimiento.value=''; 
...
//if($_SESSION["CCSistema"] != ""){
 // $oCC = $_SESSION["CCSistema"];
  $EstadoCuenta = "oriomka_inavi.cuenta";
  $EstadoCT =  "oriomka_inavi.transacciones";
  $EstadoDT =  "oriomka_inavi.documentos";
  $EstadoCC =  "oriomka_inavi.centrocosto";
...
//		   		parent.document.frmDiarios.refresh
	//	</script>"; 
	 ?>
      ...
      <tr <?= $sStilo ?>  id="<?php print('FilaRenglon'.trim($numero)); ?>"   style="cursor:pointer"   onMouseOut="FueraFila('',this);" onMouseMove="SobreFila('<?=trim($DesCuenta)?>',this);" >
        <A name=<?=trim($OrdenRen)?> ></A>
		<td width=5 title="Editar Renglón" onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>" class="RenglonesMov">
			<?=$iNumeroShow?> 
        </td>
		<td width=20 title="Editar Renglón" onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>" align="left">
			<?=trim($codigo)?> 
         </td>
		<td width=20 title="Editar Renglón" onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>" align="left">
			<?=trim($oCT)?> 
        </td>
		<td width=115 title="Editar Renglón" onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>" align="left">
			<?php print($descripcion);?>
        </td>
    	<td  width=62 title="Editar Renglón" onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>" align="left">
...
?>
		...
		<td width=50 title="Editar Renglón" onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>"  align="left">
		<?=number_format($haber,2);?>
		</td>
		<td width=15 title="Editar Renglón" onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>" align="left">
			<?=trim($oDT)?> 
        </td>
    	<td width=80   onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>"  align="left">
			<?php print($documento);?>
        </td>
		<td width=30   onClick="<?php print("EditarRenglon('$numero','$codigo','$descripcion','$debe','$haber','$documento','$DesCuenta','$OrdenRen','$oCT','$oDT','$oIM')")?>">
			<?php print($oIM);?>
        </td>
		
		
		<td width=5 height="8" class="RenglonesMov"><a href="<?php print("javascript:InsertarRenglon('$numero','$OrdenRen')")?>"><img  title="Insertar Renglón" src="./Imagenes/InsertarRenglon.bmp"></a></td>
		<td width=5 height="8" class="RenglonesMov"><a href="<?php print("javascript:EliminarRenglon('$numero')")?>"><img  title="Eliminar Renglón" src="./Imagenes/EliminarRenglon.bmp"></td>
		
	</tr> 
	<?php  }	//   if ($Arreglo[$inc][8] != "E" && $Arreglo[$inc][8] != "NE"){?>
