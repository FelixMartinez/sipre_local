...
if ($codigo > 0) {
	...
	$queryAct = sprintf("SELECT deprecactivos.Codigo,
						...
						INNER JOIN oriomka_inavi.ubicacion ON (deprecactivos.Ubicacion = ubicacion.id_ubicacion)
						INNER JOIN oriomka_inavi.departamento ON (deprecactivos.Departamento = departamento.id_departamento)
							WHERE Codigo =  %s;",
	$codigo);
