...
$conAd = ConectarBDAd();
$SqlStr = "Select a.codigo,a.descripcion from adcontabilidad.company 
a left join adcontabilidad.comcerrada b 
on a.codigo = b.codigo and mes = $Mes and ano = $Ano
where b.codigo is null and a.codigo <> 'oriomka_inavi' and a.codigo <> 'BASEPRUEBA'";
