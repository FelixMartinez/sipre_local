...
$SqlStr=" select * from $TablaEnc.movimien a left join oriomka_inavi.cuenta b on a.codigo = b.codigo
...
$SqlStr=" select * from $TablaEnc.movimiendif a left join oriomka_inavi.cuenta b on a.codigo = b.codigo
where b.codigo is null order by fecha,comprobant";
$exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
            $exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
			   if ( NumeroFilas($exc2)>0){
...
$SqlStr=" select * from $TablaEnc.movimien a left join oriomka_inavi.transacciones b on a.CT = b.codigo
where b.codigo is null order by fecha,comprobant";
$exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
//echo "           Las Cuentas Que no tienen Codigo <br>";			  	
            $bprimera = true;  
...
$SqlStr=" select * from $TablaEnc.movimiendif a left join oriomka_inavi.transacciones b on a.CT = b.codigo
where b.codigo is null order by fecha,comprobant";
$exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
//echo "           Las Cuentas Que no tienen Codigo <br>";			  	
            $bprimera = true;  
...
$SqlStr=" select * from $TablaEnc.movimien a left join oriomka_inavi.documentos  b on a.DT = b.codigo
where b.codigo is null order by fecha,comprobant";
$exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
//echo "           Las Cuentas Que no tienen Codigo <br>";			  	
            $bprimera = true;  
...
$SqlStr=" select * from $TablaEnc.movimiendif a left join oriomka_inavi.documentos b on a.DT = b.codigo
where b.codigo is null order by fecha,comprobant";
$exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
//echo "           Las Cuentas Que no tienen Codigo <br>";			  	
            $bprimera = true;  
...
$SqlStr=" select * from $TablaEnc.movimien a left join oriomka_inavi.centrocosto  b on a.im = b.codigo
where b.codigo is null order by fecha,comprobant";
$exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
//echo "           Las Cuentas Que no tienen Codigo <br>";			  	
            $bprimera = true;  
...
$SqlStr=" select * from $TablaEnc.movimiendif a left join oriomka_inavi.centrocosto b on a.im = b.codigo
where b.codigo is null order by fecha,comprobant";
$exc2 = EjecutarExec($con,$SqlStr) or die($SqlStr);
//echo "           Las Cuentas Que no tienen Codigo <br>";			  	
            $bprimera = true;  
