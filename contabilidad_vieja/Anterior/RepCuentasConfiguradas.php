...
//Cabecera de página
	function Header(){                                                         
      //  llamando a la funcion encabezado del fpdf
        ...
        $gerencia = $_SESSION["sDesBasedeDatos"];//empresa logueada
        //$titulo ="Configuracion del ". $this->TituloFormato;//titulo del reporte
		$titulo ="Configuracion del ".$TituloFormato;//titulo del reporte
