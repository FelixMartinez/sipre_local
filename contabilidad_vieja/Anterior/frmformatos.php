...
?>
			Formatos de los Reportes Financieros (Inclusión)
<?php 
	}else{
		$Desha = 'readonly class=cTexBoxdisabled';
?>
	  		Formatos de los Reportes Financieros (Modificación)
<?php } ?>
...
?>
			<button name=BtnBuscar type="submit" value=Buscar onClick="<?php print("PantallaBuscar('T_Codigo','$ArreGeneral')");?>"Class = inputBoton >Buscar</button>
...
?>
  			...
  			<button name="BtnVerConfiguracion" type="submit" value="Configuración del Reporte" onClick="VerConfiguracion();" >Configuración del Reporte</button>		   
        <script language='javascript'>
