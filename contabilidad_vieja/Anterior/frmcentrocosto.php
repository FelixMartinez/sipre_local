...
?>
			Centro de Costo (Inclusión)
<?php 
	}else{
   		$Desha = 'readonly class=cTexBoxdisabled';
?>
			Centro de Costo (Modificación)
<?php 
	} 
?>            
		</td>            
...
?>
		<td align="right"><hr/> 
        	<button name=BtnGuardar type="submit" value=Guardar onClick="<?php print("Ejecutar('$sEjecut')");?>" class=inputBoton>Guardar</button>
...
?>
			<button name=BtnBuscar type=button value=Buscar onClick="<?php print("PantallaBuscar('T_Codigo','$ArreGeneral')");?>"Class = inputBoton >Buscar</button> 

<?php
	if (!($StatusOculto =='LI' || $StatusOculto =='' || $StatusOculto =='DE')){ ?>
  			<button name=BtnIncluir type="submit" value=Incluir onClick="Ejecutar('LI');"class=inputBoton>Incluir</button>
  			<button name=BtnEliminar type="submit" value=Eliminar onClick="Ejecutar('DE');" class=inputBoton>Eliminar</button>
