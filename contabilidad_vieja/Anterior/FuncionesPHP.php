...
$CN ='MY';
		...
		//my_sql   
		 	mysql_select_db("oriomka_inavi", $Connec); //Abre la Base de Datos
		 	//mysql_select_db($_SESSION["sBasedeDatos"], $Connec); //Abre la Base de Datos			
		    $eje= mysql_query($StringSql,$Connec) or die($StringSql);
		   return $eje;
		 }
}//fin EjecutarExec()
...
$CN ='MY';
		...
		//my_sql   
		 	//mysql_select_db("oriomka_adcontabilidad", $Connec); //Abre la Base de Datos
		 	mysql_select_db("adcontabilidad", $Connec); //Abre la Base de Datos			
		   return mysql_query($StringSql,$Connec);
		 }
}//fin EjecutarExecAd()
	...
	$ejec = mysql_query($strSql,$con);
		...
		if($faltaCompletar){
			...
			window.onload = function(e){ 
				alert('Existen articulos con datos imcompletos');
