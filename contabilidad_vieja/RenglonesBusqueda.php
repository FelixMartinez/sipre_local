...
if ($_SESSION["CCSistema"] != ""){
	if ($sTabla == 'oriomka_inavi.cuenta'){
...
if (NumeroFilas($rs3)>0){
	while ($row =  ObtenerFetch($rs3)) {
		...
		if(($Tipo_pantalla == 'frmIntegracionContable')&&($id_campo != "i")){

			if(strlen($CodigoBuscar) > 11) { ?>
...
<?php		
		...
		}elseif (($Tipo_pantalla == 'frmIntegracionContable')&&($id_campo === "i")) { ?>
