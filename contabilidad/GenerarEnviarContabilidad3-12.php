...
function generarNotasCreditoCpAdORG($idTran=0,$Desde="",$Hasta=""){
	$con = ConectarBD();
	$ct='17';
	$dt='10';
	$cc='01';
...
/*			$cuentaMov = buscarContable(16,$id_motivo,$sucursal); // 61 = Notas de credito CxP
			$cuentaCXP = buscarContable(61,$idproveedor,$sucursal);	 // 16 = CXP Administrativo */ 
...
//------------------------------
function generarNotasCreditoCpAdNUEVA($idTran=0,$Desde="",$Hasta=""){
	$con = ConectarBD();
	$ct='17';
	$dt='10';
	$cc='01';
	...
	while ($row = ObtenerFetch($exec)) {
		...
		if(buscarDoc($id,$cc,$ct,$dt,$fecha) == 0){
			...
			if($Descuento == 0){
			// Compras sin descuentos
				ingresarRenglon($cuentacontable,$descripcion,$Deber,$Haber,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'H',$cc,$id);
				//NO VA - 28/07/2014
				/* Para insertar los terceros */
					/*ingresarEnlacesTerceros($cuentacontable,$fecha,$Debe,$Haber,$id_subsecion
					,"ga_subsecciones","id_subseccion|descripcion",$descripcion);*/
				...
				if(!in_array($id, $arrayIdFactura)){
					ingresarRenglon($cuentaiva,$descripcion,$montoiva,0,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'H',$cc,$id);
				}
				//NO VA - 28/07/2014
				/* Para insertar los terceros */
					/*ingresarEnlacesTerceros($cuentaiva,$fecha,$montoiva,0,$idproveedor
				...
				if ($MontoRetenidoIVA == 0){
					...
					$montoCXP = bcadd($Debe,$montoiva,2);
					$montoCXP = bcsub($montoCXP,$MontoRetenidoIVA,2);	 
					ingresarRenglon($cuentaRetenido,$descripcion,0,$MontoRetenidoIVA,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'D',$cc,$id);
					//NO VA - 28/07/2014
					/* Para insertar los terceros */
						/*ingresarEnlacesTerceros($cuentaRetenido,$fecha,0,$MontoRetenidoIVA,$idproveedor
						,"cp_proveedor","id_proveedor|nombre",$descripcion);*/
				...
				if ($valor==1){ //Venezuela
					ingresarRenglon($cuentaCXP,$descripcion,$montoTotal,0,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'H',$cc,$id);
					ingresarRenglon($cuentaMov,$descripcion,0,$monto,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'D',$cc,$id);		
				}else if($valor==2){ //Panamá 				
					ingresarRenglon($cuentaCXP,$descripcion,$montoTotal,0,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'D',$cc,$id);					
					if(!in_array($id, $arrayIdFactura)){//
						ingresarRenglon($cuentaCXP,$descripcion,$montoiva,0,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'D',$cc,$id);
					}
					ingresarRenglon($cuentaMov,$descripcion,0,$monto,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'D',$cc,$id);		
				}else if ($valor==3){ //Puerto Rico
					ingresarRenglon($cuentaCXP,$descripcion,$montoTotal+$montoiva,0,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'H',$cc,$id);
					ingresarRenglon($cuentaMov,$descripcion,0,$monto,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'D',$cc,$id);	
				}
			...
			// Compras con descuentos
				ingresarRenglon($cuentacontable,$descripcion,$Debe,$Haber,$documento,$ct,$dt,$cc,$icomprobant,$fecha,'H',$cc,$id);
				//NO VA - 28/07/2014
				/* Para insertar los terceros */
					/*ingresarEnlacesTerceros($cuentacontable,$fecha,$Debe,$Haber,$idproveedor
					,"cp_proveedor","id_proveedor|nombre",$descripcion);*/
