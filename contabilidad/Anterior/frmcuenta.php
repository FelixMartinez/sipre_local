...
<table width="100%">
	...
	<tr>    
		<td><fieldset>
		  <legend class="legend">Datos del Catálogo</legend>
        	<table border="0" align="center">
        		<tr>
    				<td  height=20 class="tituloCampo" width="140" valign="top" align="right">
                    ...
                    <td  height=20 class="tituloCampo" width="140"valign="top" align="right"> Debe Cierre:</td>			
...
?> 
				...
				<tr>
		 			<td  height=20 class="tituloCampo" width="140" valign="top" align="right">
			         	<span class="textoRojoNegrita">*</span> Descripción:
                    </td>
          			<td height=20 align="left" valign="top">
                   	...
                   	<td  height=20 class="tituloCampo" width="140"valign="top" align="right"> Haber Cierre:
                    </td>				  
            		<td height=20 align="left" valign="top">
...
?>
				...
				<tr>
					<td  height=20 class="tituloCampo" width="140"valign="top" align="right">&Uacute;ltimo Movimiento:
					</td>
		  			<td height=20 align="left" valign="top">
               		...
               		<td  height=20 class="tituloCampo" width="140"valign="top" align="right"> Deshabilitar:
                    </td>
...
?>
    			...
    			<tr>
     				<td  height=20 class="tituloCampo" width="140"valign="top" align="right">Saldo Anterior:
					</td>
		  			<td height=20 align="left" valign="top">
...
?>
                   	...
                   	<td  height=20 class="tituloCampo" width="140"valign="top" align="right"> Fecha Deshabilitado:
                    </td>				  
            		<td height=20 align="left" valign="top">
...
?>
				...
				<tr>
					<td  height=20 class="tituloCampo" width="140"valign="top" align="right"> Debe:
                    </td>				  
            		<td height=20 align="left" valign="top">
                    ...
                    <td height=20 class="tituloCampo" width="140"valign="top" align="right">Centro Costo:
                    </td>
...
?>
            <td  height=20 class="tituloCampo" width="140"valign="top" align="right"> Haber:</td>
    ...
    ?>
            ...
            <td  height=20 class="tituloCampo" width="140"valign="top" align="right"> Bancaria:</td>
...
<?PHP
  ...
  $sEjecut='UP';
                ...
                <tr>
                <td align="right"><hr/>                
           <button name=BtnGuardar type="submit" value=Guardar onClick="<?php print("Ejecutar('$sEjecut');");?>" >Guardar</button>
...
?>
        <button name=BtnBuscar type="submit" value=Buscar onClick="<?php print("PantallaBuscar('T_Codigo','$ArreGeneral')");?>" >Buscar</button> 

<?php
 if (!($StatusOculto =='LI' || $StatusOculto =='' || $StatusOculto =='DE')){ ?>
  <button name=BtnIncluir type="submit" value=Incluir onClick="Ejecutar('LI');">Incluir</button>
  <button name=BtnEliminar type="submit" value=Eliminar onClick="Ejecutar('DE');">Eliminar</button>
        <script language='javascript'>
