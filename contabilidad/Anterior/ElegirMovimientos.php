...
<head>
    ...
    function Entrar(){
		...
		document.ElegirMovimientos.method='post';
		document.ElegirMovimientos.action='frmDiarios.php?oTablaSelec='+document.ElegirMovimientos.oTablaSelec.value;
		document.ElegirMovimientos.submit();
    }
...
?>
                                    <input type="text" id="oCC" name="oCC" <?=$sReadonly?> class='cTexBox' maxlength="8" onBlur="<?php print("BuscarDescripGeneral(this.value,'$sClaveCon','$ArreCC')");?>" onDblClick="<?php print("AbrirBus(this.name,'$ArreCC')");?>" onKeyPress="fn(this.form,this,event,'xDFecha')" size="10" style="text-align:right" value="<?=$oCC?>">
