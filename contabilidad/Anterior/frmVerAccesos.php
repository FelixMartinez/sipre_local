...
<table width="100%"  align="center">
	<tr>
  	...
  	<tr>
    	<td align="right" width="685" >
        	<button class="inputBoton" name="BtnGuardar" type="button" value="Guardar" onClick="GuardarAcceso();">Guardar</button>
        </td>
        <td align="right" width="94" >
        	<button class="inputBoton" name="BtnRegresar" type="button" value="<< Regresar" onClick="Regresar();">Regresar</button>
        </td>
        <td align="right" width="98" >
        	<button class="inputBoton" name="BtnAsignar" type="button" value="Asignar Todos" onClick="Asignar();">Asignar Todos</button>
        </td>
        <td align="right" width="90" >
        	<button class="inputBoton" name="BtnQuitar" type="button" value="Quitar Todos" onClick="Quitar();">Quitar Todos</button>
         </td>
  </tr>
</table>  
...
<?php   if ($Tipo == 'P'){  ?>
    <td width=250 height="16" align="left" valign="top" class=cabecera><font style="font-weight:bold"><?php print($Descripcion);?> </font></td> 
<?php   }else{ ?>
     <td width=250 align="left" height="16" valign="top" class=cabecera><?php print($Descripcion);?></td> 
<?php  } ?>	
<?php 
     if ($Tipo == 'T' ||$Tipo == 'C'){  
?>     	
    <td width=50 align="center" height="16" valign="top">
