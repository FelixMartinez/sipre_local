...
?>
		<td align="right"><hr/>
        	<button name=BtnGuardar type=button value=Guardar onClick="<?php print("Ejecutar('$sEjecut')");?>" class=inputBoton>Guardar</button>
...
<?php
	if (!($StatusOculto =='LI' || $StatusOculto =='' || $StatusOculto =='DE')){ 
?>
  			<button name=BtnIncluir type="submit" value=Incluir onClick="Ejecutar('LI');"class=inputBoton>Incuir</button>
