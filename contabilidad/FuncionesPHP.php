...
//my_sql
  ...
  return mysql_connect("localhost","root","");//return mysql_connect("localhost","oriomka_root","oriomka");Realiza la coneccion al Servidor Remoto
...
$CN ='MY';
		...
		//my_sql
		  $link = mysql_connect("localhost","root","");//$link = mysql_connect("localhost","oriomka_root","oriomka");Realiza la coneccion al Servidor Remoto
...
function CargarSaldosORG($cDesde1,$cHasta1,$cDesde2='',$cHasta2='',$icierre = 0){
$con = ConectarBD();
