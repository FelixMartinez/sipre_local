        ...
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                	...
                	<td id="tdlstTipoTransaccionnBuscar"></td>
				</tr>
                <tr align="left">
                	<td></td>
                	<td></td>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <tr>
                                ...
                                <td>Motivo No Fijo(Editable)</td>
                                <td><img src="img/iconos/pencil_gris.png"/></td>
                                <td>Motivo Fijo (No Editable)</td>
                            </tr>
                            </table>
                        </td>
                    </tr>
...
xajax_cargaLstModuloAdministracion("lstModuloAdministracionBuscar", "byId('btnBuscar').click();");
xajax_cargaLstTipoTransaccion("lstTipoTransaccionnBuscar", "byId('btnBuscar').click();");
xajax_listaMotivo(0, 'id_motivo', 'ASC');
