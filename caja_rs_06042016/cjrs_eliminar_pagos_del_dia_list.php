...
if(!(validaAcceso("cjrs_eliminar_pagos_del_dia_list"))) {
...
include("controladores/ac_cjrs_eliminar_pagos_del_dia_list.php");
...
<head>
	...
	<title>.: SIPRE 2.0 :. Caja de Repuestos y Servicios - Eliminación de Pagos Cargados del Día</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Eliminación de Pagos Cargados del Día</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr class="noprint">
			<td align="right">
				...
				<form id="frmBuscar" name="frmBuscar" onsubmit="byId('btnBuscar').click(); return false;" style="margin:0">
					...
					<tr>
						<td align="right" class="tituloCampo" width="150">Tipo de Pago:</td>
						<td id="tdSelTipoPago">
						<select id="lstTipoPago" name="lstTipoPago" class="inputHabilitado">
							<option value="-1">[ Todos ]</option>
						</select>
						<script>
			...
			<td>
				...
				<tr>
					...
					<td width="68%">
						...
						<input type="hidden" id="hddModulo" name="hddModulo" readonly="readonly" size="30" value="cj_rs_eliminar_pagos"/>
...
xajax_listadoPagosDelDia(0,'','ASC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|');
