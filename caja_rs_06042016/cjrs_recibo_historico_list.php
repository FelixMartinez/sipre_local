...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Caja de Repuestos y Servicios - Histórico de Recibos</title>
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstTipoDcto" name="lstTipoDcto" onchange="byId('btnBuscar').click();">
                        	...
                        	<option value="2">Nota de Cargo</option>
			...
			<td>
				...
				<tr>
					...
					<td align="center">
						<table>
						<tr>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Factura Venta PDF / Nota de Cargo PDF</td>
                            <td>&nbsp;</td>
