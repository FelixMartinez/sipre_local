...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Caja de Repuestos y Servicios - Devolución de Venta</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
        	<td class="tituloPaginaCajaRS">Devolución de Venta</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
        	...
        	<td>
                <div class="wrap">
                    ...
                    <div class="pane">
                        ...
                        <tr>
                            <td>
                                <button type="button" onclick="xajax_imprimirDevolucionRepuestos(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                            </td>
                        </tr>
                        </table>
...
xajax_listaFacturaVenta(0,'idNotaCredito','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
xajax_listaFacturaVentaServicio(0,'idFactura','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
xajax_listaFacturaVentaAdmon(0,'idFactura','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
