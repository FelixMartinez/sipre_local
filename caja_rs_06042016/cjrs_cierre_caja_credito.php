...
<head>
	...
	<title>.: SIPRE 2.0 :. Caja de Repuestos y Servicios - Corte de Caja/Crédito</title>
					...
					<tr>
						<td colspan="5" class="noprint" bgcolor="#FFFFFF" scope="row" style="text-align:right">
							<button type="button" id="btnImprimir" name="btnImprimir" onclick="window.print();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_print.png"/></td><td>&nbsp;</td><td>Imprimir</td></tr></table></button>
                                <!--<button type="button" id="btnCierreTotal" name="btnCierreTotal" onclick="window.location.href = 'cjrs_pagos_cargados_dia_credito.php?acc=2'"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/key_go.png"/></td><td>&nbsp;</td><td>Cierre Total</td></tr></table></button>-->
...
function saldosDeCierre($montoApertura){
	...
	WHERE ((pa.fechaPago = (SELECT ape.fechaAperturaCaja AS fechaAperturaCaja
		...
		AND cj_cc_encabezadofactura.condicionDePago = 0) %s
