...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Caja de Repuestos y Servicios - Pago de Nota de Cargo</title>
	...
	function validarAgregarAnticipoNotaCredito(){
		...
		if (parseFloat(saldo) < parseFloat(monto))
			...
			if (parseFloat(montoFaltaPorPagar) >= parseFloat(monto)){
				...
				alert("El monto a pagar no puede ser mayor que el saldo de la Nota de Cargo")
		}
	}
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Pago de Nota de Cargo</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
				...
				<tr>
					<td colspan="4">
						...
						<tr>
							...
							<fieldset><legend class="legend">Datos de la Nota de Cargo</legend>
								<input type="hidden" id="hddIdNotaCargo" name="hddIdNotaCargo"/>
								<table border="0" width="100%">
								<tr>
									<td align="right" class="tituloCampo" width="120">Nro. Nota de Cargo:</td>
									<td>
								...
								<tr>
									...
									<td align="left" id="tdDeparmamento" width="120"><input type="text" id="txtDepartamento" name="txtDepartamento" size="20" readonly="readonly"/></td>
								</tr>
								<tr>
									<td align="right" class="tituloCampo" width="120">Saldo Nota de Cargo:</td>
		...
		<tr>
			<td>
				...
				<tr class="tituloColumna">
					...
					<td colspan="4"><strong>Monto Pagado de la Nota de Cargo:
...
xajax_cargarNotaCargo(<?php echo $_GET['id_nota_cargo'] ?>);
