...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Caja de Repuestos y Servicios - Notas de Cargo por Pagar</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Notas de Cargo por Cobrar</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td>
				...
				<tr>
					<td>
						<button type="button" onclick="xajax_imprimirNotaCargo(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
					</td>
				</tr>
				</table>
			...
			<td>
				...
				<tr>
					...
					<td align="center">
						<table>
						<tr>
							<td><img src="../img/iconos/money_add.png"/></td><td>Pagar Nota de Cargo</td>
                            <td>&nbsp;</td>
