...
<head>
	...
	<title>.: SIPRE 2.0 :. Caja de Repuestos y Servicios - Histórico de Cierre/Crédito</title>
	...
	<body>
		<div id="divGeneralPorcentaje">
			...
			<div id="divInfo">
				...
				<tr>
					<td align="center" class="tituloPaginaCajaRS">Corte de Caja (Repuestos y Servicios)<br/><span class="textoNegroNegrita_10px">(Resumen de Saldos - CRÉDITO)</span></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
...
function saldosDeCierre($montoApertura){
	...
	WHERE
		...
		AND cj_cc_encabezadofactura.condicionDePago = 0
		AND pa.idCaja = 2
		%s
	...
	GROUP BY nc.idFormaPago",
		$andEmpresa2,$andEmpresa3,$andEmpresa4);
