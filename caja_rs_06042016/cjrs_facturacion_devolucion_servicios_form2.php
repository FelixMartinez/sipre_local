				...
				<tr>
					...
					<td valign="top" width="50%">
						...
						<tr align="right" id="trGastosSinIva">
							...
							<td></td>
							<td>
								<input type="hidden" id="hddIdIvaVenta" name="hddIdIvaVenta" readonly="readonly"/>
								<input type="text" id="txtIvaVenta" name="txtIvaVenta" readonly="readonly" size="6" style="text-align:right"/>%</td>
							<td align="right"><input type="text" id="txtTotalIva" name="txtTotalIva" readonly="readonly" size="18" style="text-align:right" class="inputSinFondo"/></td>
						</tr>
