...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////// HISTORICO DE FACTURAS DE REPUESTOS ///////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($totalRows > 0) {
	...
	while ($contFila<1) {
		...
		if ($contFila % 45 == 1) {
			...
			$pdf->Cell(762,5,"FACTURAS IMPRESAS",0,0,'C');
			...
			$arrayTamCol = array("100","100","100","50","50","50","50","100","45","50","50");
		...
		while ($rowDetalle = mysql_fetch_assoc($rsDetalle)){
			...
			$pdf->Cell($arrayTamCol[3],12,date("d-m-Y", strtotime($rowDetalle['fechaRegistroFactura'])),'LR',0,'C',true);
			$pdf->Cell($arrayTamCol[4],12,utf8_encode($rowDetalle['fechaVencimientoFactura']),'LR',0,'C',true);
			...
			$pdf->Cell($arrayTamCol[8],12,utf8_encode($rowDetalle['descripcion_estado_factura']),'LR',0,'C',true);
			$pdf->Cell($arrayTamCol[9],12,utf8_encode($rowDetalle['saldoFactura']),'LR',0,'R',true);
