...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Caja de Repuestos y Servicios - Histórico de Notas de Crédito</title>
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td>
                ...
                <tr>
                    <td>
                        <button type="button" onclick="xajax_imprimirNotaCredito(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                    </td>
                </tr>
                </table>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <select multiple id="lstEstadoNotaCredito" name="lstEstadoNotaCredito" onchange="byId('btnBuscar').click();">
                            <option value="-1">[ Seleccione ]</option>
		...
		<tr>
			<td><div id="divListaNotaCreditoVenta" style="width:100%"></div></td>
		</tr>
		<tr>
			<td>
				...
				<tr>
					...
					<td align="center">
						<table>
						<tr>
							<td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Nota Crédito PDF</td>
							<td>&nbsp;</td>
		...
		<tr>
			<td align="right"><hr>
                ...
                <tr align="right" class="trResaltarTotal">
                    <td class="tituloCampo" width="120">Saldo Nota(s) Crédito:</td>
...
xajax_listaNotaCreditoVenta(0,'idNotaCredito','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value +
