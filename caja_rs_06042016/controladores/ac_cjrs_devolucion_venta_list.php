...
function imprimirDevolucionRepuestos($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjrs_devolucion_respuestos_pdf.php?valBusq=%s',890,550)", $valBusq));
...
function listaFacturaVentaAdmon($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaFacturaVentaAdmon", "6%", $pageNum, "id_pedido_venta_propio", $campOrd, $tpOrd, $valBusq, $maxRows, "Nro. Pedido");
		$htmlTh .= ordenarCampo("xajax_listaFacturaVentaAdmon", "6%", $pageNum, "id_pedido_venta_referencia", $campOrd, $tpOrd, $valBusq, $maxRows, "Nro. Referencia");
