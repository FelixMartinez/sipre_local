...
function imprimirNotaCredito($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjrs_nota_credito_impresa_pdf.php?valBusq=%s',890,550)", $valBusq));
...
function listaNotaCredito($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaNotaCredito", "10%", $pageNum, "nombre_cliente", $campOrd, $tpOrd, $valBusq, $maxRows, "Cliente");
		...
		$htmlTh .= ordenarCampo("xajax_listaNotaCredito", "5%", $pageNum, "fecha_hora", $campOrd, $tpOrd, $valBusq, $maxRows, "Fecha / Hora Impresora");
		$htmlTh .= ordenarCampo("xajax_listaNotaCredito", "5%", $pageNum, "consecutivo_serial", $campOrd, $tpOrd, $valBusq, $maxRows, "Consecutivo Fiscal / Serial Impresora");
	...
	$objResponse->assign("spnTotalNotasCredito","innerHTML",number_format($totaNotasCredito, 2, ".", ","));
