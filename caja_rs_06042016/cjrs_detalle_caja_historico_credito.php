...
<div id="divGeneralPorcentaje">
	...
	<tr>
		<td align='center' colspan='2'><strong>CORTE DE CAJA (REPUESTOS Y SERVICIOS)<BR>RECIBOS POR MEDIO DE PAGO - CRÉDITO</strong></td>
	</tr>
	</table>	
	<br>
...
while ($rowFormaPago = mysql_fetch_array($consultaFormaPago)) {
    ...
    <tr align="right" height="22">
        <td class="tituloColumna" width="94%">Total Credito:</td>
