...
$objPHPExcel->getActiveSheet()->setCellValue("P".$contFila, "Piezas");
$objPHPExcel->getActiveSheet()->setCellValue("Q".$contFila, "Saldo Factura");
...
while ($row = mysql_fetch_assoc($rs)) {
	...
	$objPHPExcel->getActiveSheet()->setCellValue("M".$contFila, ((strlen($row['observacion_factura']) > 0) ? utf8_encode($row['observacion_factura']) : ""));
	$objPHPExcel->getActiveSheet()->setCellValue("N".$contFila, $row['estado_factura']);
	$objPHPExcel->getActiveSheet()->setCellValue("O".$contFila, $row['cant_items']);
	$objPHPExcel->getActiveSheet()->setCellValue("P".$contFila, $row['cant_piezas']);
	$objPHPExcel->getActiveSheet()->setCellValue("Q".$contFila, $row['saldo_factura']);
...
$objPHPExcel->getActiveSheet()->setCellValue("P".$contFila, $arrayTotal[14]);
$objPHPExcel->getActiveSheet()->setCellValue("Q".$contFila, $arrayTotal[15]);
