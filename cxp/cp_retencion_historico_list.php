    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_imprimirRetencion(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF por Lote</td></tr></table></button>
                    </td>
                </tr>                
                </table>
