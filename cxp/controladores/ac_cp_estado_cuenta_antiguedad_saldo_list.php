...
function cargarTipoDocumento(){
	...
	$array = array(1 => "Factura", 2 => "Nota de Débito", 3 => "Anticipo", 4 => "Nota de Crédito");
	...
	while ($row = mysql_fetch_array($rsLimit)) {
		...
		if (in_array($valCadBusq[3],array(3))) { // 3 = General por Proveedor, 4 = General por Dcto.
			...
			$htmlTb .= "<tr align=\"left\" class=\"trResaltarTotal\" height=\"24\">";
				...
				$htmlTb .= "<td class=\"tituloCampo\" colspan=\"11\">".utf8_encode($row['nombre_proveedor'])."</td>";
			$htmlTb .= "</tr>";
		...
		while ($rowEstado = mysql_fetch_array($rsEstado)) {
			...
			switch ($rowEstado['tipoDocumentoN']) {
				case 1 : // 1 = Factura
					$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_factura_form.php?id=".$rowEstado['idFactura']."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Factura Venta")."\"/><a>";
					switch ($rowEstado['id_modulo']) {
						case 0 : // REPUESTOS
							$aVerDcto .= sprintf("<a href=\"javascript:verVentana('../repuestos/reportes/iv_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Registro Compra PDF")."\"/></a>",
								$rowEstado['idFactura']);
							break;
						case 1 : // SERVICIOS
							/*$aVerDcto .= sprintf("<a href=\"javascript:verVentana('../servicios/sa_imprimir_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Registro Compra PDF")."\"/></a>",
								$rowEstado['id_orden_tot']);*/
							break;
						case 2 : // VEHICULOS
							$aVerDcto .= sprintf("<a href=\"javascript:verVentana('../vehiculos/reportes/an_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Registro Compra PDF")."\"/></a>",
								$rowEstado['idFactura']);
							break;
						case 3 : // ADMINISTRACION
							$aVerDcto .= sprintf("<a href=\"javascript:verVentana('../compras/reportes/ga_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Registro Compra PDF")."\"/></a>",
								$rowEstado['idFactura']);
							break;
					}
					break;
				case 2 : // 2 = Nota Cargo
					$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_nota_cargo_form.php?id=".$rowEstado['idFactura']."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Nota de Débito")."\"/><a>";
				...
				case 4 : // 4 = Nota Credito
					$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_nota_credito_form.php?id=".$rowEstado['idFactura']."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Nota de Crédito")."\"/><a>";
			...
			if (in_array($valCadBusq[3],array(3,4))) { // 3 = General por Proveedor, 4 = General por Dcto.
				...
				$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
					...
					$htmlTb .= "<td align=\"center\">".date("d-m-Y",strtotime($rowEstado['fecha_origen']))."</td>";
					$htmlTb .= "<td align=\"center\" nowrap=\"nowrap\">".date("d-m-Y",strtotime($rowEstado['fecha_vencimiento']))."</td>";
		...
		if (in_array($valCadBusq[3],array(3))) { // 3 = General por Proveedor, 4 = General por Dcto.
			$htmlTb .= "<tr align=\"left\" class=\"trResaltarTotal\" height=\"24\">";
				$htmlTb .= "<td align=\"right\" class=\"tituloCampo\" colspan=\"7\">".utf8_encode($row['nombre_proveedor']).":</td>";
...
function listaECIndividual($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 10000, $totalRows = NULL) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaECIndividual", "10%", $pageNum, "saldoFactura", $campOrd, $tpOrd, $valBusq, $maxRows, "Saldo");
		$htmlTh .= ordenarCampo("xajax_listaECIndividual", "10%", $pageNum, "saldoFactura", $campOrd, $tpOrd, $valBusq, $maxRows, "Cta. Corriente");
	...
	while ($row = mysql_fetch_array($rsLimit)) {
		...
		switch ($row['tipoDocumentoN']) {
			case 1 : // 1 = Factura
				$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_factura_form.php?id=".$row['idFactura']."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Registro Compra")."\"/><a>";
				switch ($row['id_modulo']) {
					case 0 : // REPUESTOS
						$aVerDcto .= sprintf("<a href=\"javascript:verVentana('../repuestos/reportes/iv_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Registro Compra PDF")."\"/></a>",
							$row['idFactura']);
				...
				break;
			case 2 : // 2 = Nota Cargo
				$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_nota_cargo_form.php?id=".$row['idFactura']."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Nota de Débito")."\"/><a>";
				$aVerDcto .= sprintf("<a href=\"javascript:verVentana('../cxp/reportes/cp_nota_cargo_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Nota de Débito PDF")."\"/><a>",
					$row['idFactura']);
				break;
			case 3 : // 3 = Anticipo
				...
				break;
			case 4 : // 4 = Nota Credito
				$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_nota_credito_form.php?id=".$row['idFactura']."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Nota de Crédito")."\"/><a>";
				$aVerDcto .= sprintf("<a href=\"javascript:verVentana('../cxp/reportes/cp_nota_credito_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Nota de Crédito PDF")."\"/><a>",
					$row['idFactura']);
				break;
			default :
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"center\" nowrap=\"nowrap\">".date("d-m-Y",strtotime($row['fecha_vencimiento']))."</td>";
