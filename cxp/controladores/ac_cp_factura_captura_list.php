...
function listaRegistroCompra($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td>";
			if (date("d-m-Y",strtotime($row['fecha_origen'])) == date("d-m-Y") || in_array($row['estatus_factura'],array(0))) {
				$htmlTb .= sprintf("<a href=\"cp_factura_form.php?id=%s&vw=e\" target=\"_self\"><img src=\"../img/iconos/pencil.png\" title=\"Editar\"/></a>",
					$row['id_factura']);
			}
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";
				$htmlTb .= sprintf("<a href=\"cp_factura_form.php?id=%s&vw=v\" target=\"_self\"><img src=\"../img/iconos/ico_view.png\" title=\"Ver\"/></a>",
					$row['id_factura']);
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";
			switch ($row['id_modulo']) {
				case 0 : // REPUESTOS
					$htmlTb .= sprintf("<a href=\"javascript:verVentana('../repuestos/reportes/iv_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"Registro Compra PDF\"/></a>",
						$row['id_factura']);
					break;
				case 1 : // SERVICIOS
					$htmlTb .= sprintf("<a href=\"javascript:verVentana('../servicios/sa_imprimir_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"Registro Compra PDF\"/></a>",
						$row['id_orden_tot']);
					break;
				case 2 : // VEHICULOS
					$htmlTb .= sprintf("<a href=\"javascript:verVentana('../vehiculos/reportes/an_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"Registro Compra PDF\"/></a>",
						$row['id_factura']);
					break;
				case 3 : // ADMINISTRACION
					$htmlTb .= sprintf("<a href=\"javascript:verVentana('../compras/reportes/ga_registro_compra_pdf.php?valBusq=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"Registro Compra PDF\"/></a>",
						$row['id_factura']);
					break;
			}
			$htmlTb .= "</td>";
