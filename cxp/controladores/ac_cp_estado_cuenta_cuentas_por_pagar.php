...
function listaFacturaIndividual($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 2000, $totalRows = NULL) {
	...
	while ($row = mysql_fetch_array($rsLimit)) {
		...
		$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_factura_form.php?id=".$idFactura."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Registro Compra")."\"/><a>";
		switch ($row['id_modulo']) {
			case 0 : // REPUESTOS
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"right\">";
				...
				$htmlTb .= "<tr>";
					...
					$htmlTb .= "<td>".$imgDevuelta.$row['numero_factura_proveedor']."</td>";
				$htmlTb .= "</tr>";
				$htmlTb .= "</table>";
			$htmlTb .= "</td>";
			$htmlTb .= "<td align=\"right\">".$row['id_proveedor']."</td>";
...
function listaNotaCargoIndividual($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 2000, $totalRows = NULL) {
	...
	while ($row = mysql_fetch_array($rsLimit)) {
		...
		$aVerDcto = "<a id=\"aVerDcto\" href=\"cp_nota_cargo_form.php?id=".$idNotaCargo."&vw=v\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\" title=\"".utf8_encode("Ver Nota de Débito")."\"/><a>";
		$aVerDcto .= "<a href=\"javascript:verVentana('../cxp/reportes/cp_nota_cargo_pdf.php?valBusq=".$idNotaCargo."', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Nota de Débito PDF")."\"/><a>";
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"right\">";
				...
				$htmlTb .= "<tr>";
					$htmlTb .= "<td align=\"left\" width=\"100%\">".$aVerDcto."</td>";
					$htmlTb .= "<td>".$imgDevuelta.$row['numero_notacargo']."</td>";
				$htmlTb .= "</tr>";
				$htmlTb .= "</table>";
			$htmlTb .= "</td>";
			$htmlTb .= "<td align=\"right\">".$row['id_proveedor']."</td>";
