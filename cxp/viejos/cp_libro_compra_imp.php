...
<body>
	<div id="divGeneralPorcentaje">
        ...
        <tr>
        	<td id="tdLibroCompra"></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
	        <td id="tdCuadroLibroCompra"></td>
        </tr>
        <tr class="noprint">
...
<script>
xajax_listaLibroCompra(0,'','',"<?php echo $_GET['f1']; ?>|<?php echo $_GET['f2']; ?>|<?php echo $_GET['modulos']; ?>|<?php echo $_GET['lstFormatoNumero']; ?>");
</script>