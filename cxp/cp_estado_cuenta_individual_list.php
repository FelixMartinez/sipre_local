                    ...
                    <fieldset><legend class="legend">Tipo de Estado de Cuenta</legend>
                        ...
                        <tr align="left">
                    		...
                    		<td valign="top">
                            	<table border="0" width="100%">
                                <tr>
                                    <td width="50%"><label><input type="checkbox" id="cbxDcto" name="cbxDcto[]" checked="checked" value="1"/> FACTURA</label></td>
                                    <td width="50%"><label><input type="checkbox" id="cbxDcto" name="cbxDcto[]" checked="checked" value="2"/> NOTA DE CARGO</label></td>
								</tr>
                                <tr>
                                    <td><label><input type="checkbox" id="cbxDcto" name="cbxDcto[]" checked="checked" value="3"/> ANTICIPO</label></td>
                                    <td><label><input type="checkbox" id="cbxDcto" name="cbxDcto[]" checked="checked" value="4"/> NOTA DE CRÉDITO</label></td>
                                </tr>
                                </table>
                            </td>
                        </tr>
