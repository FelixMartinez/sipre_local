    ...
    <div id="divInfo" style="text-align:center">
        ...
        <tr>
            <td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_imprimirReporte(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
...
window.onload = function(){
	jQuery(function($){
	   $("#txtFecha").maskInput("9999",{placeholder:" "});
	});
