...
function formComisionProduccion($frmBuscar) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= "<td width=\"13%\">% Productividad / Eficiencia</td>";
		$htmlTh .= "<td width=\"13%\">UT'S</td>";
		$htmlTh .= "<td width=\"13%\">UT'S Físicas</td>";
		$htmlTh .= "<td width=\"13%\">".cAbrevMoneda."</td>";
	$htmlTh .= "</tr>";
...
function guardarComisionProduccion($frmComisionProduccion, $frmBuscar) {
	...
	while ($row = mysql_fetch_assoc($rs)) {
		switch ($row['idDepartamentoOrigenFactura']) {
			case 0 : $Result1 = generarComision($row['idFactura'], false); $arrayFactura[] = $row['numeroFactura']; break;
			case 1 : $Result1 = calcular_comision_factura($row['idFactura'], false); $arrayFactura[] = $row['numeroFactura']; break;
		}
	...
	if (!$rs) { errorGuardarComisionProduccion($objResponse); return $objResponse->alert(mysql_error()."\nError Nro: ".mysql_errno()."\nLine: ".__LINE__); }
	while ($row = mysql_fetch_assoc($rs)) {
		$Result1 = calcular_comision_vale_salida($row['id_vale_salida'], false); $arrayValeSalida[] = $row['numero_vale'];
		if ($Result1[0] != true) { errorGuardarComisionProduccion($objResponse); return $objResponse->alert($Result1[1]); }
	}
	...
	while ($row = mysql_fetch_assoc($rs)) {
		switch ($row['idDepartamentoOrigenFactura']) {
			case 0 : $Result1 = devolverComision($row['idNotaCredito'], false); $arrayNotaCredito[] = $row['numeracion_nota_credito']; break;
			case 1 : $Result1 = devolverComisionNC($row['idNotaCredito'], $row['idDocumento'], false); $arrayNotaCredito[] = $row['numeracion_nota_credito']; break;
		}
		if ($Result1[0] != true) { errorGuardarComisionProduccion($objResponse); return $objResponse->alert($Result1[1]); }
	}
...
function listaComision($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 1, $totalRows = NULL) {
	...
	while ($rowComision = mysql_fetch_assoc($rsLimitComision)) {
		...
		$valComision = mysql_num_rows($rsDetalle);
		
		while ($rowDetalle = mysql_fetch_assoc($rsDetalle)) {
			
			$queryArt = sprintf("SELECT DISTINCT comi.id_comision, acc.id_accesorio, com_art.monto, acc.nom_accesorio
					FROM pg_comision_empleado com_emp
					LEFT JOIN pg_comision comi ON comi.id_cargo_departamento = com_emp.id_cargo_departamento
					...
					JOIN cj_cc_encabezadofactura encf ON encf.idFactura = facc.id_factura
					WHERE comi.tipo_importe = 5 AND comi.tipo_comision = 5 AND com_emp.id_cargo_departamento = %s AND encf.numeroFactura = %s AND com_emp.id_empleado = %s;",
					valTpDato($rowComision['id_cargo_departamento'], "int"),
					valTpDato($rowDetalle['numero_documento'], "int"),
					valTpDato($rowComision['id_empleado'], "int"));
			$rsArt = mysql_query($queryArt);
			$totalRowsComision = mysql_num_rows($rsArt);
			...
			if(!$encabezado){
				...
				if ($arrayTotalVehic[0][7] > 0) {
					$htmlTb .= "<td>"."G-Bonus"."</td>";
					$htmlTb .= "<td>"."D-Bonus"."</td>";
					$htmlTb .= "<td>"."V-Bonus"."</td>";
					$htmlTb .= "<td>"."Contrato Servicio"."</td>";
					$htmlTb .= "<td>"."Hunter"."</td>";
					$htmlTb .= "<td>"."Protective"."</td>";
					$htmlTb .= "<td>"."Tire & Wheels"."</td>";
					$htmlTb .= "<td>"."Prot. De Pago"."</td>";
					$htmlTb .= "<td>"."Traffic Box"."</td>";
				}
			...
			if($rowDetalle['costo_compra'] > 0){
				$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
					...
					if ($arrayTotalVehic[0][7] > 0) {
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['GAP'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['DOBLE SEGURO'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['SEGURO'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['contrato_servicio'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['HUNTER'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['THE PROTECTOR'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['TIRE AND WHEELS'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							$htmlTb .= number_format($signo * $rowArt['prot_pago'], 3, ".", ",");
						$htmlTb .= "</td>";
						$htmlTb .= "<td width=\"6%\">";
							if($rowArt['TRAFFIC BLACK BOX (SOLO CAMARA)'] > 0) {
								$htmlTb .= number_format($signo * $rowArt['TRAFFIC BLACK BOX (SOLO CAMARA)'], 3, ".", ",");
							} else if($rowArt['TRAFFIC BLACK BOX (CON GPS)']){
								$htmlTb .= number_format($signo * $rowArt['TRAFFIC BLACK BOX (CON GPS)'], 3, ".", ",");
							} else{
								$htmlTb .= number_format($signo * 0, 3, ".", ",");
							}
						$htmlTb .= "</td>";		
					}
					$htmlTb .= "<td width=\"4%\">";
		...
		if ($arrayTotalVehic[0][7] > 0) {
			$htmlTh .= "<tr align=\"left\" class=\"trResaltar4\" height=\"24\">";
				$htmlTh .= "<td align=\"right\" class=\"tituloCampo\" colspan=\"7\" rowspan=\"3\">"."Empleado:"."</td>";
				$htmlTh .= "<td colspan=\"8\">".$rowComision['cedula']."</td>";
				$htmlTh .= "<td align=\"right\" class=\"tituloCampo\" colspan=\"4\">"."Mes / Año:"."</td>";
				$htmlTh .= "<td align=\"center\" colspan=\"6\">".$mes[$rowComision['mes_documento']]." ".$rowComision['ano_documento']."</td>";
			$htmlTh .= "</tr>";
			$htmlTh .= "<tr align=\"left\" class=\"trResaltar4\" height=\"24\">";
				$htmlTh .= "<td colspan=\"8\">".utf8_encode($rowComision['nombre_empleado'])."</td>";
				$htmlTh .= "<td align=\"right\" class=\"tituloCampo\" colspan=\"4\">"."% Productividad / Eficiencia:"."</td>";
				$htmlTh .= "<td align=\"right\" colspan=\"6\">".number_format($rowComision['porcentaje_productividad'], 2, ".", ",")."</td>";
			$htmlTh .= "</tr>";
			$htmlTh .= "<tr align=\"left\" class=\"trResaltar4\" height=\"24\">";
				$htmlTh .= "<td colspan=\"13\">".utf8_encode($rowComision['nombre_cargo'])."</td>";
			$htmlTh .= "</tr>";
		} else {
			$htmlTh .= "<tr align=\"left\" class=\"trResaltar4\" height=\"24\">";
				$htmlTh .= "<td align=\"right\" class=\"tituloCampo\" colspan=\"4\" rowspan=\"3\">"."Empleado:"."</td>";
				$htmlTh .= "<td colspan=\"4\">".$rowComision['cedula']."</td>";
				$htmlTh .= "<td align=\"right\" class=\"tituloCampo\" colspan=\"2\">"."Mes / Año:"."</td>";
				$htmlTh .= "<td align=\"center\" colspan=\"4\">".$mes[$rowComision['mes_documento']]." ".$rowComision['ano_documento']."</td>";
			$htmlTh .= "</tr>";
			$htmlTh .= "<tr align=\"left\" class=\"trResaltar4\" height=\"24\">";
				$htmlTh .= "<td colspan=\"4\">".utf8_encode($rowComision['nombre_empleado'])."</td>";
				$htmlTh .= "<td align=\"right\" class=\"tituloCampo\" colspan=\"2\">"."% Productividad / Eficiencia:"."</td>";
			$htmlTh .= "<td align=\"right\" colspan=\"4\">".number_format($rowComision['porcentaje_productividad'], 2, ".", ",")."</td>";
			$htmlTh .= "</tr>";
			$htmlTh .= "<tr align=\"left\" class=\"trResaltar4\" height=\"24\">";
				$htmlTh .= "<td colspan=\"7\">".utf8_encode($rowComision['nombre_cargo'])."</td>";
			$htmlTh .= "</tr>";
		}
		if ($arrayTotalVehic[0][7] > 0) {
		$htmlTh .= "<tr class=\"tituloColumna\">";
			$htmlTh .= "<td colspan=\"15\"></td>";
		...
		if ($arrayTotalRep[0][7] > 0 || $arrayTotalServ[0][7] > 0 || $arrayTotalVehic[0][7] > 0) {
			...
			if ($arrayTotalVehic[0][7] > 0) {
				$htmlTh .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"24\">";
					$htmlTh .= "<td class=\"tituloCampo\" colspan=\"13\">Total Facturas:</td>";
					$htmlTh .= "<td colspan='2'>".$arrayTotal[0][7]."</td>";
		...
		if ($arrayTotalRep[1][7] > 0 || $arrayTotalServ[1][7] > 0 || $arrayTotalVehic[1][7] > 0) {
			...
			if ($arrayTotalVehic[0][7] > 0) {
				...
				$htmlTh .= "</tr>";
				$htmlTh .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"24\">";
				$htmlTh .= "<td class=\"tituloCampo\" colspan=\"13\">"."Total Notas Créd.:"."</td>";
		...
		if ($arrayTotalVehic[0][7] > 0) {
			$htmlTh .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
				$htmlTh .= "<td class=\"tituloCampo\" colspan=\"13\">Total:</td>";
		...
		$col = ($arrayTotalVehic[0][7] > 0) ? 13 : 4;
		...
		if (isset($arrayResumen)) {
			foreach ($arrayResumen as $indice => $valor) {
				...
				$htmlTh .= "<tr align=\"right\" class=\"trResaltarTotal2\" height=\"24\">";
					$htmlTh .= "<td class=\"tituloCampo\" colspan=\"$col\">"."Total ".$arrayResumen[$indice][0].":"."</td>";
					$htmlTh .= "<td colspan=\"2\"></td>";
		...
		$htmlTh .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
			$htmlTh .= "<td class=\"tituloCampo\" colspan=\"$col\">"."Total:"."</td>";
			$htmlTh .= "<td colspan=\"2\"></td>";
...
$htmlTh .= "<td colspan=\"3\"></td>";
		...
		$colFoot = ($arrayTotalVehic[0][7] > 0) ? 27 : 18;
		$htmlTh .= "<tr class=\"tituloColumna\">";
	...
	$htmlTf = "<tr>";
		if ($arrayTotalVehic[0][7] > 0) {
			$htmlTf .= "<td align=\"center\" colspan=\"27\">";
		} else {
