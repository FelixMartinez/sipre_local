...
function imprimirReporteVenta($frmBuscar) {
	...
	$objResponse->script(sprintf("verVentana('reportes/if_reporte_venta_pdf.php?valBusq=%s', 1000, 500);",
		$valBusq));
...
function reporteVenta($frmBuscar) {
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"6\">";
			...
			$htmlTh .= "<tr>";
				...
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">RESUMEN MENSUAL</p>"."</td>";
	...
	if (isset($arrayVentaAccesorio)) {
		foreach ($arrayVentaAccesorio as $indice => $valor) {
			...
			$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
				$htmlTb .= "<td align=\"left\">".utf8_encode($arrayVentaAccesorio[$indice][0])."</td>";
				$htmlTb .= "<td>".valTpDato(number_format($arrayVentaAccesorio[$indice][1],2,".",","),"cero_por_vacio")."</td>";
				$htmlTb .= "<td>".valTpDato(number_format($arrayVentaAccesorio[$indice][2],2,".",","),"cero_por_vacio")."</td>";
				$htmlTb .= "<td>".number_format($porcParticipacion,2,".",",")."%</td>";
			$htmlTb .= "</tr>";
			
			$arrayTotalVentaAccesorio[3] += $porcParticipacion;
			
			$arrayClave[] = (count($arrayClave) > 0) ? "['".utf8_encode($arrayVentaAccesorio[$indice][0])."', ".$arrayVentaAccesorio[$indice][2]."]" : "{ name: '".utf8_encode($arrayVentaAccesorio[$indice][0])."', y: ".$arrayVentaAccesorio[$indice][2].", sliced: true, selected: true }";
		}
	}
	$data1 = (count($arrayClave) > 0) ? implode(",",$arrayClave) : "";
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"4\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">ACCESORIOS INSTALADOS POR ASESOR</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						2,
						"Pie with legend",
	...
	if (isset($arrayVentaAdicional)) {
		foreach ($arrayVentaAdicional as $indice => $valor) {
			...
			$htmlTb .= "<tr class=\"tituloColumna\" height=\"24\">";
				$htmlTb .= "<td colspan=\"6\" title=\"".$arrayVentaAdicional[$indice]['id_empleado']."\">".utf8_encode($arrayVentaAdicional[$indice]['nombre_empleado'])."</td>";
			$htmlTb .= "</tr>";
			$htmlTb .= "<tr class=\"tituloColumna\">";
				$htmlTb .= "<td width=\"35%\">Adicional</td>";
				$htmlTb .= "<td width=\"15%\">Cant. Venta de<br>".$mes[intval($valFecha[0])]." ".$valFecha[1]."</td>";
				$htmlTb .= "<td width=\"20%\">Monto Venta de<br>".$mes[intval($valFecha[0])]." ".$valFecha[1]."</td>";
				$htmlTb .= "<td width=\"20%\">Monto Venta Acumulado hasta<br>".$mes[intval($valFecha[0])]." ".$valFecha[1]."</td>";
			...
			if (isset($arrayVentaAdicional[$indice]['array_adicional'])) {
				foreach ($arrayVentaAdicional[$indice]['array_adicional'] as $indice2 => $valor2) {
					...
					$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
						...
						$htmlTb .= "<td>".number_format($valor2['cant_facturado_accesorio'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['monto_facturado_accesorio'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['monto_facturado_accesorio_acumulado'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($porcParticipacion, 2, ".", ",")."%</td>";
					$htmlTb .= "</tr>";
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"5\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">ADICIONALES INSTALADOS POR ASESOR</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						2,
						"Donut chart",
		...
		foreach ($arrayVentaAsesor as $indice => $valor) {
			...
			if (isset($arrayVentaAsesor[$indice]['array_asesor'])) {
				foreach ($arrayVentaAsesor[$indice]['array_asesor'] as $indice2 => $valor2) {
					...
					$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
						$htmlTb .= "<td align=\"left\" title=\"".$valor2['id_empleado']."\">".utf8_encode($valor2['nombre_empleado'])."</td>";
						$htmlTb .= "<td>".number_format($valor2['nro_unidades_vendidas'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['nro_unidades_vendidas_acumulado'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['monto_facturado_vehiculo'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['monto_facturado_vehiculo_acumulado'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($porcParticipacion, 2, ".", ",")."%</td>";
					$htmlTb .= "</tr>";
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"6\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">VENTAS POR ASESOR</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						3,
						"Donut chart",
			...
			if (isset($arrayVentaModelo[$indice]['array_modelo'])) {
				foreach ($arrayVentaModelo[$indice]['array_modelo'] as $indice2 => $valor2) {
					...
					$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
						...
						$htmlTb .= "<td>".number_format($valor2['cant_unidades_vendidas'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['cant_unidades_vendidas_acumulado'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['monto_unidades_vendidas'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['monto_unidades_vendidas_acumulado'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($porcParticipacion, 2, ".", ",")."%</td>";
					$htmlTb .= "</tr>";
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"6\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">VENTAS POR MODELO DE VEHÍCULO</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						4,
						"Donut chart",
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"6\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">OPERACIONES A CRÉDITO</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						5,
						"Pie with legend",
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"6\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">OPERACIONES A CONTADO</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						6,
						"Pie with legend",
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"6\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">COMPAÑIA DE SEGUROS</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						7,
						"Pie with legend",
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"6\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">VENTA POR EMPRESA</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						1,
						"Donut chart",
