...
function imprimirReporte($frmBuscar) {
	...
	$objResponse->script(sprintf("verVentana('reportes/if_reporte_postventa_pdf.php?valBusq=%s', 1000, 500);",
		$valBusq));
...
function reporteServicios($frmBuscar) {
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"14\">";
			...
			$htmlTh .= "<tr>";
				...
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">SERVICIOS</p>"."</td>";
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"14\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">MOSTRADOR</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						2,
						"Basic column",
	...
	$htmlTh .= "<thead>";
		$htmlTh .= "<td colspan=\"14\">";
			...
			$htmlTh .= "<tr>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">"."</td>";
				$htmlTh .= "<td align=\"center\" width=\"90%\">"."<p class=\"textoAzul\">LATONERÍA Y PINTURA</p>"."</td>";
				$htmlTh .= "<td align=\"right\" width=\"5%\">";
					$htmlTh .= sprintf("<a class=\"modalImg\" id=\"aGrafico%s\" rel=\"#divFlotante1\" onclick=\"abrirDivFlotante1(this, 'tblGrafico', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');\"><img class=\"puntero\" src=\"../img/iconos/chart_pie.png\" title=\"Gráficos\"/></a>",
						3,
						"Basic column",
	...
	$htmlTblIni .= "<table class=\"texto_9px\" cellpadding=\"2\" width=\"100%\">";
	$htmlTh .= "<thead>";
		$htmlTh .= "<td align=\"center\" colspan=\"14\">"."<p class=\"textoAzul\">INVENTARIO</p>"."</td>";
	$htmlTh .= "</thead>";
	$htmlTh .= "</tr>";
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		$htmlTh .= "<td width=\"10%\">"."Conceptos"."</td>";
