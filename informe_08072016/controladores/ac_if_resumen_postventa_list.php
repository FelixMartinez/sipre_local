	...
	if (isset($arrayMovCompras)) {
		foreach ($arrayMovCompras as $indice => $valor) {
			...
			$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
				...
				$htmlTb .= "<td>".number_format($arrayMovCompras[$indice]['total_neto'], 2, ".", ",")."</td>";
...
function analisisInventario($objResponse, $idEmpresa, $valFecha) {
	...
	if (isset($arrayAnalisisInv)) {
		foreach ($arrayAnalisisInv as $indice => $valor) {
			...
			$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
				...
				$htmlTb .= "<td>".number_format($arrayAnalisisInv[$indice][4], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayAnalisisInv[$indice][3] / $arrayAnalisisInv[$indice][4], 2, ".", ",")."</td>";
	...
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
		...
		$htmlTb .= "<td>".number_format((($totalPromVentas > 0) ? $totalCostoInv / $totalPromVentas : 0), 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format((($totalCantArt > 0) ? $totalExistArt / $totalCantArt : 0), 2, ".", ",")."</td>";
	$htmlTb .= "<tr>";
	...
	if (isset($arrayMovVentas)) {
		foreach ($arrayMovVentas as $indice => $valor) {
			...
			$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
				...
				$htmlTb .= "<td>".number_format($arrayMovVentas[$indice]['total_neto'], 2, ".", ",")."</td>";
	...
	if (isset($arrayMovVentasServ)) {
		foreach ($arrayMovVentasServ as $indice => $valor) {
			...
			$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
				...
				$htmlTb .= "<td>".number_format($arrayMovVentasServ[$indice]['total_neto'], 2, ".", ",")."</td>";
...
function facturacionAsesoresServicios($objResponse, $idEmpresa, $valFecha, $idCierreMensual, $rowConfig301) {
	...
	if (isset($arrayVentaAsesor)) {
		foreach ($arrayVentaAsesor as $indice => $valor) {
			...
			$htmlTb .= "<tr class=\"tituloColumna\" height=\"24\">";
				$htmlTb .= "<td colspan=\"8\" title=\"".$arrayVentaAsesor[$indice]['id_empleado']."\">".utf8_encode($arrayVentaAsesor[$indice]['nombre_asesor'])."</td>";
			$htmlTb .= "</tr>";
			...
			if (isset($arrayVentaAsesor[$indice]['array_tipo_orden'])) {
				foreach ($arrayVentaAsesor[$indice]['array_tipo_orden'] as $indice2 => $valor2) {
					...
					$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
						$htmlTb .= "<td align=\"left\" title=\"".$valor2['id_tipo_orden']."\">".utf8_encode($valor2['descripcion_tipo_orden'])."</td>";
						$htmlTb .= "<td>".number_format($valor2['cantidad_ordenes'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['total_ut'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['total_mo'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['total_repuestos'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['total_tot'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($valor2['total_asesor'], 2, ".", ",")."</td>";
			...
			$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"24\">";
				...
				$htmlTb .= "<td>".number_format($arrayVentaAsesor[$indice]['cantidad_ordenes'], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayVentaAsesor[$indice]['total_ut'], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayVentaAsesor[$indice]['total_mo'], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayVentaAsesor[$indice]['total_repuestos'], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayVentaAsesor[$indice]['total_tot'], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayVentaAsesor[$indice]['total_asesor'], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($porcAsesor, 2, ".", ",")."%</td>";
			$htmlTb .= "</tr>";
	...
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
		...
		$htmlTb .= "<td>".number_format($totalVentaOrden, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($totalVentaUT, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($totalVentaMO, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($totalVentaRepuestos, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($totalVentaTot, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($totalVentaAsesores, 2, ".", ",")."</td>";
...
function facturacionTecnicosServicios($objResponse, $idEmpresa, $valFecha, $rowConfig301) {
	...
	if (isset($arrayEquipo)) {
		foreach ($arrayEquipo as $indice => $valor) {
			...
			if (isset($arrayTecnico)) {
				foreach ($arrayTecnico as $indice2 => $valor2) {
					...
					$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
						...
						$htmlTb .= "<td>".number_format($arrayTecnico[$indice2]['total_uts'], 2, ".", ",")."</td>";
						$htmlTb .= "<td>".number_format($arrayTecnico[$indice2]['total_bs'], 2, ".", ",")."</td>";
			...
			$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"24\">";
				...
				$htmlTb .= "<td>".number_format($arrayEquipo[$indice][3], 2, ".", ",")."</td>";
	...
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
		...
		$htmlTb .= "<td>".number_format($arrayTotalFactTecnicos[0], 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($arrayTotalFactTecnicos[1], 2, ".", ",")."</td>";
	...
	if (isset($arrayVentaVendedor)) {
		foreach ($arrayVentaVendedor as $indice => $valor) {
			...
			$htmlTb .= "<tr align=\"right\" class=\"".$clase."\">";
				...
				$htmlTb .= "<td>".number_format($arrayVentaVendedor[$indice][6], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayVentaVendedor[$indice][7], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayVentaVendedor[$indice][8], 2, ".", ",")."</td>";
...
function facturacionVendedores($frmBuscar) {
	...
	$valFecha = explode("-", $frmBuscar['txtFecha']);
			...
			$htmlMsj .= "<td>";
				...
				$htmlMsj .= "<tr>";
					...
					$htmlMsj .= "<td align=\"center\">";
						$htmlMsj .= utf8_encode("Cierre generado el ".date("d-m-Y", strtotime($row['fecha_creacion']))." a las ".date("h:ia", strtotime($row['fecha_creacion']))."<br>por ".$row['nombre_empleado']);
					$htmlMsj .= "</td>";
				$htmlMsj .= "</tr>";
				$htmlMsj .= "</table>";
			$htmlMsj .= "</td>";
	...
	if (isset($arrayProdTipoOrden)) {
		foreach ($arrayProdTipoOrden as $idTipo => $tipo) {
			$htmlTh .= "<td title=\"".$idTipo."\" width=\"10%\">".$tipo['nombre']."</td>";
		}
	}
		$htmlTh .= "<td>Total</td>";
	...
	if (isset($arrayOperador)) {
		foreach ($arrayOperador as $idOperador => $operador) {
			...
			if (isset($arrayProdTipoOrden)) {
				foreach ($arrayProdTipoOrden as $idTipo => $tipo) {
					$htmlTb .= "<td>".number_format(((isset($arrayMO[$idOperador][$idTipo])) ? $arrayMO[$idOperador][$idTipo] : 0), 2, ".", ",")."</td>";
				}
			}
	...
	if (isset($arrayTipoArticulo)) {
		foreach ($arrayTipoArticulo as $idTipoArticulo => $tipoArticulo) {
			...
			if ($arrayTotalRepuestoTipo[$idTipoArticulo] != 0) {
				...
				if (isset($arrayProdTipoOrden)) {
					foreach ($arrayProdTipoOrden as $idTipo => $tipo) {
						$htmlTb .= "<td>".number_format($arrayRepuesto[$idTipoArticulo][$idTipo], 2, ".", ",")."</td>";
					}
				}
					$htmlTb .= "<td>".number_format($arrayTotalRepuestoTipo[$idTipoArticulo], 2, ".", ",")."</td>";
	...
	if (isset($arrayProdTipoOrden)) {
		foreach ($arrayProdTipoOrden as $idTipo => $tipo) {
			...
			$htmlTb .= "<td>".number_format((-1)*$arrayTotalDescuentoRepuestoTipoOrden[$idTipo], 2, ".", ",")."</td>";
		}
	}
	...
	if (isset($arrayProdTipoOrden)) {
		foreach ($arrayProdTipoOrden as $idTipo => $tipo) {
			$htmlTb .= "<td>".number_format($arrayTotalRepuestoTipoOrden[$idTipo] - $arrayTotalDescuentoRepuestoTipoOrden[$idTipo], 2, ".", ",")."</td>";
		}
	}
	...
	if (isset($arrayOtroOperador)) {
		foreach ($arrayOtroOperador as $idOperador => $operador) {
			...
			if (isset($arrayOtroProdTipoOrden)) {
				foreach ($arrayOtroProdTipoOrden as $idTipo => $tipo) {
					$htmlTb .= "<td>".number_format(((isset($arrayOtroMO[$idOperador][$idTipo])) ? $arrayOtroMO[$idOperador][$idTipo] : 0), 2, ".", ",")."</td>";
				}
			}
				$htmlTb .= "<td>".number_format($arrayOtroTotalMOOperador[$idOperador], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($porcOperador, 2, ".", ",")."%</td>";
			$htmlTb .= "</tr>";
		}
	}
	...
	if (isset($arrayOtroProdTipoOrden)) {
		foreach ($arrayOtroProdTipoOrden as $idTipo => $tipo) {
			...
			$htmlTb .= "<td>".number_format($arrayOtroTotalMOTipoOrden[$idTipo], 2, ".", ",")."</td>";
		}
	}
		$htmlTb .= "<td>".number_format($subTotalMoOtro, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($porcMO, 2, ".", ",")."%</td>";
	$htmlTb .= "</tr>";
	...
	if (isset($arrayOtroTipoArticulo)) {
		foreach ($arrayOtroTipoArticulo as $idTipoArticulo => $tipoArticulo) {
			...
			if ($arrayOtroTotalRepuestoTipo[$idTipoArticulo] != 0) {
				...
				if (isset($arrayOtroProdTipoOrden)) {
					foreach ($arrayOtroProdTipoOrden as $idTipo => $tipo) {
						$htmlTb .= "<td>".number_format($arrayOtroRepuesto[$idTipoArticulo][$idTipo], 2, ".", ",")."</td>";
					}
				}
					$htmlTb .= "<td>".number_format($arrayOtroTotalRepuestoTipo[$idTipoArticulo], 2, ".", ",")."</td>";
					$htmlTb .= "<td>".number_format($porcTipoRepuestos, 2, ".", ",")."%</td>";
				$htmlTb .= "</tr>";
			}
		}
	...
	if (isset($arrayOtroProdTipoOrden)) {
		foreach ($arrayOtroProdTipoOrden as $idTipo => $tipo) {
			...
			$htmlTb .= "<td>".number_format($arrayOtroTotalRepuestoTipoOrden[$idTipo], 2, ".", ",")."</td>";
		}
	}
		$htmlTb .= "<td>".number_format($subTotalOtroRepServ, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($porcRepuestos, 2, ".", ",")."%</td>";
	$htmlTb .= "</tr>";
	...
	if (isset($arrayOtroProdTipoOrden)) {
		foreach ($arrayOtroProdTipoOrden as $idTipo => $tipo) {
			...
			$htmlTb .= "<td>".number_format((-1)*$arrayOtroTotalDescuentoRepuestoTipoOrden[$idTipo], 2, ".", ",")."</td>";
		}
	}
	$porcDescuentoRepServ = ($totalProdOtro > 0) ? ($totalDescuentoOtroRepServ * 100) / $totalProdOtro : 0;
		$htmlTb .= "<td>".number_format((-1)*$totalDescuentoOtroRepServ, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format((-1)*$porcDescuentoRepServ, 2, ".", ",")."%</td>";
	$htmlTb .= "</tr>";
	...
	if (isset($arrayOtroProdTipoOrden)) {
		foreach ($arrayOtroProdTipoOrden as $idTipo => $tipo) {
			$htmlTb .= "<td>".number_format($arrayOtroTotalRepuestoTipoOrden[$idTipo] - $arrayOtroTotalDescuentoRepuestoTipoOrden[$idTipo], 2, ".", ",")."</td>";
		}
	}
		$htmlTb .= "<td>".number_format($subTotalOtroRepServ - $totalDescuentoOtroRepServ, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($porcRepuestos - $porcDescuentoRepServ, 2, ".", ",")."%</td>";
	$htmlTb .= "</tr>";
	...
	if ($rowConfig300['valor'] == 1) {
		...
		if (isset($arrayOtroProdTipoOrden)) {
			foreach ($arrayOtroProdTipoOrden as $idTipo => $tipo) {
				$htmlTb .= "<td>".number_format($arrayOtroTotalNotaTipoOrden[$idTipo], 2, ".", ",")."</td>";
			}
		}
	...
	$porcTotalProdTaller = $porcMO + $porcRepuestos - $porcDescuentoRepServ;
	$porcTotalProdTaller += ($rowConfig300['valor'] == 1) ? $porcNota : 0;
		$htmlTb .= "<td>".number_format($totalProdOtro, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($porcTotalProdTaller, 2, ".", ",")."%</td>";
	$htmlTb .= "</tr>";
	$data1 = substr($data1, 0, (strlen($data1)-1));
	...
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
		...
		$htmlTb .= "<td>".number_format($totalFacturacionPostVenta, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format(100, 2, ".", ",")."%</td>";
	$htmlTb .= "</tr>";
	...
	$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
		...
		$htmlTb .= "<td colspan=\"3\">".number_format($subTotalMo, 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	...
	if (isset($arrayMecanico)) {
		foreach ($arrayMecanico as $indice => $valor) {
			...
			$htmlTb .= "<tr align=\"right\" class=\"trResaltar2\" height=\"24\">";
				...
				$htmlTb .= "<td colspan=\"3\">".number_format($arrayMecanico[$indice][1], 2, ".", ",")."</td>";
			$htmlTb .= "</tr>";
			
			// HORAS DISPONIBLE VENTA TECNICOS
			$htmlTb .= "<tr align=\"right\" class=\"trResaltar2\" height=\"24\">";
				$htmlTb .= "<td align=\"left\">"."Hrs. Disp. Venta Técnicos"."</td>";
				$htmlTb .= "<td colspan=\"3\">".number_format($arrayMecanico[$indice][1] * 7.1 * ($diaHabiles - $totalRowsDiasFeriados), 2, ".", ",")."</td>";
			$htmlTb .= "</tr>";
			...
			$htmlTb .= "<tr align=\"right\" class=\"trResaltar2\" height=\"24\">";
				...
				$htmlTb .= "<td colspan=\"3\">";
					$htmlTb .= number_format((($arrayMecanico[$indice][1] > 0) ? ($arrayMecanico[$indice][1] * 7.1 * ($diaHabiles - $totalRowsDiasFeriados)) / $arrayMecanico[$indice][1] : 0), 2, ".", ",");
				$htmlTb .= "</td>";
			$htmlTb .= "</tr>";
			...
			$htmlTb .= "<tr align=\"right\" class=\"trResaltar\" height=\"24\">";
				...
				$htmlTb .= "<td colspan=\"3\">".number_format($arrayMecanico[$indice][0], 2, ".", ",")."</td>";
			$htmlTb .= "</tr>";
			
			// HORAS DISPONIBLE VENTA TECNICOS EN FORMACION
			$htmlTb .= "<tr align=\"right\" class=\"trResaltar\" height=\"24\">";
				$htmlTb .= "<td align=\"left\">"."Hrs. Disp. Venta Técnicos en Formación"."</td>";
				$htmlTb .= "<td colspan=\"3\">".number_format($arrayMecanico[$indice][0] * 3.57 * ($diaHabiles - $totalRowsDiasFeriados), 2, ".", ",")."</td>";
			$htmlTb .= "</tr>";
			...
			$htmlTb .= "<tr align=\"right\" class=\"trResaltar\" height=\"24\">";
				...
				$htmlTb .= "<td colspan=\"3\">";
					$htmlTb .= number_format((($arrayMecanico[$indice][0] > 0) ? ($arrayMecanico[$indice][0] * 3.57 * ($diaHabiles - $totalRowsDiasFeriados)) / $arrayMecanico[$indice][0] : 0), 2, ".", ",");
				$htmlTb .= "</td>";
			$htmlTb .= "</tr>";
		}
	}
	...
	$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
		...
		$htmlTb .= "<td colspan=\"3\">".number_format($arrayValeRecepcion[1][1], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	...
	$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
		...
		$htmlTb .= "<td colspan=\"3\">".number_format($arrayValeRecepcion[2][1] + $arrayValeRecepcion[3][1], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
		...
		foreach ($arrayTipoOrden as $indice => $valor) {
			if ($arrayTipoOrden[$indice]['cantidad_abiertas'] != 0) {
				...
				$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
					...
					$htmlTb .= "<td>".number_format($arrayTipoOrden[$indice]['cantidad_fallas_abiertas'], 2, ".", ",")."</td>";
					$htmlTb .= "<td></td>";
					$htmlTb .= "<td>".number_format($arrayTipoOrden[$indice]['cantidad_abiertas'], 2, ".", ",")."</td>";
				$htmlTb .= "</tr>";
			}
		}
	}
	...
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"24\">";
		...
		$htmlTb .= "<td>".number_format($totalFallaTipoOrdenAbierta, 2, ".", ",")."</td>";
		$htmlTb .= "<td></td>";
		$htmlTb .= "<td colspan=\"2\">".number_format($totalTipoOrdenAbierta, 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
		...
		foreach ($arrayTipoOrden as $indice => $valor) {
			if ($arrayTipoOrden[$indice]['cantidad_cerradas'] != 0) {
				...
				$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
					...
					$htmlTb .= "<td>".number_format($arrayTipoOrden[$indice]['cantidad_fallas_cerradas'], 2, ".", ",")."</td>";
					$htmlTb .= "<td>".number_format($arrayTipoOrden[$indice]['cantidad_uts_cerradas'], 2, ".", ",")."</td>";
					$htmlTb .= "<td>".number_format($arrayTipoOrden[$indice]['cantidad_cerradas'], 2, ".", ",")."</td>";
				$htmlTb .= "</tr>";
			}
		}
	}
	...
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"24\">";
		...
		$htmlTb .= "<td>".number_format($totalFallaTipoOrdenCerrada, 2, ".", ",")."</td>";
		$htmlTb .= "<td>".number_format($totalUtsTipoOrdenCerrada, 2, ".", ",")."</td>";
	...
	$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
		...
		$htmlTb .= "<td colspan=\"3\">".number_format($subTotalRepServ - $totalDescuentoRepServ, 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	...
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
		...
		$htmlTb .= "<td colspan=\"3\">".number_format(($subTotalRepServ - $totalDescuentoRepServ) / $totalTipoOrdenCerrada, 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	
	// HORAS ENTRE ORDENES
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"24\">";
		$htmlTb .= "<td align=\"left\" class=\"tituloCampo\">"."UT'S / OR"."</td>";
		$htmlTb .= "<td colspan=\"3\">".number_format($totalTotalUtsEquipos / $totalTipoOrdenCerrada, 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
