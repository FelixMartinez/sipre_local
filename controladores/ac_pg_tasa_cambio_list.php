...
function listaTasaCambio($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 15, $totalRows = NULL) {
	...
	$htmlTh .= "<tr class=\"tituloColumna\">";
		$htmlTh .= "<td></td>";
		$htmlTh .= ordenarCampo("xajax_listaTasaCambio", "40%", $pageNum, "nombre_tasa_cambio", $campOrd, $tpOrd, $valBusq, $maxRows, "Nombre");
		$htmlTh .= ordenarCampo("xajax_listaTasaCambio", "20%", $pageNum, "descripcion_moneda_extranjera", $campOrd, $tpOrd, $valBusq, $maxRows, "Moneda Extranjera");
		$htmlTh .= ordenarCampo("xajax_listaTasaCambio", "20%", $pageNum, "descripcion_moneda_nacional", $campOrd, $tpOrd, $valBusq, $maxRows, "Moneda Nacional");
		$htmlTh .= ordenarCampo("xajax_listaTasaCambio", "20%", $pageNum, "monto_tasa_cambio", $campOrd, $tpOrd, $valBusq, $maxRows, "Tasa de Cambio");
