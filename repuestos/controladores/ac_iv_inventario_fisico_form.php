...
function buscarCodigoArticulo($frmBuscarCodigoArticulo, $frmInventario) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= "<td width=\"14%\">".utf8_encode("Marca")."</td>";
	$htmlTh .= "</tr>";
	while ($row = mysql_fetch_assoc($rs)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"right\">".utf8_encode($row['marca'])."</td>";
		$htmlTb .= "</tr>";
	}
	$htmlTblFin .= "</table>";
...
function cargarInventarioFisico($idInventarioFisico) {
	...
	$objResponse->assign("txtFecha","value",date("d-m-Y", strtotime($row['fecha'])));
...
function listaArticulosInventario($pageNum = 0, $campOrd = "numero", $tpOrd = "ASC", $valBusq = "", $maxRows = 100, $totalRows = NULL) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaArticulosInventario", "6%", $pageNum, "marca", $campOrd, $tpOrd, $valBusq, $maxRows, utf8_encode("Marca"));
