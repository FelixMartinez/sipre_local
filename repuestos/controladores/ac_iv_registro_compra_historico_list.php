...
function formImportacion($idFactura) {
	...
	$objResponse->assign("spnFechaDctoTransporte","innerHTML",date("d-m-Y",strtotime($row['fecha_dcto_transporte'])));
	$objResponse->assign("spnFechaVencDctoTransporte","innerHTML",date("d-m-Y",strtotime($row['fecha_vencimiento_dcto_transporte'])));
	$objResponse->assign("spnFechaEstimadaLlegada","innerHTML",date("d-m-Y",strtotime($row['fecha_estimada_llegada'])));
...
function listaExpediente($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 10, $totalRows = NULL) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaExpediente", "8%", $pageNum, "gastos_import_nac_unitario", $campOrd, $tpOrd, $valBusq, $maxRows, "Gastos Unit. Importación");
		$htmlTh .= ordenarCampo("xajax_listaExpediente", "8%", $pageNum, "gastos_import_unitario", $campOrd, $tpOrd, $valBusq, $maxRows, "Otros Cargos Unit.");
		$htmlTh .= ordenarCampo("xajax_listaExpediente", "8%", $pageNum, "costo_unitario_final", $campOrd, $tpOrd, $valBusq, $maxRows, "Costo Unit. Final");
		$htmlTh .= ordenarCampo("xajax_listaExpediente", "4%", $pageNum, "peso_unitario", $campOrd, $tpOrd, $valBusq, $maxRows, "Peso Unit. (g)");
		$htmlTh .= ordenarCampo("xajax_listaExpediente", "6%", $pageNum, "tasa_cambio_diferencia", $campOrd, $tpOrd, $valBusq, $maxRows, "Tasa Cambio Dif.");
		$htmlTh .= ordenarCampo("xajax_listaExpediente", "6%", $pageNum, "costo_cif_diferencia", $campOrd, $tpOrd, $valBusq, $maxRows, "Costo Unit. CIF Dif.");
	$htmlTh .= "</tr>";
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$arrayTotal[15] += $row['cantidad'] * $row['costo_cif_diferencia'];
	}
	if ($contFila > 0) {
		$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"22\">";
			...
			$htmlTb .= "<td></td>";
			$htmlTb .= "<td>".$abrevMonedaOrigen.number_format($arrayTotal[4], 2, ".", ",")."</td>";
			$htmlTb .= "<td>".$abrevMonedaOrigen.number_format($arrayTotal[5], 2, ".", ",")."</td>";
			$htmlTb .= "<td>".$abrevMonedaOrigen.number_format($arrayTotal[6], 2, ".", ",")."</td>";
			$htmlTb .= "<td></td>";
			$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotal[8], 2, ".", ",")."</td>";
			$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotal[9], 2, ".", ",")."</td>";
			$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotal[10], 2, ".", ",")."</td>";
			$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotal[11], 2, ".", ",")."</td>";
			$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotal[12], 2, ".", ",")."</td>";
			$htmlTb .= "<td>".number_format($arrayTotal[13], 2, ".", ",")."</td>";
			$htmlTb .= "<td></td>";
			$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotal[15], 2, ".", ",")."</td>";
		$htmlTb .= "</tr>";
		...
		if ($pageNum == $totalPages) {
			...
			while ($row = mysql_fetch_assoc($rs)) {
				...
				$arrayTotalFinal[15] += $row['cantidad'] * $row['costo_cif_diferencia'];
			}
			...
			$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal3\" height=\"22\">";
				...
				$htmlTb .= "<td></td>";
				$htmlTb .= "<td>".$abrevMonedaOrigen.number_format($arrayTotalFinal[4], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".$abrevMonedaOrigen.number_format($arrayTotalFinal[5], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".$abrevMonedaOrigen.number_format($arrayTotalFinal[6], 2, ".", ",")."</td>";
				$htmlTb .= "<td></td>";
				$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotalFinal[8], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotalFinal[9], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotalFinal[10], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotalFinal[11], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotalFinal[12], 2, ".", ",")."</td>";
				$htmlTb .= "<td>".number_format($arrayTotalFinal[13], 2, ".", ",")."</td>";
				$htmlTb .= "<td></td>";
				$htmlTb .= "<td>".$abrevMonedaLocal.number_format($arrayTotalFinal[15], 2, ".", ",")."</td>";
			$htmlTb .= "</tr>";
		}
	}
