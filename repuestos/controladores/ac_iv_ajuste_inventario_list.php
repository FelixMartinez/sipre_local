...
function listaVale($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaVale", "12%", $pageNum, "numeracion_vale", $campOrd, $tpOrd, $valBusq, $maxRows, "Nro. Vale");
		$htmlTh .= ordenarCampo("xajax_listaVale", "14%", $pageNum, "tipo_documento", $campOrd, $tpOrd, $valBusq, $maxRows, "Tipo Documento");
		$htmlTh .= ordenarCampo("xajax_listaVale", "44%", $pageNum, "nombre_cliente", $campOrd, $tpOrd, $valBusq, $maxRows, "Cliente / Empleado");
		$htmlTh .= ordenarCampo("xajax_listaVale", "8%", $pageNum, "items", $campOrd, $tpOrd, $valBusq, $maxRows, "Items");
