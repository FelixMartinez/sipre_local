        	...
        	<td>
                ...
                <tr>
                    ...
                    <form id="frmListaArticuloPreseleccionado" name="frmListaArticuloPreseleccionado" style="margin:0px">
                        ...
                        <tr>
                        	<td align="right">
                            	<button type="button" id="btnPresupuesto" name="btnPresupuesto" onclick="xajax_formPresupuesto(xajax.getFormValues('frmListaArticuloPreseleccionado'));">Presupuesto</button>
                            </td>
                        </tr>
                        </table>
					</form>
