	...
	function insertFilaArticuloMultiple(decimales) {
		...
		$('#trItmPieArtMultiple').before(
			'<tr id=\"trItmArtMult:' + contFila + '\" align=\"center\" class=\"textoGris_11px ' + clase + '\">' +
				...
				'<td><img class=\"puntero\" id=\"imgEliminarArtMult' + contFila + '\" name=\"imgEliminarArtMult' + contFila + '\" onclick=\"elimFilaArticuloMultiple(' + contFila + '); calcularArticuloMultiple();\" src=\"../img/iconos/cross.png\"/></td>' +
			'</tr>');
