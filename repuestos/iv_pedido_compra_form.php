    ...
    <tr>
        ...
        <fieldset>
            ...
            <tr align="left">
                ...
                <td><input type="text" id="txtCostoArt" name="txtCostoArt" maxlength="12" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event)" size="16" style="text-align:right"/></td>
