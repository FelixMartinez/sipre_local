    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="xajax_imprimirPrecioArt(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                    	<button type="button" onclick="xajax_exportarPreciosArt(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
                </tr>
                </table>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td colspan="3">
                    	<label><input name="cbxVerArtDisponible" type="checkbox" checked="checked" value="3"/> Disponible</label>
                        <label><input name="cbxVerArtNoDisponible" type="checkbox" checked="checked" value="4"/> No Disponible</label>
                    </td>
                </tr>
                <tr align="left">
...
xajax_listaPrecioArticulo(0,'art.codigo_articulo','ASC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
</script>                  