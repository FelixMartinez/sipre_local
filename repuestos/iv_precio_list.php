...
<form id="frmPrecio" name="frmPrecio" onsubmit="return false;" style="margin:0">
	<div id="tblPrecio" style="max-height:500px; overflow:auto; width:960px;">
        <table border="0" width="100%">
        <tr>
            <td>
                <table border="0" width="100%">
...
xajax_listaPrecio(0, "id_precio", "ASC", '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>' + '|' + byId('lstEstatusBuscar').value);
