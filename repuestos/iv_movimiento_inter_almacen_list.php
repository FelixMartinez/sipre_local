...
<head>
	...
	function abrirDivFlotante1(nomObjeto, verTabla, valor, valor2) {
		...
		if (verTabla == "tblImportarArchivo") {
			...
			xajax_formMovimientoInterAlmacen(valor, valor2, xajax.getFormValues('frmBuscar'));
...
xajax_listaMovInterAlmacen(0, 'CONCAT(descripcion_almacen, ubicacion)', 'ASC', '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|' + byId('cbxVerArtUnaUbic').value + '|' + byId('cbxVerArtMultUbic').value + '|||' + byId('cbxVerUbicDisponible').value + '|' + byId('cbxVerUbicSinDisponible').value + '|' + byId('lstEstatus').value);
