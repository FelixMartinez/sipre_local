...
$sqlBusq .= $cond.sprintf("fact_vent.idDepartamentoOrigenFactura IN (0,1)");
...
while ($row = mysql_fetch_assoc($rs)) {
	...
	while ($rowFacturaVenta = mysql_fetch_assoc($rsFacturaVenta)) {
		...
		$objPHPExcel->getActiveSheet()->setCellValue("E".$contFila, date("d-m-Y",strtotime($rowFacturaVenta['fechaRegistroFactura'])));
