...
$posY = 10;
imagestring($img,1,285,$posY,"ANÁLISIS DE INVENTARIO AL ".date("d-m-Y"),$textColor);
imagestring($img,1,600,$posY+10,"GENERADO EL: ".date("d-m-Y H:i:s", strtotime($rowAnalisisInv['fecha'])),$textColor);
