    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('iv_articulo_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    ...
                    <a class="modalImg" id="aEliminar" rel="#divFlotante2" onclick="abrirDivFlotante2(this, 'tblPermiso', '1');">
                    	...
                    	<button type="button" onclick="xajax_exportarArticulos(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
...
<form action="controladores/ac_upload_file_articulo.php" enctype="multipart/form-data" id="frmArticulo" name="frmArticulo" method="post" onsubmit="return false;" style="margin:0" target="iframeUpload">
    ...
    <div id="tblListaDcto" style="max-height:500px; overflow:auto; width:960px">
        <table border="0" width="100%">
        <tr align="left">
            <td>
...
<form id="frmModeloArticulo" name="frmModeloArticulo" style="margin:0;" onsubmit="return false;">
    ...
    <div id="tblModeloArticulo" style="max-height:500px; overflow:auto; width:960px">
    	<table border="0" width="100%">
        <tr align="left">
            <td>
...
<form id="frmUbicacionArticulo" name="frmUbicacionArticulo" style="margin:0;" onsubmit="return false;">
    ...
    <div id="tblUbicacionArticulo" style="max-height:500px; overflow:auto; width:960px">
