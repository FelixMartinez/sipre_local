                    	...
                    	<tr>
                            ...
                            <td align="right" width="50%">
                                <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                                    <table border="0" width="100%"> <!--contiene el buscador-->			
                                        <tr align="left">
                                        ...
                                        <tr align="left">
                                            ...
                                            <td colspan="3"><input type="text" id="textCriterio" name="textCriterio" class="inputHabilitado" size="40" style="width:95%"/></td>
                                            <td align="right">
