	...
	function verMsj(valor,idObjAccion){
		switch(idObjAccion){
			case "checkPosibildiadCierre":
				...
				Msj = "Todo controla de trafico que tenga asignado esta posibilidad de cierre, se considera como finalizada o rechazada";
			break;
			default: 
				idObjMsj = "divEstatusInicial";
				Msj = "Esta sera la posibilidad de cierrer que se asignara a cada control de trafico creado";
			break;
		}
				...
				<tr>
					...
					<td align="center">
                        ...
                        <tr>
                            ...
                            <td>Finaliza control de trafico</td>
                        </tr>
                        </table>
                    </td>
				</tr>
