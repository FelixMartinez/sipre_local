...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Asignar actividad</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        <table width="100%" border="0"> <!--tabla principa-->
            <tr><td class="tituloPaginaCrm">Asignacion de actividades</td> </tr>
            <tr><td>&nbsp;</td></tr>
            <tr align="right">
            	<td>
			                        ...
			                        <table width="100%" border="0">
			                        	<tr align="left">
			                                ...
			                                <td colspan="4">
			                                	<table>
			                                    	<tr>
			                                        	<td><input id="textIdEmpresaBus" name="textIdEmpresaBus" readonly="readonly" class="inputInicial" type="text" size="6" readonly="readonly" style="text-align:center" value = ""></td>
			                                            <td><input id="textEmpresaBus"  name="textEmpresaBus" readonly="readonly" class="inputInicial" type="text" size="50" readonly="readonly" style="text-align:center" value = ""></td>
			                                        </tr>
			                                    </table>
			                                </td>
			                            </tr>
			                            <tr align="left">
			                                ...
			                                <td><input id="fechaSelectEquipo" class="inputHabilitado" type="text" size="20" readonly="readonly" style="text-align:center" name="fechaSelectEquipo" globalnumber="656" value = "<?php echo date("d-m-Y"); ?>"> </td>
                ...
                <div class="wrap">
                    ...
                    <div class="pane"> <!--Estadisticas-->
                        <div id="divGeneralGrafico1">
                        	<fieldset>
                            	<legend class="legend">Gráfico de Actividades</legend>
                                <form id="formGenerarGrafico" name="formGenerarGrafico">
                                <table border="0" align="right">
                                    <tr align="right">
                                        <td class="tituloCampo">Equipos:</td>
                                        <td id="tdListEquipoGrafico" align="left"> 
                                            <select class="inputHabilitado">
                                            	<option value="">[ Seleccione ]</option>
                                            </select>
                                        </td>
                                        <td class="tituloCampo">Integrantes:</td>
                                        <td id="tdListIntegrantesGrafico" align="left">
                                            <select class="inputHabilitado">
                                                <option value="">[ Seleccione ]</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr align="right">
                                        <td class="tituloCampo" >Actividades:</td>
                                        <td id="tdListTipoActividaGrafico" align="left" colspan="3"></td>
                                    </tr>
                                    <tr align="right">
                                        <td class="tituloCampo" align="right">fecha:</td>
                                        <td align="left" colspan="3">Desde: <input type="text" id="fechaInicio" value="<?php echo date("01-m-Y") ?>" name="fechaInicio" readonly="readonly" class="inputHabilitado" size="20"/> Hasta: <input type="text" id="fechaFin" name="fechaFin" readonly="readonly" value="<?php echo date("d-m-Y") ?>" class="inputHabilitado" size="20"/></td>
                                    </tr>
                                    <tr align="right">
                                        <td colspan="4">
                        ...
                        <div id="divGeneralGrafico2">
                        	<fieldset>
                            	<legend class="legend">Gráfico de Desempeño</legend>
                                <form id="formGenerarGrafico2" name="formGenerarGrafico2">
                                    <table border="0" align="right">
                                        <tr align="right">
                                            <td class="tituloCampo" >Equipos:</td>
                                            <td id="tdListEquipoGrafico2" align="left">
                                                <select class="inputHabilitado"><option value="">[ Seleccione ]</option></select>
                                            </td>
                                            <td class="tituloCampo">Actividades:</td>
                                            <td align="left">
                                        ...
                                        <tr align="right">
                                        <td class="tituloCampo">Fecha</td>
                                        <td align="left" colspan="3">
                                            Desde:<input type="text" id="fechaInicio2" name="fechaInicio2" readonly="readonly" value="<?php echo date("01-m-Y") ?>" class="inputHabilitado" size="20"/>
                                            Hasta:<input type="text" id="fechaFin2" name="fechaFin2" readonly="readonly" value="<?php echo date("d-m-Y") ?>" class="inputHabilitado" size="20"/>
                                        </td>
                                        </tr>
                                        <tr>                           
            ...
            <tr>
            	<td>
                	<table class="divMsjInfo2" width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                        	<td><img width="25" src="../img/iconos/ico_info.gif"></td>
                        	<td>
                            	<table align="center">
                                	<tr>
                                        <td ><img src="../img/iconos/ico_aceptar_azul.png"/></td>
                                        <td >Asignada</td>
                                        <td ><img src='../img/cita_programada_incumplida.png'/></td>
                                        <td>Atrasado</td>
                                        <td ><img src='../img/iconos/ico_aceptar.gif'/></td>
                                        <td>Finalizada</td>
                                        <td ><img src="../img/cita_entrada_retrazada.png"/></td>
                                        <td>Finalizado tarde</td>
                                        <td ><img src="../img/iconos/arrow_rotate_clockwise.png"/></td>
                                        <td>Finalizado Auto</td>
                                        <td ><img src="../img/iconos/tick.png"/></td>
                                        <td>Finalizado Efectivo</td>
                                        <td ><img src="../img/iconos/cross.png"/></td>
                                        <td>Finalizado No Efectivo</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
...
<div id="divFlotante" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo" class="handle">
    	<table><tr><td id="tdFlotanteTitulo2" width="100%">Asignacion de Actividad</td></tr></table>
    </div>
    <form id="formAsignarActividadAgen"  name="formAsignarActividadAgen" onsubmit="return false;">
        <table border="0" width="760">
            <tr id="trAsignarActTipo" align="left">
                ...
                <td id=""><input name="txtTipoActividad" id="txtTipoActividad" type="text" readonly="readonly"/> </td>
            </tr>
            <tr align="left">
            ...
            <tr align="left">
                ...
                <td>
                    <input name="textIdIntegrante" id="textIdIntegrante" type="text" readonly="readonly" size="6%"/>
                    <input name="nombreVendedor" id="nombreVendedor" type="text" readonly="readonly" size="40%"/>
                </td>
            </tr>
            <tr align="left">
                <td align="right" class="tituloCampo">Fechas de Asignacion:</td>
                <td><input id="textFechAsignacion" name="textFechAsignacion" type="text" readonly="readonly"/></td>
            </tr>
            <tr align="left">
                <td align="right" class="tituloCampo">Hora de Asignacion:</td>
                <td><input name="textHoraAsignacion" id="textHoraAsignacion" type="text" readonly="readonly"/>
            ...
            <tr  align="left">
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td><input type="text" id="idClienteHidd" name="idClienteHidd" readonly="readonly" size="6"/></td>
                            <td>
                            <a class="modalImg" rel="#divFlotante2" onclick="openImg(this);">
                               <button type="button" id="listCliente" name="listCliente" title="Seleccionar">
            ...
            <tr>
                <td align="right" colspan="2"><hr>
                   <input name="hddActEjecucion" id="hddActEjecucion" type="hidden" value=""/>
                    ...
                    <button type="button" id="btnGuardar" name="btnGuardar" onclick="validarFromAgenda();">Guardar</button>
                    <button type="button" id="butCancelarAsignacion" name="butCancelarAsignacion" class="close">Cancelar</button>
                </td>
            </tr>
        </table>
    </form>
            ...
            <form id="frmBuscarCliente" name="frmBuscarCliente" onsubmit="return false;">
                <table align="right" border="0">
                    <tr>
                        ...
                        <td><input type="text" id="textCriterio" name="textCriterio" class="inputHabilitado" value="" size="30"/></td>
                    </tr>
                    <tr align="right">
                        <td colspan="2">
