				                ...
				                <table border="0" width="100%">			
					                <tr align="left">
					                 ...
					                 <tr>
					                    ...
					                    <td colspan="3">
					                       <input type="text" id="textCriterio" name="textCriterio" class="inputHabilitado" onclick="byId('btnBuscar').click();" style="width:95%" /> 
					                    </td>
					                    <td align="left">
...
<form id="frmActividad" name="frmActividad" style="margin:0" onsubmit="return false;">
    <table border="0" id="tblClaveEspecial" width="760">
        <tr align="left">
            ...
            <td width="85%">
                <table cellpadding="0" cellspacing="0">
                    <tr align="left">
                        <td><input type="text" id="txtIdEmpresa" name="txtIdEmpresa" onkeyup="xajax_asignarEmpresa(this.value)" size="6" style="text-align:center"/></td>
                        <td>
        ...
        <tr align="left">
            ...
            <td><input type="text" id="txtNombre" name="txtNombre" size="55"/></td>
        </tr>
        <tr align="left">
            <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Nombre Abreviado:</td>
            <td>
            <div style="float:left"><input type="text" id="txtNombreAbreviado" name="txtNombreAbreviado" size="55" maxlength="6" onfocus="accion('block');" onblur="accion('none');"/></div>
...
xajax_listadoActividad(0,'tipo,posicion_actividad','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>'+'|||1');
