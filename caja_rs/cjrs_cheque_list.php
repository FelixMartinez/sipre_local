...
if(!(validaAcceso("cjrs_cheque_list"))) {
...
include("controladores/ac_cjrs_cheque_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Cheques</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
            <td class="tituloPaginaCajaRS">Cheques</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		...
		<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr style="vertical-align:top">
                    <td>
                    	<button type="button" onclick="window.open('cjrs_cheque_form.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                    <td>
                    ...
                    <td>
                        <button type="button" onclick="xajax_exportarCheque(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
                    </td>
                </tr>
                </table>
				...
				<tr>
					...
					<td align="center">
						...
						<tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Recibo Cheque PDF</td>
						</tr>
						</table>
					</td>
				</tr>
