...
if(!(validaAcceso("cjrs_transferencia_list"))) {
...
include("controladores/ac_cjrs_transferencia_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Transferencias</title>
	...
	<div id="divInfo" class="print">
		...
		<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr style="vertical-align:top">
                    <td>
                    	<button type="button" onclick="window.open('cjrs_transferencia_form.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                    <td>
                    ...
                    <td>
                        <button type="button" onclick="xajax_exportarTransferencia(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
                    </td>
                </tr>
                </table>
				...
				<tr>
					...
					<td align="center">
						...
						<tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Recibo Transferencia PDF</td>
						</tr>
						</table>
					</td>
				</tr>
