...
<head>
    ...
    function abrirDivFlotante1(obj, id_cheque){
		
    	byId('hddIdCheque').value = "";
		byId('txtNroCheque').value = "";
		byId('txtMotivoAnulacion').value = "";		
		
		openImg(obj);
		xajax_cargarCheque(id_cheque);
		byId('txtMotivoAnulacion').focus();
    }
	
	function validarAnulacionCheque(){
		error = false;
		
		if (!(validarCampo('hddIdCheque','t','') == true
		&& validarCampo('txtNroCheque','t','') == true
		&& validarCampo('txtMotivoAnulacion','t','') == true)) {
			validarCampo('hddIdCheque','t','');
			validarCampo('txtNroCheque','t','');
		...
		if (error == true) {
			...
			if(confirm("¿Seguro deseas anular el cheque Nro: " + byId('txtNroCheque').value + " ?")){
				xajax_anularCheque(xajax.getFormValues('formAnulacion'));
			}			
		}
	}
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td align="right">
                ...
                <tr>
                    <td>
			<button type="button" onclick="xajax_imprimirDevolucionCheque(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                    </td>
                </tr>
                </table>
...
<div id="divFlotante1" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo1" class="handle"><table><tr><td id="tdFlotanteTitulo1" width="100%">Anular Cheque</td></tr></table></div>
    	...
    	<td>
            ...
            <tr align="left">
                ...
                <td>
                    ...
                    <input type="text" id="txtNroCheque" name="txtNroCheque" readonly="readonly" />
                </td>
            </tr>
            <tr align="left">
    ...
    <tr>
        <td align="right"><hr>
	        <button type="button" id="btnAnularCheque" name="btnAnularCheque" onclick="validarAnulacionCheque();"><img class="puntero" title="Anular Cheque" src="../img/iconos/delete.png" style="vertical-align:middle; margin-top:-2px;">Anular Cheque</button>
