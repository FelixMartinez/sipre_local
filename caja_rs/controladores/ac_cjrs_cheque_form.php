...
function cargarDcto($idCheque){
	...
	if ($idCheque > 0) {
		...
		if (!($rowCheque['estatus'] == 1)) {
			...
			return $objResponse->script(sprintf("window.location.href='cjrs_cheque_list.php';"));
		}
...
function guardarCheque($frmDcto, $frmDetallePago, $frmListaDctoPagado){
	...
	if (!xvalidaAcceso($objResponse,"cjrs_cheque_list","insertar")){ return $objResponse; }
	...
	cerrarVentana = true;
	window.location.href='cjrs_cheque_list.php';"));
