...
function exportarFactura($frmBuscar) {
	...
	$objResponse->script("window.open('reportes/cjrs_factura_historico_r_excel.php?valBusq=".$valBusq."','_self');");
...
function imprimirFactura($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjrs_factura_historico_r_pdf.php?valBusq=%s&lstOrientacionPDF=%s',890,550)", $valBusq, $frmBuscar['lstOrientacionPDF']));
