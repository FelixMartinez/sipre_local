...
if (in_array(idArrayPais,array(1))) { // VENEZUELA
	...
	$titleFormatoTelf .= "\nVENEZUELA:\n+0000-0000-0000000, 0000-0000000"."\n";
} else if (in_array(idArrayPais,array(2))) { // PANAMA
	//// VALIDACIONES ////
	$arrayValidarCI[] = "/^(\d{1,2}-\d{1,6}-\d{1,6})$/"; // C.I.V. PANAMEÑO EJEMP : 8-926-1601
	$arrayValidarCI[] = "/^(PE-\d{1}-\d{1,6})$/"; // C.I.V. PANAMEÑO NACIDO EN EXTRAJERO EJEMP : PE-5-687
	...
	$arrayValidarRIF[] = "/^(PE-\d{1}-\d{1,6})$/"; // C.I.V. PANAMEÑO NACIDO EN EXTRAJERO EJEMP : PE-5-687
