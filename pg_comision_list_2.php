...
<head>
	...
	function abrirDivFlotante2(nomObjeto, verTabla, valor, valor2) {
		...
		if (verTabla == "tblListaEmpresa") {
			...
			tdFlotanteTitulo = 'tdFlotanteTitulo2';
			tituloDiv2 = 'Empresas';
	...
	function asignarTipoPorcentaje(idTipoPorcentaje){
		byId('trNivelProducitividad').style.display = 'none';
		
		if(idTipoPorcentaje == 2) {
			byId('trNivelProducitividad').style.display = '';
		} 
	}
    ...
    <tr>
    	<td valign="top" width="65%">
            ...
            <tr align="left">
                ...
                <td>
                    <select id="lstTipoPorcentaje" name="lstTipoPorcentaje" onchange="asignarTipoPorcentaje(this.value);" style="width:99%">
                        <option value="-1">[ Seleccione ]</option>
                        <option value="1">1.- Simple</option>
                        <option value="2">2.- Por Productividad</option>
                    </select>
