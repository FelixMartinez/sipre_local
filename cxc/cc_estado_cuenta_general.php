...
if(!(validaAcceso("cc_estado_cuenta_general"))) {
...
include("controladores/ac_cc_estado_cuenta_general.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - E.C. General</title>
	...
	function validar(){
		...
		&& validarCampo('txtCodigoCliente','t','') == true) {
			...
			validarCampo('txtCodigoCliente','t','fecha');
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar">Estado de Cuenta General</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
