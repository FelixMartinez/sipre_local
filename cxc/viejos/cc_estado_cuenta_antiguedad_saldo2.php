...
if(!(validaAcceso("cc_estado_cuenta_antiguedad_saldo"))) {
...
include("controladores/ac_cc_estado_cuenta_antiguedad_saldo2.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Antigüedad de Saldos</title>
	...
	function validar(){
		if (byId('radioOpcion1').checked == true) {
			...
			&& validarCampo('txtFecha','t','') == true) {
				xajax_listarTodoCliente(byId('txtCodigoCliente').value,byId('txtIdEmpresa').value,byId('txtFecha').value,xajax.getFormValues('frmCliente'));
			} else {
			...
			if (validarCampo('txtFecha','t','') == true) {
				...
				xajax_listarTodo('',byId('txtIdEmpresa').value,byId('txtFecha').value,xajax.getFormValues('frmCliente'));
			} else {
				alert('Los campos señalados en rojo son requeridos');
				return false;
			}
			...
			if (validarCampo('txtFecha','t','') == true) {
				...
				xajax_listarTodoDetalle('',byId('txtIdEmpresa').value,byId('txtFecha').value,xajax.getFormValues('frmCliente'));
			} else {
				alert('Los campos señalados en rojo son requeridos');
				return false;
			}
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar">Antigüedad de Saldos</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
			...
			<td>
				...
				<tr>
					<td>
						...
						}" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
				</tr>
				</table>
			</td>
		...
		<tr>
			...
			<tr>
				...
				<td valign="top" width="40%">
					...
					<table border="0" width="100%" align="center">
					<tr align="left">
						<td align="right" class="tituloCampo" width="35%">Antiguedad de Saldos al:</td>
						<td width="65%">
							<input type="text" name="txtFecha" id="txtFecha" style="text-align:center" size="10" readonly="readonly"/>
						</td>
					</tr>
					<tr align="left">
						<td align="right" class="tituloCampo" rowspan="3">Tipo de Estado de Cuenta:</td>
						<td><input type="radio" id="radioOpcion1" name="radioOpcion" checked="checked" value="1"/>Individual</td>
					</tr>
					<tr align="left">
						<td><input type="radio" id="radioOpcion2" name="radioOpcion" value="2"/>Todos los Clientes (Resumen)</td>
					</tr>
					<tr align="left">
						<td><input type="radio" id="radioOpcion3" name="radioOpcion" value="3"/>Todos los Clientes (Detallado)</td>
					</tr>
					</table>
					</fieldset>
					...
					<fieldset><legend class="legend">Tipo de Documento</legend>
					<table border="0" class="tabla" width="100%">
					<tr>
						<td width="6%" ><input type="checkbox" id="cbxdoc" name="cbxdoc[]" checked="checked" value="1"/></td>
						<td width="14%">FACTURA</td>
						<td width="6%" ><input type="checkbox" id="cbxdoc" name="cbxdoc[]" checked="checked" value="2"/></td>
						<td width="14%">NOTA CARGO</td>
						<td width="6%" ><input type="checkbox" id="cbxdoc" name="cbxdoc[]" checked="checked" value="3"/></td>
						<td width="17%">ANTICIPO</td>
						<td width="6%" ><input type="checkbox" id="cbxdoc" name="cbxdoc[]" checked="checked" value="4"/></td>
						<td width="17%">NOTA CRÉDITO</td>
					</tr>
					</table>
					</fieldset>
				</td>
					...
					<tr>
						...
						<td align="center">
							<table>
								<tr>
									<td></td>
									<td>En este estado de cuentas de Antigüedad de Saldos presentará solo los documentos pendientes por Cobrar, incluyendo los que estén cancelados parcialmente.</td>
									<td>&nbsp;</td><td>&nbsp;</td>
								</tr>
							</table>
						</td>
