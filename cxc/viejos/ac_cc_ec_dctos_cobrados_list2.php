		...
		while ($rowEstado = mysql_fetch_array($rsEstado)) {
			...
			switch ($rowEstado['tipoDocumentoN']) {
				...
				case 5 : // 5 = Cheque
					switch ($rowEstado['id_modulo']) {
						case 2 : // VEHICULOS
							$aVerDcto = sprintf("<a href=\"javascript:verVentana('../caja_vh/reportes/cjvh_recibo_impresion_pdf.php?idTpDcto=5&id=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Recibo(s) de Pago(s)")."\"/><a>",
								$rowEstado['idFactura']);
							break;
						default : $aVerDcto = "";
					}
				...
				case 6 : // 6 = Transferencia
					switch ($rowEstado['id_modulo']) {
						case 2 : // VEHICULOS
							$aVerDcto = sprintf("<a href=\"javascript:verVentana('../caja_vh/reportes/cjvh_recibo_impresion_pdf.php?idTpDcto=6&id=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"".utf8_encode("Recibo(s) de Pago(s)")."\"/><a>",
								$rowEstado['idFactura']);
							break;
						default : $aVerDcto = "";
					}
