...
<head>
	...
	function validarFrmDcto(){
		...
		if (byId('hddIdFacturaNotaCargo').value > 0) {
		} else {
			if (!(validarCampo('txtIdMotivo','t','lista') == true)) {
				validarCampo('txtIdMotivo','t','lista');
                        ...
                        <tr>
                            ...
                            <fieldset><legend class="legend">Nota de Crédito</legend>
                                ...
                                <tr>                        
                                    ...
                                    <td align="left" id="tdlstVendedor">
				...
				<tr>
					...
					<td valign="top" width="50%">
						...
						<tr align="right">
							...
							<td>
								<input name="txtFlete" type="text" id="txtFlete" onblur="calcularTotal();" style="text-align:right"/>
						...
						<tr id="trNetoOrden" align="right" class="trResaltarTotal">
							...
							<td>
								<input type="text" id="txtTotalNotaCredito" name="txtTotalNotaCredito" readonly="readonly" size="17" style="text-align:right" class="inputSinFondo"/>
						...
						<tr align="right">
							...
							<td><input type="text" id="txtMontoExento" name="txtMontoExento" onblur="calcularTotal();" style="text-align:right"/></td>
						</tr>
						<tr align="right">
