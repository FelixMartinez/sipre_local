...
$objPHPExcel->getActiveSheet()->getStyle("P".$contFila.":".(chr(ord("P") + $totalRowsFormaPago - 1)).$contFila)->applyFromArray($styleArrayColumna);
$objPHPExcel->getActiveSheet()->mergeCells("P".$contFila.":".(chr(ord("P") + $totalRowsFormaPago - 1)).$contFila);
