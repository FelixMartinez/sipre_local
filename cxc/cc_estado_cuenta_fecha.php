...
if(!(validaAcceso("cc_estado_cuenta_fecha"))) {
...
include("controladores/ac_cc_estado_cuenta_fecha.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - E.C Por Fecha</title>
	...
	function validar(){
		if (validarCampo('txtFechaInicial','t','') == true)
			xajax_listarTodo(xajax.getFormValues('frmCliente'));
		else{
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar">Estado de Cuenta por Fecha
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
					...
					<tr>
						...
						<td align="center">
							<table>
								<tr>
									<td></td>
									<td>Este estado de cuenta mostrará los documentos pendientes por cobrar y cancelados de todos los clientes y todos los módulos dentro de un rango de fecha seleccionado.</td>
									<td>&nbsp;</td><td>&nbsp;</td>
								</tr>
							</table>
						</td>
...
<div id="divFlotante" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	...
	<table border="0" id="tblListadoCliente" width="600px">
