                	...
                	<td colspan="4">
                        ...
                        <tr>
                            ...
                            <fieldset><legend class="legend">Factura</legend>
                                ...
                                <tr align="left">
                                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Fecha Factura:</td>
        ...
        <tr id="trListaArticulo" align="left">
            ...
            <form id="frmListaArticulo" name="frmListaArticulo" style="margin:0">
                ...
                <tr align="center" class="tituloColumna">
                    ...
                    <td>
                        <a class="modalImg" id="aAgregarArticuloCompra" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblLista', 'Concepto');">
        ...
        <tr id="trListaPagoDcto">
            ...
            <form id="frmListaPagoDcto" name="frmListaPagoDcto" style="margin:0">
                ...
                <tr align="center" class="tituloColumna">
                    ...
                    <td><img src="../img/iconos/information.png" title="Mostrar como pago de contado en la copia del banco"/></td>
                </tr>
