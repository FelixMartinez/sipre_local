...
include("controladores/ac_cc_estado_cuenta_antiguedad_saldo.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Estado de Cuenta Antigüedad de Saldos</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td class="tituloPaginaCuentasPorCobrar">Estado de Cuenta Antigüedad de Saldos</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
            ...
            <td>
                ...
                <tr>
                    <td>
                        ...
                        }" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table>
                        </button>
                    </td>
                </tr>
                </table>
