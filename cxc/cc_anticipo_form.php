                        ...
                        <tr>
                            ...
                            <fieldset><legend class="legend">Anticipo</legend>
                                ...
                                <tr align="left">
                                    ...
                                    <td id="tdtxtFecha" colspan="2"><input type="text" id="txtFecha" name="txtFecha" style="text-align:center" size="10"/></td>
                                </tr>
                                <tr id="trNetoOrden" align="right" class="trResaltarTotal">
                                    <td class="tituloCampo">Total:</td>
                                    <td id="tdTotalRegistroMoneda"></td>
                                    <td>
                                        <input type="text" id="txtTotalAnticipo" name="txtTotalAnticipo" readonly="readonly" size="17" style="text-align:right" class="inputSinFondo"/>
        ...
        <tr id="trListaPagoDcto">
            ...
            <form id="frmListaPagos" name="frmListaPagos" style="margin:0">
                ...
                <tr align="center" class="tituloColumna">
                	<td><input type="checkbox" id="cbxItm" onclick="selecAllChecks(this.checked,this.id,'frmListaPagos');"/></td>
