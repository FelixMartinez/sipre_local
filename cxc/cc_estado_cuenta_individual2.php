...
if(!(validaAcceso("cc_estado_cuenta_individual"))) {
...
include("controladores/ac_cc_estado_cuenta_individual2.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - E.C Individual</title>
	...
	<script>
		...
		function validar(){
			...
			&& validarCampo('txtCodigoCliente','t','') == true) {	
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar">Estado de Cuenta Individual
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
					...
					<tr>
						...
						<td align="center">
							<table>
								<tr>
									<td></td>
									<td>Este estado de cuenta mostrará los documentos pendientes por cobrar de un cliente seleccionado, incluyendo los documentos cancelados parcialmente, con la opción para filtrar por módulos.</td>
									<td>&nbsp;</td><td>&nbsp;</td>
								</tr>
							</table>
						</td>
