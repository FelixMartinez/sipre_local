...
function listaNotaCredito($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	while ($row = mysql_fetch_assoc($rsLimit)){
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";
				$htmlTb .= sprintf("<a href=\"cc_nota_credito_form.php?id=%s&acc=5\" target=\"_self\"><img src=\"../img/iconos/ico_view.png\"/ title=\"Ver\"></a>",
					$row['idNotaCredito']);
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";
			switch ($row['idDepartamentoNotaCredito']) {
				...
				$htmlTb .= (strlen($aVerDctoAux) > 0) ? "<a href=\"".$aVerDctoAux."\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"Nota de Crédito PDF\"/></a>" : "";
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";
			// MODIFICADO ERNESTO
