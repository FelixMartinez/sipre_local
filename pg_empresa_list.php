	...
	<div class="pane" style="max-height:500px; overflow:auto; width:960px;">
        ...
        <tr>
            <td>
                ...
                <tr>
                    <td colspan="2">
                    <fieldset><legend class="legend">Logos</legend>
                        <table border="0" width="100%"><input type="hidden" id="accTipoImg" name="accTipoImg"/>
                        <tr align="left">
                            <td class="tituloCampo" width="50%">Grupo:</td>
                            <td class="tituloCampo" width="50%">Empresa:</td>
                        </tr>
                        <tr>
