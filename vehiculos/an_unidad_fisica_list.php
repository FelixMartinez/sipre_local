	...
	function abrirDivFlotante1(nomObjeto, verTabla, valor, valor2) {
		...
		if (verTabla == "tblUnidadFisica") {
			...
			if (valor2 == 'editar') {
				...
				jQuery(function($){
					$("#txtFechaFabricacion").maskInput("99-99-9999",{placeholder:" "});
				});
				...
				jQuery(function($){
					$("#txtFechaFabricacion").unmaskInput("99-99-9999",{placeholder:" "});
				});
...
xajax_cargaLstEmpresaFinal('<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>', 'onchange=\"xajax_cargaLstAlmacenBuscar(this.value); byId(\'btnBuscar\').click();\"');
...
xajax_cargaLstAlmacenBuscar('<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
