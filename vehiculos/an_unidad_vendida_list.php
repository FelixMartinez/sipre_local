        ...
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                        <select id="lstTipoFecha" name="lstTipoFecha" style="width:99%">
                            <option value="-1">[ Seleccione ]</option>
                            <option value="1">De Factura</option>
                            <option value="2">De Entrega</option>
                        </select>
                    </td>
                </tr>
                <tr align="left">
...
byId('lstTipoFecha').className = "inputHabilitado";
