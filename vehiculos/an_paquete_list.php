    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="xajax_formPaquete();" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                </tr>
                </table>
...
<form id="frmPaquete" name="frmPaquete" style="margin:0" onsubmit="return false;">
...
<form id="frmAccesorioPaquete" name="frmAccesorioPaquete" style="margin:0" onsubmit="return false;">
