...
if (getmysql("SELECT COUNT(*) from an_pedido WHERE id_presupuesto = ".$idPresupuesto.";") != 0 && !isset($_GET['view'])) {
	echo '<script language="javascript" type="text/javascript"> alert("No se puede modificar el presupuesto"); window.location="an_presupuesto_venta_list.php"; </script>';
	exit;
}
...
if ($row['estado'] == 3) {
	...
	<script language="javascript" type="text/javascript">
		...
		window.location="an_presupuesto_venta_list.php";
	</script>';
	exit;
}
