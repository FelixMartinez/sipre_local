    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_exportarRegistroCompra(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
                    </td>
                </tr>
                </table>
...
<form id="frmImportacion" name="frmImportacion" style="margin:0" onsubmit="return false;">
    	...
    	<td>
            ...
            <div class="panes">
                ...
                <div>
                    ...
                    <tr align="left">
                    	<td>
                        	<button type="button" onclick="xajax_exportarExpediente(xajax.getFormValues('frmImportacion'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
                        </td>
                    </tr>
                    <tr>
