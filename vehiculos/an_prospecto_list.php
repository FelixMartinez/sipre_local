...
<head>
	...
	function abrirDivFlotante1(nomObjeto, verTabla, valor) {
		...
		if (verTabla == "tblProspecto") {
			...
			ocultarDocumentosRecaudos();
			ocultarActividadAsignadas();
			ocultaSeguimiento();
			...
			byId('txtEmailProspecto').className = 'inputHabilitado';
			...
			if (valor > 0) {
				...
				xajax_muestraActividades(valor);
				xajax_actividadSeguimiento(valor);
	...
	function abrirDivFlotante2(nomObjeto, verTabla, valor, valor2) {
		...
		if (verTabla == "tblListaEmpresa") {
			...
			byId('lstNivelInteres').className = 'inputHabilitado';
			byId('txtPrecioUnidadBasica').className = 'inputHabilitado';
	...
	function validarFrmProspecto() {
		...
		&& validarCampo('txtEmailProspecto','t','email') == true
		...
		&& validarCampo('txtEmailComp','','email') == true)) {
			...
			validarCampo('txtEmailProspecto','t','email');
		...
		if (byId('lstTipoProspecto').value == 1) { // 1 = Natural, 2 = Juridico
			if (!(validarCampo('txtApellidoProspecto','t','') == true)) {
				validarCampo('txtApellidoProspecto','t','');
				
				error = true;
			}
		} else if (byId('lstTipoProspecto').value == 2) { // 1 = Natural, 2 = Juridico
		} else {
			byId('txtApellidoProspecto').className = "inputInicial";
		}
		...
		if (error == true) {
			...
			byId('btnGuardarProspecto').disabled = true;
			byId('btnCancelarProspecto').disabled = true;
			xajax_guardarProspecto(xajax.getFormValues('frmProspecto'), xajax.getFormValues('frmListaCliente'));
			xajax_guardarDocumentosRecaudados(xajax.getFormValues('frmProspecto'));
		}
	}
	...
	function validarFrmModelo() {
		...
		&& validarCampo('txtPrecioUnidadBasica','t','numPositivo') == true) {
			xajax_insertarModelo(xajax.getFormValues('frmModelo'), xajax.getFormValues('frmProspecto'));
		} else {
			...
			validarCampo('txtPrecioUnidadBasica','t','numPositivo');
	...
	//MUESTRA LAS ACTIVIDADDES DE SEGUIMIENTO
	function mostarSeguimiento(){
		$('#actividadSeguimiento').show();
	}
	//OCLUTAL OCULTA LAS ACTIVIDADES DE SEGUIMIENTO
	function ocultaSeguimiento(){
		$('#actividadSeguimiento').hide();
	}
	//MUESTRA LOS CHEBOX DE DOCUMENTOS REQUERIDOS
	function mostrarDocumentosRecaudos(){
		$('#documentoRecaudados').show();
	}
	//MUESTRA ACTIVIDADES ASIGNADAS	
	function mostrarActividadAsignadas(){
	...
	//OCULTA LOS CHEBOX DE DOCUMENTOS REQUERIDOS
	function ocultarDocumentosRecaudos(){
		$('#documentoRecaudados').hide();
	} 
	//OCULTA ACTIVIDADES ASIGNADAS		
	function ocultarActividadAsignadas(){
        ...
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstTipoCuentaCliente" name="lstTipoCuentaCliente" onchange="byId('btnBuscar').click();">
                        	<option value="-1">[ Seleccione ]</option>
                            <option value="1">Prospecto</option>
                            <option selected="selected" value="3">Prospecto Aprobado</option>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/pencil.png"/></td><td>Editar Prospecto</td>
                            <td>&nbsp;</td>
...
<form id="frmProspecto" name="frmProspecto" style="margin:0" onsubmit="return false;">
	<div class="pane" style="max-height:520px; overflow:auto; width:960px;">
                        ...
                        <tr>
                            ...
                            <fieldset><legend class="legend">Dirección Particular</legend>
                                ...
                                <tr align="left">
                                    ...
                                    <td><input type="text" name="txtCalleProspecto" id="txtCalleProspecto" style="width:99%"/></td>
                                    <td align="right" class="tituloCampo">Casa / Edif.:</td>
                                    <td><input type="text" name="txtCasaProspecto" id="txtCasaProspecto" style="width:99%"/></td>
                                </tr>
                                <tr align="left">
                            ...
                            <fieldset><legend class="legend">Dirección de Trabajo</legend>
                                ...
                                <tr align="left">
                                    <td align="right" class="tituloCampo">Urbanización:</td>
                                    <td colspan="3"><input type="text" name="txtUrbanizacionComp" id="txtUrbanizacionComp" style="width:99%"/></td>
                                </tr>
                                <tr align="left">
                                    <td align="right" class="tituloCampo">Calle / Av.:</td>
                                    <td><input type="text" name="txtCalleComp" id="txtCalleComp" style="width:99%"/></td>
                                    <td align="right" class="tituloCampo">Casa / Edif.:</td>
                                    <td><input type="text" name="txtCasaComp" id="txtCasaComp" style="width:99%"/></td>
                                </tr>
                                <tr align="left">
                                    <td align="right" class="tituloCampo"><?php echo $spanMunicipio; ?>:</td>
                ...
                <div class="wrap">
                    ...
                    <div class="pane">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <select name="lstNivelSocial" id="lstNivelSocial">
        ...
        <tr>
            <td align="right"><hr>
                ...
                <button type="button" id="btnCancelarProspecto" name="btnCancelarProspecto" class="close" onclick="ocultarDocumentosRecaudos();">Cancelar</button> 
            </td>
        </tr>
        </table>
	</div>
...
<form id="frmCliente" name="frmCliente" style="margin:0" onsubmit="return false;">
	<div class="pane" style="max-height:520px; overflow:auto; width:960px;">
        <table border="0" id="tblCliente" width="100%">
        <tr>
            <td>
                <table border="0" width="100%">
                <tr align="left">
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Datos del Contacto</legend>
                        ...
                        <tr align="left">
                            ...
                            <td>
                            <div style="float:left">
                                <input type="text" name="txtTelefonoContacto" id="txtTelefonoContacto" size="18" style="text-align:center"/>
                            </div>
                            <div style="float:left">
                                <img src="../img/iconos/information.png" title="Formato Ej.: <?php echo $titleFormatoTelf; ?>"/>
                            </div>
...
<form id="frmCredito" name="frmCredito" style="margin:0" onsubmit="return false;">
        ...
        <tr>
            ...
            <form id="frmBuscarModelo" name="frmBuscarModelo" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscarModelo" name="btnBuscarModelo" onclick="xajax_buscarModelo(xajax.getFormValues('frmBuscarModelo'), xajax.getFormValues('frmProspecto'));">Buscar</button>
        ...
        <tr>
            ...
            <form id="frmModelo" name="frmModelo" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td><input type="text" id="txtPrecioUnidadBasica" name="txtPrecioUnidadBasica" onblur="setFormatoRafk(this,2);" size="16" style="text-align:right"/></td>
                </tr>
                <tr align="left">
...
xajax_listaCliente(0,'id','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|'+byId('lstTipoPago').value+'|'+byId('lstEstatusBuscar').value+'||'+byId('lstTipoCuentaCliente').value);
