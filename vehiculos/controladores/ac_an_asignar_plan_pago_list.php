...
function listaPlanPago($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 15, $totalRows = NULL) {
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"center\">".htmlentities(date("d-m-Y",strtotime($row['fecha_asignacion'])))."</td>";
...
function guardarNotaCargoCxP($idFormaPago, $costoUnitario, $idPedidoCompraDetalle, $frmAsignacion, $frmListaPlanPago) {
	...
	$txtSubTotalNotaCargo = $costoUnitario;
	...
	$txtMontoExonerado = 0;
	$txtObservacion = "NOTA DE CARGO DE VEHICULO POR PLAN MAYOR";
