...
<form id="frmAsignacion" name="frmAsignacion" style="margin:0" onsubmit="return false;">
	<div id="tblAsignacion" style="max-height:520px; min-height:320px; overflow:auto; width:960px;">
        <table border="0" width="100%">
        <tr>
            <td>
                <table width="100%">
        ...
        <tr>
            ...
            <fieldset id="fieldsetUnidadAsignacion"><legend class="legend">Vehículos de la Asignación <b>Ref. <span id="spanTituloUnidadAsignacion"></span></b></legend>
                ...
                <tr align="left">
                    <td>
                    <a class="modalImg" id="aNuevoUnidadAsignacion" rel="#divFlotante2" onclick="abrirDivFlotante2(this, 'tblModelo');">
...
<form action="controladores/ac_upload_file_tmp.php" enctype="multipart/form-data" id="frmImportarPedido" name="frmImportarPedido" method="post" style="margin:0" target="iframeUpload">
    ...
    <div id="tblModelo" style="max-height:520px; overflow:auto; width:960px;">
        ...
        <tr>
            ...
            <form id="frmBuscarModelo" name="frmBuscarModelo" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscarModelo" onclick="xajax_buscarModelo(xajax.getFormValues('frmBuscarModelo'), xajax.getFormValues('frmAsignacion'));">Buscar</button>
        ...
        <tr>
            <td>
            <form id="frmUnidadAsignacion" name="frmUnidadAsignacion" style="margin:0" onsubmit="return false;">
                <table border="0" width="100%">
                <tr>
                    <td>
                        <table width="100%">
...
window.onload = function(){
	jQuery(function($){
		...
		$("#txtFechaCierreCompra").maskInput("99-99-9999",{placeholder:" "});
		$("#txtFechaCierreVenta").maskInput("99-99-9999",{placeholder:" "});
	});
