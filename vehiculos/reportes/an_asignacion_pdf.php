...
imagestring($img,1,0,10,strtoupper($rowEmp['ciudad_empresa'].", ".date("d")." de ".$mes[date("n")]." de ".date("Y")),$textColor);
...
imagestring($img,1,0,80,strtoupper(utf8_decode("A continuación propuesta de asignación para el mes de ".$mes[date("n", strtotime($rowEncabezado['fecha_asignacion']))]." de ".date("Y", strtotime($rowEncabezado['fecha_asignacion'])).". Una vez hecha su")),$textColor);

imagestring($img,1,0,90,strtoupper(utf8_decode("revisión les pedimos por favor firmar y comunicar su aceptación para el ".date("d", strtotime($rowEncabezado['fecha_asignacion']))." de ".$mes[date("n", strtotime($rowEncabezado['fecha_asignacion']))]." de ".date("Y", strtotime($rowEncabezado['fecha_asignacion'])).",")),$textColor);
...
$posY += 9;
$posY += 9;
imagestring($img,1,20,$posY,strtoupper("- EL CIERRE DE COMPRAS ES EL: ".date("d-m-Y", strtotime($rowEncabezado['fecha_cierre_compra']))),$textColor);

$posY += 9;
imagestring($img,1,20,$posY,strtoupper("- EL CIERRE DE VENTAS A PUBLICO ES EL: ".date("d-m-Y", strtotime($rowEncabezado['fecha_cierre_venta']))),$textColor);
