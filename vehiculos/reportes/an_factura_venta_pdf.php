...
if(in_array($rowConfig403['valor'],array(1,2))){
	...
	for ($pageNum = 0; $pageNum < 2; $pageNum++) {
		...
		$direccionCliente = strtoupper(str_replace(";", "", utf8_decode("DIRECCIÓN: ").elimCaracter(utf8_encode($rowEncabezado['direccion_cliente']),";")));
		$posY += 8;
