...
$queryEmp = sprintf("SELECT *,
	IF (vw_iv_emp_suc.id_empresa_suc > 0, CONCAT_WS(' - ', vw_iv_emp_suc.nombre_empresa, vw_iv_emp_suc.nombre_empresa_suc), vw_iv_emp_suc.nombre_empresa) AS nombre_empleado_empresa
...
<div class="marco">
    ...
    <p style="text-align:right">
		<?php echo htmlentities($rowEmp['ciudad_empresa']).", ".date("d")." de ".$mes[intval(date("n"))]." de ".date("Y"); ?>
    </p>
