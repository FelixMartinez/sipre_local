...
<form id="frmPedido" name="frmPedido" style="margin:0" onsubmit="return false;">
	<div id="tblPedido" style="max-height:520px; overflow:auto; width:960px;">
        <table border="0" width="100%">
        <tr>
            <td>
                <table width="100%">
...
<form id="frmRegistrarUnidad" name="frmRegistrarUnidad" style="margin:0" onsubmit="return false;">
...
<form id="frmInspeccion" name="frmInspeccion" style="margin:0" onsubmit="return false;">
	<div id="tblInspeccion" style="max-height:520px; overflow:auto; width:960px;">
        <table border="0" width="100%">
        <tr>
            <td>
...
<form id="frmAnularUnidad" name="frmAnularUnidad" style="margin:0" onsubmit="return false;">
	<div id="tblAnularUnidad" style="max-height:520px; overflow:auto; width:560px;">
        <table border="0" width="100%">
        <tr>
        	<td>
            	<table width="100%">
