...
<div id="divGeneralPorcentaje">
    ...
    <tr>
        <td class="tituloPaginaVehiculos">Informe de Ventas por Serial<br/><span class="texto_10px">(Venta Mensual <?php echo $emeses[$mes].' '.$ano; ?>)</span></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr>
    	<td>
            ...
            <tr align="left" class="<?php echo $clase; ?>" height="24">
                ...
                <td align="center"><?php echo date("d-m-Y", strtotime($unidad['fecha'])); ?></td>
