    ...
    <form id="presupuesto" action="an_ventas_presupuesto_guardar.php" method="post" >
        ...
        <tr>
        	<td align="center">
                ...
                if (isset($_GET['view'])) {
                    if ($_GET['view'] != 'print'){
                        echo "<strong>(MODO VISTA)</strong><br/>";
                    }
                    
                    if($_GET['view'] != 'print') { ?>
                        <button type="button" value="imprimir" onclick="imprimir();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_print.png"/></td><td>&nbsp;</td><td>Imprimir</td></tr></table></button>
                        <button type="button" value="editar" onclick="window.location='an_ventas_presupuesto_editar.php?id=<?php echo $idPresupuesto; ?>';"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/pencil.png"/></td><td>&nbsp;</td><td>Editar</td></tr></table></button>
                        <button type="button" value="Generar" onclick="window.location='an_ventas_pedido_generar.php?idPresupuesto=<?php echo $idPresupuesto; ?>';"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/plus.png"/></td><td>&nbsp;</td><td>Generar Pedido</td></tr></table></button>
                        <button type="button" value="Regresar" onclick="window.location='an_presupuesto_venta_list.php';"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/return.png"/></td><td>&nbsp;</td><td>Regresar</td></tr></table></button>
                <?php
                    }
                } ?>
            </td>
        ...
        <tr>
        	<td>
                ...
                <tr>
                    ...
                    <td colspan="2"><strong><?php echo utf8_encode($spanCiudadLocal); ?>, <?php echo ($fecha == "") ? date("d-m-Y") : $fecha; ?></strong></td>
				</tr>
                <tr>
        ...
        <tr>
        	<td>
                ...
                <tr align="right">
                	<td><div class="etiqueta"><label for="totalinicial" accesskey="t">Total Inicial, Gastos:</label></div>
                ...
                <tr align="right">
                	<td><div class="etiqueta"><label for="totalinicialflat" accesskey="t">Total Inicial, Gastos, FLAT:</label></div>
        ...
        <tr style="display:none">
        	<td>
                ...
                <tr align="left">
                    ...
                    <td align="right" class="tituloCampo" width="14%">Inicial:</td>
        ...
        <tr>
			...
			<?php if(viewmode()) { ?>
                ...
                <button type="button" id="btnCancelar" name="btnCancelar" onclick="window.open('an_presupuesto_venta_list.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
            <?php } ?>
            </td>
        </tr>
        </table>
