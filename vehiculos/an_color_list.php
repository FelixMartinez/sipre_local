...
<div id="divGeneralVehiculos">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Color</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="xajax_formColor();" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                </tr>
                </table>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                        <input type="submit" id="btnBuscar" onclick="xajax_buscarColor(xajax.getFormValues('frmBuscar'));" value="Buscar"/>
...
<form id="frmColor" name="frmColor" style="margin:0" onsubmit="return false;">
    <table border="0" id="tblColor" width="450px">
    <tr>
    	<td>
        	<table width="100%">
            <tr>
