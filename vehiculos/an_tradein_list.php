            ...
            <td>
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Trade-In</legend>
                        <table border="0" width="100%">
                        <tr>
                            <td align="right" class="tituloCampo" width="40%">Id Trade-In:</td>
                            <td width="60%"><input type="text" id="txtIdTradeIn" name="txtIdTradeIn" class="inputCompleto" maxlength="12" style="text-align:right"/></td>
                        </tr>
                        <tr align="left">
                            ...
                            <td>
                                ...
                                <tr>
                                	<td><input type="text" readonly="readonly" id="txtAllowance_2" name="txtAllowance_2" class="inputCompleto" maxlength="12" style="text-align:right"/></td>
                        ...
                        <tr align="left">
                            <td align="right" class="tituloCampo">ACV:</td>
                            <td>
                            	<table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                	<td><input type="text" readonly="readonly" id="txtAcv_2" name="txtAcv_2" class="inputCompleto" maxlength="12" style="text-align:right"/></td>
                        ...
                        <tr align="left">
                            ...
                            <td>
                            	<table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                	<td><input type="text" readonly="readonly" id="txtPayoff_2" name="txtPayoff_2" class="inputCompleto" maxlength="12" style="text-align:right"/></td>
                        ...
                        <tr align="left">
                            ...
                            <td>
                            	<table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                	<td><input type="text" readonly="readonly" id="txtCreditoNeto_2" name="txtCreditoNeto_2" class="inputCompleto" maxlength="12" style="text-align:right"/></td>
