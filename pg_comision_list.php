...
<head>
	...
	function abrirDivFlotante1(nomObjeto, verTabla, valor) {
		...
		if (verTabla == "tblComision") {
			...
			byId('trNivelProducitividad').style.display = 'none';
			byId('trPorcentajeArticulo').style.display = 'none';
			byId('trNivelProducitividadUnidad').style.display = 'none';
	...
	function abrirDivFlotante2(nomObjeto, verTabla, valor, valor2) {
		...
		byId('tblNivelProducitividadUnidad').style.display = 'none';
		...
		if (verTabla == "tblListaEmpresa") {
			...
			idObjeTitulo = 'tdFlotanteTitulo2';
			tituloDiv2 = 'Empresas';
			...
			xajax_listAccesorio();
			idObjeTitulo = "tdFlotanteTitulo3";
			tituloDiv2 = valor;
		}else if (verTabla == "tblNivelProducitividadUnidad"){
			document.forms['frmNivelPrdoctUnidad'].reset(); 
			if (valor2 == "nuevoNivelProdutividadUnidad") {
				byId('hddIdNivelProductividadUnidad').value = "";
			}
			idObjeTitulo = "tdFlotanteTitulo4";
			tituloDiv2 = valor;
		}
		
		byId(verTabla).style.display = '';
		openImg(nomObjeto);
		byId(idObjeTitulo).innerHTML = tituloDiv2;
		...
		switch(idTipoComision){
			case "1": //M.O
				if(idTipoPorcentaje == 2){
					byId('trNivelProducitividad').style.display = ''; // POR PRODUCTIVIDAD
				}
					break;
			case "5": //VEHICULO
				if(comisionSobre == 5 && idTipoPorcentaje == 3){
					byId('trNivelProducitividadUnidad').style.display = ''; // POR PRODUCTIVIDAD
				}
					break;
			case "6": //ACESSORIO
				if(comisionSobre == 3 && idTipoPorcentaje == 4){
	...
	function ocutar(){
		...
		if(byId('trNivelProducitividad').style.display == ''){ // PARA LOS NIVELES DE PRODUTIVIDA (SERVICIO)
			byId('trNivelProducitividad').style.display = 'none';
		}
		if(byId('trNivelProducitividadUnidad').style.display == ''){ // PARA LOS NIVELES DE PRODUTIVIDA (VEHICULO)
			byId('trNivelProducitividadUnidad').style.display = 'none';
		}	
	}
	...
	function validarFrmNivelProductividadUnidad(){
		...
		&& validarCampo('txPorcentaje','t','') == true) {
			if(byId("hddIdNivelProductividadUnidad").value > 0){ //editar
				xajax_editarNivelProdUnidad(xajax.getFormValues('frmNivelPrdoctUnidad'));
			} else {//insertar
				xajax_insertaNivelProductUnidad(xajax.getFormValues('frmComision'),xajax.getFormValues('frmNivelPrdoctUnidad'));
			}
		} else {
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                	<td align="right" class="tituloCampo" width="120">Modo Comisión:</td>
                    <td>
                        <select id="lstModoComisionBuscar" name="lstModoComisionBuscar" onchange="byId('btnBuscar').click();">
                            <option value="-1">[ Seleccione ]</option>
                            <option value="1">Por Venta Propia</option>
                            <option value="2">Por Venta General</option>
                            <option value="3">Por Venta Subordinada</option>
                        </select>
                    </td>
                ...
                <tr align="left">
                	...
                	<td>
                        <select id="lstTipoComisionBuscar" name="lstTipoComisionBuscar" onchange="byId('btnBuscar').click();" style="width:99%">
                            <option value="-1">[ Seleccione ]</option>
                            <option value="1">1.- M.O.</option>
                            <option value="2">2.- T.O.T.</option>
                            <option value="3">3.- Nota</option>
                            <option value="4">4.- Repuesto</option>
                            <option value="5">5.- Vehículo</option>
                            <option value="6">6.- Accesorio</option>
                            <option value="7">7.- Arbitrario</option>
                            <option value="8">8.- Facturado</option>
                        </select>
                    </td>
...
<form id="frmComision" name="frmComision" style="margin:0" onsubmit="return false;">
    <table border="0" id="tblComision" width="960">
    <tr>
    	<td valign="top" width="65%">
            ...
            <tr align="left">
                ...
                <td>
                    <select id="lstTipoPorcentaje" name="lstTipoPorcentaje" onchange="asignarTipoComision();" style="width:99%">
                        <option value="-1">[ Seleccione ]</option>
    ...
    <tr id="trPorcentajeArticulo">
        ...
        <fieldset><legend class="legend">Porcentaje Articulo</legend>
            ...
            <tr align="left">
            	<td>
<a class="modalImg" id="aNuevoPorcentajeArt" rel="#divFlotante3" onclick="abrirDivFlotante2(this, 'tblPorcentajeArt', 'Lista Articulo', 'NuevoPorcentajeArt');">
    ...
    <tr id="trNivelProducitividadUnidad">
    	<td colspan="2">
        <fieldset><legend class="legend">Nivel de Productividad Por unidad</legend>
        	<table width="100%">
            <tr align="left">
            	<td>
       <a class="modalImg" id="aNuevoNivelUnidad" rel="#divFlotante4" 
onclick="abrirDivFlotante2(this, 'tblNivelProducitividadUnidad', 'Nuevo Nivel Productividad Por Unidad', 'nuevoNivelProdutividadUnidad');">
    	...
    	<tr>
        	<td>
                <form id="frmBuscarArt" name="frmBuscarArt" onsubmit="return false;" style="margin:0">
                    <table border="0" id="tblBuscaPorcentajeArt" align="right">
                    <tr align="right">
                        <td align="right" class="tituloCampo">Criterio:</td>
                        <td align="right"><input id="txtCriterioBuscarArticulo" class="inputHabilitado" type="text" onkeyup="byId('btnBuscarPorcentajeArt').click();" name="txtCriterioBuscarArticulo"></td>
                        <td align="right">
        ...
        <tr>
        	<td>
                <form id="frmPorcentajeArt" name="frmPorcentajeArt" onsubmit="return false;" style="margin:0">
                    <table border="0" id="tblPorcentajeArt" width="760">
                        <tr>
                            <td id="tdLstArticulo" colspan="3"></td>
                        </tr>
                        <tr>
...
<div id="divFlotante4" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
    ...
    <form id="frmNivelPrdoctUnidad" name="frmNivelPrdoctUnidad" onsubmit="return false;" style="margin:0">
        <table border="0" id="tblNivelProducitividadUnidad" width="310">
            <tr align="left">
            	<td class="tituloCampo" align="right" width="120"><span class="textoRojoNegrita">*</span>Tipo de Unidad:</td>
                <td>
            ...
            <tr align="left">
                <td class="tituloCampo" align="right"><span class="textoRojoNegrita">*</span>Mayor o Igual</td>
                <td><input type="text" id="txtMayoIgual" name="txtMayoIgual" size="25" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event);" class="inputHabilitado" /></td>
            </tr>
            
            <tr align="left">
                <td class="tituloCampo" align="right"><span class="textoRojoNegrita">*</span>Menor o Igual</td>
                <td><input type="text" id="txtMenorIgual" name="txtMenorIgual" size="25" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event);" class="inputHabilitado" /></td>
            </tr>
            
            <tr align="left">
                <td  class="tituloCampo" align="right">Tipo de Unidad:</td>
                <td>
            ...
            <tr align="left">
                <td class="tituloCampo" align="right">Mayor o Igual</td>
                <td><input type="text" id="txtMayoIgual2" name="txtMayoIgual2" size="25" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event);" class="inputHabilitado" /></td>
            </tr>
            
            <tr align="left">
                <td class="tituloCampo" align="right">Menor o Igual</td>
                <td><input type="text" id="txtMenorIgual2" name="txtMenorIgual2" size="25" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event);" class="inputHabilitado" /></td>
            </tr>
            <tr align="left">
                <td class="tituloCampo" align="right"><span class="textoRojoNegrita">*</span>Porcentaje</td>
                <td><input type="text" id="txPorcentaje" name="txPorcentaje" size="25" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event);" class="inputHabilitado" /></td>
            </tr>
...
<script>
byId('lstTipoComisionBuscar').className = 'inputHabilitado';
