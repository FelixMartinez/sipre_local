        ...
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td>
                        <select multiple id="lstTipoMovimiento" name="lstTipoMovimiento" onchange="byId('btnBuscar').click();">
                            <option value="-1">[ Seleccione ]</option>
...
<form id="frmClaveMovimiento" name="frmClaveMovimiento" style="margin:0" onsubmit="return false;">
    ...
    <tr>
    	<td>
            ...
            <tr align="left">
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Tipo de Clave:</td>
                <td>
            	...
            	<td align="right" class="tituloCampo">Tipos de Pago:</td>
                <td>
            	...
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Dcto. que Genera:</td>
...
xajax_listaClaveMovimiento(0, "vw_pg_clave_mov.descripcion_modulo", "ASC", byId('lstModuloBuscar').value + '|' + lstTipoMovimiento.join());
