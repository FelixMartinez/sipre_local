    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('ga_solicitud_compras_insertar.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                </tr>
                </table>
			</td>
        	...
        	<td>
             <form id="frmListaMarca" name="frmListaMarca" style="margin:0">
				...
				WHERE vw_ga_solicitudes.id_estado_solicitud_compras != 7
					AND vw_ga_solicitudes.id_estado_solicitud_compras != 6
					AND vw_ga_solicitudes.id_estado_solicitud_compras != 5";
