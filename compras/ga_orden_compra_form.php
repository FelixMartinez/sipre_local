                            	...
                            	<fieldset>
                                    ...
                                    <table border="0" width="100%">
                                        <tr align="left">
                                            ...
                                            <td width="32%"><input type="text" id="txtCotizacion" name="txtCotizacion" size="20" style="text-align:center"/></td>
                                        ...
                                        <tr align="left">
                                            ...
                                            <td colspan="3"><textarea id="txtObservaciones" name="txtObservaciones" cols="40" rows="2"></textarea></td>
                                        </tr>
                                    </table>
                                </fieldset>
...
jQuery(function($){
	...
	$("#txtFechaCotizacion").maskInput("99-99-9999",{placeholder:" "});
});
new JsDatePick({
		useMode:2,
