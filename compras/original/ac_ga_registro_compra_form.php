...
//RECORRE EL DETALLE DE LA ORDEN PARA VERIFICAR Y ASI ACTULIZAR LOS PENDIENTES
		...
		errorGuardarDcto($objResponse,__LINE__);
		$objResponse->alert(utf8_encode("Existen artículos los cuales no tienen una ubicación asignada"));
	}
...
//$objResponse->alert($query);	
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listIva", "50%", $pageNum, "observacion", $campOrd, $tpOrd, $valBusq, $maxRows, utf8_encode("Observación"));
