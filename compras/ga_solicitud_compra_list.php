		...
		function abrirDiv(idObj,nombreObj){
			switch(nombreObj){
				...
				case "abreEmpr":
					...
					byId("btnBuscar").onclick = function() {
		...
		function valProcesarSolicitud(){
			if (validarCampo('codEmpleado','t','') == true) {
				...
				validarCampo('codEmpleado','t','');
					alert("Debe Colocar el Código de Empleado11111");
			return false;
			}
		}
...
<div id="divGeneralPorcentaje">
    ...
    <table border="0" width="100%">
        ...
        <tr class="noprint">
            <td>
                <table align="left" border="0" cellpadding="0" cellspacing="0"> <!--tabla botones-->
                    <tr>
                        <td>
                ...
                <form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                    <table  border="0" align="right">
                        <tr>
                            ...
                            <td><input type="text" id="txtNroSolicitud" name="txtNroSolicitud" class="inputHabilitado"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Desde: <input id="txtFechaDes"  name="txtFechaDes" class="inputHabilitado" type="text" style="text-align:center" size="15" autocomplete="off" globalnumber="77"></td>
                            <td colspan="2">Hasta: <input id="txtFechaHas" name="txtFechaHas" class="inputHabilitado" type="text" style="text-align:center" size="15" autocomplete="off" globalnumber="77"></td>
                        </tr> 
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input type="text" id="txtCriterio" name="txtCriterio" onkeypress="byId('buttBuscarList').click();" size="45" class="inputHabilitado"/></td>
                             <td>
                                <button type="button" id="buttBuscarList" name="buttBuscarList" onclick="xajax_BuscarSolicituComp(xajax.getFormValues('frmBuscar'));" style="cursor:default">
                                    Buscar
                                </button>
                            	<button type="button" id="buttLimpiar" name="buttLimpiar" onclick="document.forms['frmBuscar'].reset();  byId('buttBuscarList').click();" style="cursor:default">
                                    Limpiar
                                </button>
                            </td>
                        </tr>
...
<div id="divFlotante" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo" class="handle">
    	<table>
        	<tr>
            	<td id="tdFlotanteTitulo" name="tdFlotanteTitulo" width="100%" align="left"></td>
            </tr>
        </table>
    </div>
...
<div id="divFlotante1" class="root" style="cursor:auto; max-height:600px; overflow:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo1" class="handle">
    	<table>
        	<tr>
                <td id="tdFlotanteTitulo1" name="tdFlotanteTitulo1" width="100%" align="left"></td>
            </tr>
        </table>
    </div>
    	...
    	<td>
            <table width="100%" border="0">
                <tr> 
                    ...
                    <td align="right" class="tituloCampo" width="10%">Num Solicitud:</td>
                    <td align="left" width="15%"><input type="text" id="numSolicitud" name="numSolicitud" size="35px" readonly="readonly"/></td>
                </tr>
                <tr>
                    <td align="right" class="tituloCampo">Fecha:</td>
                    <td align="left" width="15%"><input type="text" id="fechSolicitud" name="fechSolicitud" size="35px" readonly="readonly"/></td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="3" >
                            <table id="tblProveedores" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td><input id="idProveedor" name="idProveedor" style="text-align:center" size="10" readonly="readonly"/></td>
                                    <td>
...
<div id="divFlotante2" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo2" class="handle">
    	<table>
        	<tr>
            	<td id="tdFlotanteTitulo2" name="tdFlotanteTitulo2" width="100%" align="left"></td>
            </tr>
        </table>
    </div>
                ...
                <form id="frmBuscar2" name="frmBuscar2" style="margin:0" onsubmit="return false;">
                    <table>
                        <tr>
                            ...
                            <td><input id="textCriterio" name="textCriterio" class="inputCompletoHabilitado" size="35" onkeypress="byId('btnBuscar').click();"/></td>
                        </tr>
                        <tr>
                            <td align="right" colspan="2">
                                <button id="btnBuscar" name="btnBuscar" title="Buscar" style="cursor:default" type="button">Buscar</button>
                                <button id="btnLimpiar" title="Limpiar" style="cursor:default" name="btnLimpiar" type="button" onclick="document.forms['frmBuscar2'].reset(); byId('btnBuscar').click();">Limpiar</button>
                            </td>
                        </tr>
                        <tr><td>&nbsp;</td></tr>
                    </table>
...
<div id="divFlotante3" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo3" class="handle">
    	<table>
        	<tr>
            	<td id="tdFlotanteTitulo3" name="tdFlotanteTitulo3" width="100%" align="left"></td>
            </tr>
        </table>
    </div>
    <table width="960">
    	<tr>
        	<td>
                <form id="frmbuscarArt" name="frmbuscarArt" style="margin:0" onsubmit="return false;"><br/>
                    <table border="0" align="right">
                        <tr>
                            <td class="tituloCampo">Criterio:</td>
                            <td><input id="textCriterioArt" name="textCriterioArt" size="35" class="inputHabilitado" onkeypress="byId('btnBuscarArt').click();"/></td>
                         </tr>
                         <tr>
                            <td align="right" colspan="2">
...
<div id="divFlotante4" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo4" class="handle"> <!--TITULO DEL LISTADO-->
    	<table width="700">
            <tr>
                <td id="tdFlotanteTitulo4" width="100%" align="left">Proveedores</td>
            </tr>
        </table>
    </div>
        ...
        <tr>
        	<td>
                ...
                <table cellpadding="0" cellspacing="0" align="right"> <!--CONTIENE EL BUSCADOR DEL LISTADO-->
                    ...
                    <tr>
                        <td class="tituloCampo">Criterio:</td>
                        <td><input type="text" id="textCriterioProveed" name="textCriterioProveed" class="inputHabilitado" size="35"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="right"><button id="BtnBuscarProvee" name="BtnBuscarProvee" onclick="xajax_buscarProveedor(xajax.getFormValues('frmBuscarProveedor'));">Buscar</button>
                        <button id="BtnLimpiarProvee" name="BtnLimpiarProvee" onclick="document.forms['frmBuscarProveedor'].reset(); byId('BtnBuscarProvee').click();">Limpiar</button></td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                </table>
                </form>
...
<script>
xajax_listadoSolicitudCompra(0,"","","<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||||<?php echo date("01-m-Y"); ?>|<?php echo date("d-m-Y"); ?>");
xajax_cargaLstEmpresaFinal('<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>', '');
xajax_combLstEstCompra();
xajax_combLstTipCompra();
	
/*PARA LOS CAMPO DE FECHA*/
