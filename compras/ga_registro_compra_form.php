                            ...
                            <td valign="top">
                                <table border="0" width="100%"> 
                                        ...
                                        <tr align="left">
                                            ...
                                            <td ><input type="text" id="txtCostoArt" name="txtCostoArt" maxlength="12" onkeypress="return validarSoloNumerosReales(event);" onblur="setFormatoRafk(this,2);" class="inputHabilitado" size="10" style="text-align:right"/></td>
...
<div id="divFlotante2" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo2" class="handle"> <!--TITULO DEL LISTADO-->
    	<table width="100%">
            <tr>
                <td id="tdFlotanteTitulo2" align="left">Cliente</td>
            </tr>
        </table>
    </div>
    <table width="960">
...
<div id="divFlotante3" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo3" class="handle"> <!--TITULO DEL LISTADO-->
    	<table width="100%">
            <tr>
                <td id="tdFlotanteTitulo3" align="left">Proveedores</td>
            </tr>
        </table>
    </div>
        	...
        	<td>
            	<form id="frmBuscarProveedor" name="frmBuscarProveedor" style="margin:0" onsubmit="return false;">
                    <table border="0" align="right"> <!--CONTIENE EL BUSCADOR DEL LISTADO-->
                        <tr>
                            <td class="tituloCampo">Criterio:</td>
                            <td><input type="text" id="textCriterioProveed" name="textCriterioProveed" class="inputHabilitado" size="25"/></td>
                        </tr>
                        <tr>
                            <td colspan="2" align="right">
                            <button id="BtnBuscarProvee" name="BtnBuscarProvee" onclick="xajax_buscarProveedor(xajax.getFormValues('frmBuscarProveedor'));">Buscar</button><button id="BtnLimpiarProvee" name="BtnLimpiarProvee" onclick="document.forms['frmBuscarProveedor'].reset(); byId('BtnBuscarProvee').click();">Limpiar</button>
                            </td>
                        </tr>
...
<div id="divFlotante4" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo4" class="handle"> <!--TITULO DEL LISTADO-->
    	<table width="100%">
            <tr>
                <td id="tdFlotanteTitulo3" align="left">Listado de Articulos</td>
            </tr>
        </table>
    </div>
...
<div id="divFlotante5" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo5" class="handle"> <!--TITULO DEL LISTADO-->
    	<table width="100%">
            <tr>
                <td id="tdFlotanteTitulo5" align="left"></td>
            </tr>
        </table>
    </div>
...
<div id="divFlotante6" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo6" class="handle"> <!--TITULO DEL LISTADO-->
    	<table width="100%">
            <tr>
                <td id="tdFlotanteTitulo6" align="left"></td>
            </tr>
        </table>
    </div>
    	...
    	<tr>
        	<td>
            	<form id="frmLstGasto" onsubmit="return false" style="margin:0">
                    <table border="0" width="100%">
                        <tr><td> <div id="divLstGastos"></div></td></tr>
                        <tr>
...
<div id="divFlotante7" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo7" class="handle"> <!--TITULO DEL LISTADO-->
    	<table width="100%">
            <tr>
                <td id="tdFlotanteTitulo7" align="left"></td>
            </tr>
        </table>
    </div>
