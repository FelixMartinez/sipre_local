...
//require_once('clases/rafklsta.php');
...
<head>
	...
	<title>.: SIPRE 2.0 :. Compras - Proveedores</title>
	...
	function validarFrmProveedor() {
		...
		if (!(validarCampo('lstEstatus','t','lista') == true
		...
		&& validarCampo('txtEmail','t','email') == true
		&& validarCampo('txtNombreContacto','t','') == true
		&& validarCampo('txtTelefonoContacto','t','telefono') == true
		&& validarCampo('txtCorreoContacto','t','email') == true
		&& validarCampo('txtNit','','rif') == true
		...
		&& validarCampo('txtFax','','telefono') == true)) {
			...
			validarCampo('txtEmail','t','email');
			validarCampo('txtNombreContacto','t','');
			validarCampo('txtTelefonoContacto','t','telefono');
			validarCampo('txtCorreoContacto','t','email');
			validarCampo('txtNit','','rif');
        ...
        <tr>
        	<td>
                ...
                <tr>
                    ...
                    <a class="modalImg" id="aNuevo" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblProveedor');">
                    	...
                    	<button type="button" onclick="xajax_exportarProveedor(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>Exportar</td></tr></table></button>
                    </td>
                </tr>
                </table>
            ...
            <form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    ...
                    <td><input type="text" name="txtCriterio" id="txtCriterio" size="30" onkeyup="byId('btnBuscar').click();"/></td>
                	<td colspan="2">
	...
	<div class="pane" style="max-height:520px; overflow:auto; width:960px;">
            ...
            <fieldset><legend class="legend">Datos Proveedor</legend>
                ...
                <tr align="left">
                    ...
                    <td id="tdTipoProveedorContadoCredito">
                        <select name="lstTipoProveedor" id="lstTipoProveedor" onchange="xajax_tipoProveedor(this.value);">
                            <option value="No" selected="selected">Contado</option>
                            <option value="Si">Credito</option>
                        </select>
                    </td>
                    <td align="right" class="tituloCampo">Contribuyente:</td>
                    <td>
                        Si<input type="radio" name="rdContribuyente" id="rdContribuyente" value="Si"/>
                        No<input type="radio" name="rdContribuyente" id="rdContribuyente" value="No" checked="checked"/>
                    </td>
                ...
                <tr align="left">
                    ...
                    <div style="float:left">
                        <img src="../img/iconos/ico_pregunta.gif" title="Formato Ej.: <?php echo $titleFormatoCI; ?>"/>
                    </div>
                    </td>
                    <td align="right" class="tituloCampo" width="12%">N.I.T.:</td>
                    <td width="22%">
                    <div style="float:left">
                ...
                <tr align="left">
                    ...
                    <div style="float:left">
                        <img src="../img/iconos/ico_pregunta.gif" title="Formato Ej.: <?php echo $titleFormatoTelf; ?>"/>
                    </div>
                    </td>
                ...
                <tr align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Email:</td>
                    <td>
                    <div style="float:left">
                        <input type="text" id="txtEmail" name="txtEmail" size="25"/>
                    </div>
                    <div style="float:left">
                        <img src="../img/iconos/ico_pregunta.gif" title="Formato Ej.: <?php echo $titleFormatoCorreo; ?>"/>
                    </div>
                    </td>
                    <td align="right" class="tituloCampo">Origen:</td>
                    <td>
                        <select name="lstTipoProveedorNacImp" id="lstTipoProveedorNacImp">
        ...
        <tr>
            ...
            <fieldset><legend class="legend">Datos del Contacto</legend>
                ...
                <tr align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Nombre(s) y Apellido(s):</td>
                    <td><input type="text" id="txtNombreContacto" name="txtNombreContacto" size="25"/></td>
                </tr>
                <tr align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Telefono:</td>
                    <td>
                    <div style="float:left">
            ...
            <fieldset><legend class="legend">Datos Adicionales Proveedor</legend>
                ...
                <tr align="left">
                    ...
                    <td>
                        <select name="lstDescuento" id="lstDescuento">
                ...
                <tr align="left">
                    ...
                    <td>
                        <select name="lstTipoCuenta" id="lstTipoCuenta">
        ...
        <tr>
            ...
            <fieldset style="display:none" id="divProveedorCredito"><legend class="legend">Datos Proveedor Credito</legend>
                ...
                <tr align="left">
                    ...
                    <td width="13%">
                        <select name="lstDiasCredito" id="lstDiasCredito">
                            <option value="5">5</option>
                            <option value="10">10</option>
                            <option value="15">15</option>
                            <option value="30">30</option>
                    ...
                    <td width="13%"><input type="text" id="txtLimiteCredito" name="txtLimiteCredito" onblur="setFormatoRafk(this);" size="15" style="text-align:right;"/></td>         
                    <td align="right" class="tituloCampo" width="12%">Plan Mayor:</td>
                    <td width="13%">
                        <select name="lstPlanMayor" id="lstPlanMayor">
                ...
                <tr>
                    <td colspan="8">
                        <table width="100%">
                        <tr align="left">
                            <td><input name="d1" type="checkbox" id="d1" value="1"/></td>
                            <td width="50%">Fotocopia del Registro Mecantil. (Ultima Publicación)</td>
                            <td><input name="d2" type="checkbox" id="d2" value="1"/></td>
                            <td width="50%">Fotocopia del RIF.</td>
                        </tr>
                        <tr align="left">
                            <td><input name="d3" type="checkbox" id="d3" value="1"/></td>
                            <td>Original de la carta de autorizacion de un representante legal.(Si es el Caso)</td>
                            <td><input name="d4" type="checkbox" id="d4" value="1"/></td>
                            <td>Original de referencias comerciales o de clientes, para persona juridica. (Por lo Menos Una)</td>
                        </tr>
                        <tr align="left">
                            <td><input name="d5" type="checkbox" id="d5" value="1"/></td>
                            <td>Original de referencia bancaria para personas juridicas. (Por lo Menos Una)</td>
                            <td><input name="d6" type="checkbox" id="d6" value="1"/></td>
                            <td>Original de la carta de autorizacion de abono en cuenta. (Si el Pago es Abono en Cuenta)</td>
                        </tr>
                        <tr align="left">
                            <td><input name="d7" type="checkbox" id="d7" value="1"/></td>
                            <td>Ultima declaracion del I.S.R.L, para persona juridica.</td>
                            <td><input name="d8" type="checkbox" id="d8" value="1"/></td>
                            <td>Original de la carta de justificación técnica (Especificaciones Técnicas) y económica (No sea Monopolio, Precios Competitivos) </td>
                        </tr>
                        <tr align="left">
                            <td><input name="d9" type="checkbox" id="d9" value="1"/></td>
                            <td colspan="3">Fianza fiel cumplimiento emitido por un Banco o Compañia Aseguradora o Afianzadora y Estados Financieros visados por un contador público.(para aquellos proveedores nuevos que reciban anticipos o que por la importancia se requiera, de acuerdo a lo establecido en la norma H de este procedimiento)</td>
                        </tr>
                        </table>
                    </td>
                </tr>
        ...
        <tr>
            <td colspan="2">
                ...
                <tr align="left">
                    ...
                    <td width="84%"><textarea name="txtObservaciones" cols="100" rows="3" id="txtObservaciones"></textarea></td>
                </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td align="right" colspan="2"><hr>
                <button type="button" id="btnGuardarProveedor" name="btnGuardarProveedor" onclick="validarFrmProveedor();">Guardar</button>      
