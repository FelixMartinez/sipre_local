...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <title>.: SIPRE 2.0 :. Compras - Devolucion de Facturas de Compra</title>
		...
		function validarFrmDcto() {
			...
			if (error == true) {
				...
				if (confirm('¿Seguro desea registrar la devolución?') == true) {
					...
					xajax_guardarDct(xajax.getFormValues('frmDcto'),xajax.getFormValues('frmBuscar'));
				}
			}
		}
    </script>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCompras">Devolucion de Facturas de Compra </td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
