...
<head>
	...
	<title>.: SIPRE 2.0 :. Compras - Artículos</title>
                ...
                <tr>
                	<td>
                        <a class="modalImg" id="aNuevo" name="aNuevo" rel="#divFlotante1" onclick="abrirDivFlotante(this.id)"><!---->
                            ...
                            <button type="button" onclick="xajax_encabezadoEmpresa(byId('lstEmpresa').value); window.print();" style="cursor:default">
                                <table align="center" cellpadding="0" cellspacing="0">
                                    <tr><td>&nbsp;</td>
...
<script>
var theHandle1 = document.getElementById("tdFlotanteTitulo1");
