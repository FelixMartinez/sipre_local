...
window.onbeforeunload = function() {
	if (cerrarVentana == false) {
		return "Se recomienda CANCELAR este cuadro de mensaje\n\nDebe Cerrar la Ventana de SIPRE 2.0 para efectuar las transacciones efectivamente";
	}
}
...
<tr>
	<td align="center" class="textoBlancoNegrita_12px" colspan="3" style="border-radius:6px;" background="../img/compras/header.gif" height="35">Copyright 2008, Goto Systems C.A. All rights reserved | Privacy Policy | Copyrights Information</td>
</tr>
</table>