...
//$objResponse->alert($queryLimit);
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listadoPedidosCompra", "30%", $pageNum, "observacioes", $campOrd, $tpOrd, $valBusq, $maxRows, "Observacion");
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"center\">".date("d-m-Y",strtotime($row['fecha_orden']))."</td>";
			...
			$htmlTb .= "<td align=\"left\">".ucfirst(strtolower(utf8_encode($row['observaciones'])))."</td>";
