...
function guardarDct($frmDcto, $frmBuscar){
	...
	$insertDevolSQL = sprintf("INSERT INTO cp_notacredito (id_empresa, id_proveedor, saldo_notacredito, 
			 ...
			 subtotal_notacredito, subtotal_descuento, total_cuenta_pagar, id_departamento_notacredito, monto_exonerado_notacredito,
			...
			SELECT id_empresa, id_proveedor, %s, %s, %s, %s, id_factura, 'FA', subtotal_factura, subtotal_descuento, total_cuenta_pagar,
			id_modulo,
	...
	$insertMovSQL = sprintf("INSERT INTO ga_movimiento (id_tipo_clave_movimiento, id_clave_movimiento,tipo_documento_movimiento, 
		id_documento,fecha_movimiento, id_cliente_proveedor, tipo_costo, fecha_captura, id_usuario, credito)
			...
			valTpDato($idFacturaCompra, "int"));
	mysql_query("SET NAMES 'utf8';");
//$objResponse->alert($insertMovSQL);
...
$objResponse->alert("BUSCA EL ULTIMO COSTO DEL ARTICULO \n".$queryCostoArt);
	...
	$insertSQL = sprintf("INSERT INTO cp_notacredito_gastos (id_notacredito, id_gastos_notacredito, tipo_gasto_notacredito, porcentaje_monto,
	 monto_gasto_notacredito, estatus_iva_notacredito, id_iva_notacredito, iva_notacredito, id_modo_gasto, afecta_documento, id_condicion_gasto)
	SELECT 
		%s,
		id_gasto,
		tipo,
