...
<head>
    ...
    <script>
		...
		function eliminarTr(tipo){//ELIMINAL OS TR DE LOS ARTICULO AGREGADOS
			switch(tipo){
...
<div id="divFlotante" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0; width:auto">
	<div id="divFlotanteTitulo" class="handle">
    	<table>
        	<tr>
            <td id="tdFlotanteTitulo" name="tdFlotanteTitulo" width="100%"></td>
            </tr>
        </table>
    </div>
...
<form id="frmAprobarSolicitud" onsubmit="return false;" name="frmAprobarSolicitud" style="margin:0">
    ...
    <tr>
    	<td>
            ...
            <tr>
				...
				<label>
                <input type="radio" id="cambiarestado" name="cambiarestado" value="6" onclick="motivo('condicionar')"/>Condicionar</label>
				<label>
                <input type="radio" id="cambiarestado" name="cambiarestado" value="7" onclick="motivo('rechazar')"/>Rechazar</label>
				</td>
    ...
    <tr>
    	<td align="right"><hr>
            <input type="text" id="idSolicitudCompra" name="idSolicitudCompra" />
            <input type="text" id="idEstadoSolicitud" name="idEstadoSolicitud" />
...
<div id="divFlotante1" class="root" style="cursor:auto; max-height:750px; overflow:auto; display:none; left:0px; position:absolute; top:0px; z-index:0; width:60%">
    ...
    <form id="frmNuevaSolicitud" name="frmNuevaSolicitud" onsubmit="return false;" style="margin:0">
        ...
        <tr> 
            ...
            <td align="right" class="tituloCampo" width="10%">N°:</td>
    ...
    <form id="frmBuscar2" name="frmBuscar2" style="margin:0" onsubmit="return false;">
        <table border="0" align="right">
            <tr>
                ...
                <td><input id="textCriterio" name="textCriterio" /></td>
                <td id="tdBtnBuscar"></td>
                <td id="tdBtnLimpiar">
                    <button id="btnLimpiar" title="Limpiar" style="cursor:default" name="btnLimpiar" type="button" 
                    onclick="document.forms['frmBuscar2'].reset(); byId('btnBuscar').click();">
                       Limpiar
                    </button>
                </td>
            </tr>
...
<div id="divFlotante3" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0; width:50%">
    ...
    <form id="frmbuscarArt" name="frmbuscarArt" style="margin:0" onsubmit="return false;">
        <table border="0" align="right">
            <tr>
            	<td class="tituloCampo">Criterio:</td>
                <td><input id="textCriterioArt" name="textCriterioArt"/></td>
                <td id="">
