...
if(!(validaAcceso("cj_devolucion_transferencia_list"))) {
...
include("controladores/ac_cj_devolucion_transferencia_list.php");
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
            <td class="tituloPaginaCaja">Devolución de Transferencias</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
            ...
            <td>
                ...
                <tr>
                    ...
                    <td align="center">
                        <table>
                        <tr>
                            <td><img src="../img/iconos/delete.png" /></td><td>Anular Transferencia</td>
                            <td>&nbsp;</td>
