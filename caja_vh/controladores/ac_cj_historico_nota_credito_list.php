...
function listaNotaCredito($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	while ($row = mysql_fetch_assoc($rsLimit)){
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td>";
				$htmlTb .= sprintf("<a href=\"../cxc/cc_nota_credito_form.php?id=%s&acc=0\" target=\"_blank\"><img src=\"../img/iconos/ico_view.png\"/ title=\"Ver\"></a>",
					$row['idNotaCredito']);
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";
			switch ($row['id_modulo']) {
				...
				case 4 : $aVerDctoAux = sprintf("../alquier/reportes/al_devolucion_venta_pdf.php?valBusq=%s", $row['idNotaCredito']); break;
				default : $aVerDctoAux = "";
			}
