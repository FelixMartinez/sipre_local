...
function cargarDcto($idTransferencia){
	...
	if ($idTransferencia > 0) {
		...
		if (!($rowTransferencia['estatus'] == 1)) {
			...
			return $objResponse->script(sprintf("window.location.href='cj_transferencia_list.php';"));
		}
...
function guardarTransferencia($frmDcto, $frmDetallePago, $frmListaDctoPagado){
	...
	if (!xvalidaAcceso($objResponse,"cj_transferencia_list","insertar")){ return $objResponse; }
	...
	cerrarVentana = true;
	window.location.href='cj_transferencia_list.php';"));
