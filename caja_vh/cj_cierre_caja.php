        ...
        <form id="form1" name="form1">
            ...
            while ($rowAperturaCaja = mysql_fetch_assoc($rsAperturaCaja)) {
                ...
                <tr align="left">
                    ...
                    <td width="22%">
                        <input type="text" id="txtFechaActual" name="txtFechaActual" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date(spanDateFormat); ?>"/>
                    </td>
                </tr>
                <tr align="left">
                    <td class="tituloCampo">Fecha Apertura:</td>
                    <td>
                        <input type="text" id="txtFechaApertura" name="txtFechaApertura" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date(spanDateFormat, strtotime($rowAperturaCaja['fechaAperturaCaja'])); ?>"/>
                    </td>
                    <td>&nbsp;</td>
                    <td class="tituloCampo">Ejecución Apertura:</td>
                    <td>
                        <input type="text" id="txtEjecucionApertura" name="txtEjecucionApertura" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date(spanDateFormat." H:i:s", strtotime($rowAperturaCaja['fechaAperturaCaja']." ".$rowAperturaCaja['horaApertura'])); ?>"/>
                    </td>
                </tr>
                <tr align="left" <?php if (in_array($rowAperturaCaja['statusAperturaCaja'], array(1,2))) { echo "style=\"display:none\""; } ?>>
                    ...
                    <td><input type="text" id="txtFechaCierre" name="txtFechaCierre" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date(spanDateFormat, strtotime($rowAperturaCaja['fechaCierre'])); ?>"/></td>
                    <td>&nbsp;</td>
                    <td class="tituloCampo">Ejecución Cierre:</td>
                    <td><input type="text" id="txtEjecucionCierre" name="txtEjecucionCierre" class="inputCompleto" readonly="readonly" style="text-align:center;" value="<?php echo date(spanDateFormat." H:i:s", strtotime($rowAperturaCaja['fechaEjecucionCierre']." ".$rowAperturaCaja['horaEjecucionCierre'])); ?>"/></td>
                </tr>
                <tr align="left">
