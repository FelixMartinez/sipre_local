            ...
            <td>
                <div class="wrap">
                    ...
                    <div class="pane">
                        ...
                        <tr>
                            <td>
                                <button type="button" onclick="xajax_imprimirFactura(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                            </td>
                        </tr>
                        </table>
                        <table border="0" width="100%">
                    ...
                    <div class="pane">
                        ...
                        <tr>
                            <td>
               	             <button type="button" onclick="xajax_imprimirContratoAlquiler(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                            </td>
                        </tr>
                        </table>
                        ...
                        <tr>
                            <td>
                            <form id="frmListaContratoAlquiler" name="frmListaContratoAlquiler" style="margin:0">
                                <div id="divListaContratoAlquiler" style="width:100%"></div>
							</form>
							</td>
                        </tr>
                        <tr>
