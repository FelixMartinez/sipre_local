...
<head>
	...
	function validarRetencion(){
		...
		&&  validarCampo('txtImporte','','') == true
		&&  validarCampo('txtUnidadTributaria','','') == true
		&&  validarCampo('txtRetencion','','') == true
		&&  validarCampo('txtSustraendo','','') == true
		&&  validarCampo('txtCodigo','t','') == true){
				xajax_guardarRetencion(xajax.getFormValues('frmCuenta'));
		} else {
			validarCampo('txtDescripcion','t','')
			validarCampo('txtImporte','','')
			validarCampo('txtUnidadTributaria','','')
			validarCampo('txtRetencion','','')
			validarCampo('txtSustraendo','','')
    	...
    	<td>
            <table border="0">
                ...
                <tr>
                    ...
                    <td><input type="text" id="txtImporte" name="txtImporte" size="30" onkeypress="return validarSoloNumeros(event);"/></td>
                </tr>
                <tr>
                    <td align="right" class="tituloCampo" width="50%">Unidad Tributaria:</td>
                    <td><input type="text" id="txtUnidadTributaria" name="txtUnidadTributaria"  size="30" onkeypress="return validarSoloNumeros(event);"/></td>
		</tr>
                <tr>
                    <td align="right" class="tituloCampo" width="50%">% Retención:</td>
                    <td><input type="text" id="txtRetencion" name="txtRetencion"  size="30" onkeypress="return validarSoloNumerosReales(event);"/></td>
		</tr>
                <tr>
                    <td align="right" class="tituloCampo" width="50%">Sustraendo en Retención:</td>
                    <td><input type="text" id="txtSustraendo" name="txtSustraendo"  size="30" onkeypress="return validarSoloNumeros(event);"/></td>
                </tr>
                <tr>
                    <td align="right" class="tituloCampo" width="50%">Codigo Concepto:</td>
                    <td><input type="text" id="txtCodigo" name="txtCodigo"  size="30" onkeypress="return validarSoloNumeros(event);"/></td>
                </tr>
                <tr>
                    <td align="right" class="tituloCampo" width="50%">Estado:</td>
                    <td>
                        <select name="selActivo" id="selActivo">
