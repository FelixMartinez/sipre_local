...
include("controladores/ac_te_propuesta_pago.php");
            ...
            <td>
            	...
            	<table border="0">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="txtMontoAPagar" name="txtMontoAPagar" size="20" style="text-align:right" onkeypress="return validarSoloNumerosRealesTesoreria(event);" onblur="validarMonto();" onfocus="$('btnAceptar').disabled = '';" readonly="readonly"/></td>
                    </tr>
                    <tr>
