...
<!--                                    <td>
		...
		<tr>
			<td align="right" class="tituloCampo">Numero Transferencia</td>
			<td><label>
				
                
                      <input type="text" id="NumeroTransferencia" name="NumeroTransferencia" size="25">
                
			</label></td>
		</tr>
        <tr>
			<td align="right" class="tituloCampo">Observacion Transferencia</td>
			<td><label>                
                 <textarea id="txtObservacionTr" name="txtObservacionTr" cols="48" rows="2" onkeyup="validarLongitud('txtObservacionTr');" onblur="validarLongitud('txtObservacionTr');"></textarea>
			</label></td>
		</tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr>
