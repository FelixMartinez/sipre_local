...
include("controladores/ac_te_propuesta_pago_mantenimiento.php");
...
<!--    <link rel="stylesheet" type="text/css" media="all" href="../js/calendar-green.css"/> 
	...
	function validarAprobacion(){
		if (validarCampo('txtConceptoCheque','t','') == true
		&& validarCampo('fechaLiberacion','t','') == true
		//&& validarCampo('numeroChequeManual','t','') == true
		&& validarCampo('txtObservacionCheque','t','') == true){
			xajax_aprobarPropuesta(xajax.getFormValues('frmCheque'),1);
		 }
		 else{
		 	validarCampo('txtConceptoCheque','t','')
                        validarCampo('fechaLiberacion','t','')
	...
	function validarLongitud(campo){
        ...
        function limpiarFormulario(){
            document.getElementById('fechaLiberacion').value = "";
            document.getElementById('numeroChequeManual').value = "";
            document.getElementById('txtIdPropuestaA').value = "";
            document.getElementById('hddIdPropuestaA').value = "";
            document.getElementById('txtConceptoCheque').value = "";
            document.getElementById('txtObservacionCheque').value = "";
            desbloquearGuardado();
        }
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td class="tituloPaginaTesoreria" colspan="2">Mantenimiento Propuesta de Pago</td>
        </tr>
        <tr>
...
<div id="divFlotante1" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0; ">
            ...
            <form name="frmBuscarProveedor" id="frmBuscarProveedor" onsubmit="return false;">
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" id="txtCriterioBusq" name="txtCriterioBusq" onkeyup="document.getElementById('btnBuscarProveedor').click();"/>
                        </td>
                        <td>    
    ...
    <div id="divCheque" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTituloCheque" class="handle"><table><tr><td id="tdFlotanteTituloCheque" width="100%">Observacion Cheque</td></tr></table></div>
	<form id="frmCheque" name="frmCheque" onsubmit="return false;">
	<table border="0" id="tblObservacionCheque">
		<tr>
			<td colspan="2" id="tdTituloListado">&nbsp;</td>
		</tr>
                <tr>
			<td colspan="2" id="tdTituloListado">&nbsp;</td>
                ...
                <tr style="display:none;">
                    ...
                    <td>
                            <input type="text" id="numeroChequeManual" name="numeroChequeManual" onkeypress="return numeros(event);" />
                    </td>
		</tr>
                <tr>
                    <td align="right" class="tituloCampo" ><span class="textoRojoNegrita">*</span>Fecha Liberaci&oacute;n:</td>
                    <td>
                            <input type="text" id="fechaLiberacion" name="fechaLiberacion" readonly="readonly" />
                    </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><label>
                      ...
                      <textarea id="txtConceptoCheque" name="txtConceptoCheque" cols="48" rows="2" onkeyup="validarLongitud('txtConceptoCheque');" onblur="validarLongitud('txtConceptoCheque');"></textarea>
        ...
        <tr>
			...
			<td><label>                
                 <textarea id="txtObservacionCheque" name="txtObservacionCheque" cols="48" rows="2" onkeyup="validarLongitud('txtObservacionCheque');" onblur="validarLongitud('txtObservacionCheque');"></textarea>
			</label></td>
		</tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr>
			...
			<input type="button" onclick="document.getElementById('divCheque').style.display='none';" value="Cancelar">
			</td>
		</tr>
	</table>
    </form>
...
<script language="javascript">
	...
	Drag.init(theHandle, theRoot);
	var theHandle = document.getElementById("divFlotanteTituloCheque");
	var theRoot   = document.getElementById("divCheque");
	Drag.init(theHandle, theRoot);
</script>