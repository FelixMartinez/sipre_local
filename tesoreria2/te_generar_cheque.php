...
include("controladores/ac_te_generar_cheque.php");
...
window.onload = function(){
  ...
  new JsDatePick({
	...
	function nuevoCheque(idEmpresa){
		...
		document.getElementById('txtFechaLiberacion').className = 'inputInicial';
		...
		document.getElementById('trChequeEntregado').style.display = 'none';
		document.getElementById('tdFlotanteTitulo').innerHTML = 'Nuevo Cheque';
	...
	function anularCheque(){
		if (validarCampo('txtComision','t','') == true){
                    ...
                    var tiene = xajax.call('tieneImpuesto', {mode:'synchronous', parameters:[document.getElementById('hddIdChequeA').value]});
        ...
        function limpiarPropuesta(){        
            ...
            document.getElementById('numeroChequePropuestaPago').innerHTML = "";
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td align="right">
				...
				<tr>
					<td>
						<button type="button" id="btnNuevo" onclick="nuevoCheque(document.getElementById('selEmpresa').value);"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
					</td>
				</tr>
				</table>
				...
				<tr align="left">
                                        ...
                                        <td align="left">
                                            ...
                                            <tr>
                                                <td>
                                                    Desde:<input type="text" style="width:100px" name="txtFecha" id="txtFecha" readonly="readonly" value=""/>
                                                    Hasta:<input type="text" style="width:100px" name="txtFecha1" id="txtFecha1" readonly="readonly" value=""/>
                                                </td>
                                                <td>
...
<!--                        <img src="../img/iconos/ico_date.png" id="imgFechaLiberacion" name="imgFechaLiberacion" class="puntero noprint"/>-->
                        <script type="text/javascript">
//                            Calendar.setup({
//                            inputField : "txtFechaLiberacion",
//                            ifFormat : "%d-%m-%Y",
//                            button : "imgFechaLiberacion"
//                            });
                        </script>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    <input type="text" readonly="readonly" id="numCheque" name="numCheque" size="25" onkeypress="return numeros(event);" style="text-align:left"/>
                    </td>
                                    ...
                                    <table border="0" class="tabla" cellpadding="2" width="97%" style="margin:auto;">
                                    	<tr>
                                            ...
                                            <td colspan="2" align="left">
                                                <input type="text" id="txtMonto" name="txtMonto" size="30" style="text-align:right" onkeypress="return validarSoloNumerosReales(event);" onblur="validarMonto();" onfocus="document.getElementById('btnAceptar').disabled = false;"/>
                                            </td>
    	...
    	<tr>
            <td align="right" id="tdDepositoBotones" colspan="2"><hr>
            	<input type="button" id="btnActualizar" name="btnActualizar" value="Actualizar" onclick="xajax_actualizarCheque(xajax.getFormValues('frmCheque'))" style="display:none"/>
...
<div id="divAnular" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	...
	<table border="0" id="tblClaveAprobacionOrden">
		...
		<tr>
			...
			<input type="button" onclick="document.getElementById('divAnular').style.display='none';" value="Cancelar">
			</td>
		</tr>
	</table>
    </form>
...
<script language="javascript">
	...
	var theRoot   = document.getElementById("divAnular");
	Drag.init(theHandle, theRoot);
	var theHandle = document.getElementById("divFlotanteTitulo2");
	var theRoot   = document.getElementById("divAnular");
	Drag.init(theHandle, theRoot);
