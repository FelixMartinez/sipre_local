                    ...
                    if (isset($_SESSION['session_error']) && $_SESSION['session_error'] == "bloqueo") {
                        ...
                        switch ($idTipoBloqueo) {
                            case 1 :
                                ...
                                $linkclose = " ó <a style=\"color:#FFFFFF;\" href=\"index.php?forceclose=1\">Forzar el Cierre de Sesi&oacute;n</a>";
                                break;
                            case 2 :
                    ...
                    <tr>
                    	<td valign="top" width="50%">
                        	<p style="font-size:11px; font-weight:bold; color:#bdb5aa; padding-bottom:8px;">
                                Arsenio Díaz
                                <br>
                                <span style="display:inline-block; color:#38A6F0; padding-right:2px;">Director de Tecnología</span>
                                <br><br>
                                Roger Ramos
                                <br>
                                <span style="display:inline-block; color:#38A6F0; padding-right:2px;">Coordinador de Desarrollo y Análisis</span>
                                <br><br>
                                José Nieves
                                <br>
                                <span style="display:inline-block; color:#38A6F0; padding-right:2px;">Especialista Analista Programador Junior</span>
                                <br><br>
                                Luis Martínez
                                <br>
                                <span style="display:inline-block; color:#38A6F0; padding-right:2px;">Especialista Analista Programador Junior</span>
                    	...
                    	<td valign="top" width="50%">
                        	<p style="font-size:11px; font-weight:bold; color:#bdb5aa; padding-bottom:8px;">
                                Carlos Agrela
                                <br>
                                <span style="display:inline-block; color:#38A6F0; padding-right:2px;">Coordinador de Soporte y Adiestramiento</span>
                                <br><br>
                                Gregor González
                                <br>
                                <span style="display:inline-block; color:#38A6F0; padding-right:2px;">Especialista Analista Programador Senior</span>
                                <br><br>
                                Shedymar Rodríguez
                                <br>
                                <span style="display:inline-block; color:#38A6F0; padding-right:2px;">Especialista Analista Programador Junior</span>
