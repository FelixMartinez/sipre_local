...
function listaCheque($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td>";			
				$htmlTb .= sprintf("<a href=\"javascript:verVentana('reportes/cjvh_recibo_impresion_pdf.php?idTpDcto=5&id=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"Recibo Cheque PDF\"/></a>",
					$row['id_cheque']);			
			$htmlTb .= "</td>";
		$htmlTb .= "</tr>";
