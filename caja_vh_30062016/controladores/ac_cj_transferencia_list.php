...
function listaTransferencia($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";			
				$htmlTb .= sprintf("<a href=\"javascript:verVentana('reportes/cjvh_recibo_impresion_pdf.php?idTpDcto=6&id=%s', 960, 550);\"><img src=\"../img/iconos/page_white_acrobat.png\" title=\"Recibo Transferencia PDF\"/></a>",
					$row['id_transferencia']);			
			$htmlTb .= "</td>";
		$htmlTb .= "</tr>";
