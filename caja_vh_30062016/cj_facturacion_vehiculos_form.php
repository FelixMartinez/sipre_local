...
if(!(validaAcceso("cj_facturacion_vehiculos_list","insertar"))) {
...
<head>
	...
	function abrirDivFlotante1(nomObjeto, verTabla, valor) {
		...
		if (verTabla == "tblListaItemPedido") {
	...
	function validarFrmListaItemPedido() {
		if (confirm("¿Desea facturar los Items Seleccionados?") == true) {
			xajax_insertarItem(xajax.getFormValues('frmListaItemPedido'), xajax.getFormValues('frmListaArticulo'), xajax.getFormValues('frmTotalDcto'))
		}
	}
	</script>
</head>
    ...
    <div id="divInfo" class="print">
            ...
            <form id="frmDcto" name="frmDcto" style="margin:0">
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Datos de la Factura</legend>
                        ...
                        <tr align="left">
                            <td align="right" class="tituloCampo">Fecha Emision:</td>
                            <td>
		...
		<tr align="right">
			<td colspan="8"><hr>
                		...
                		<button type="button" id="btnCancelar" name="btnCancelar" onclick="window.open('cj_facturacion_vehiculos_list.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
			</td>
		</tr>
		</table>
	</div>
...
<form id="frmListaItemPedido" name="frmListaItemPedido" onsubmit="return false;" style="margin:0">
    <table border="0" id="tblListaItemPedido" width="760">
    <tr>
    	<td>
