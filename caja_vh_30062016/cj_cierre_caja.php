            ...
            while ($rowAperturaCaja = mysql_fetch_assoc($rsAperturaCaja)) {
                ...
                <tr>
                   ...
                   <?php if (!(count($arrayTipoPago) > 0)) { ?>
                        <button type="button" id="btnCierreTotal" name="btnCierreTotal" onclick="window.location.href = 'cj_pagos_cargados_dia.php?acc=2'"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/key_go.png"/></td><td>&nbsp;</td><td>Recibos por Medio de Pago</td></tr></table></button>
                   <?php } ?>
                ...
                <tr align="center" style="font-size:12px;">
                    ...
                    <td>
                        ...
                        WHERE pg_cargo_departamento.clave_filtro = 10
