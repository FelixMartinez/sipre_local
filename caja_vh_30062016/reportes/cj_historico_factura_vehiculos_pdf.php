...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////// HISTORICO DE FACTURAS DE VEHÍCULOS ///////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($totalRows > 0) {
	...
	while ($contFila<1) {
		...
		if ($contFila % 45 == 1) {
			...
			$pdf->Ln();
			$pdf->Cell(562,10,"HISTÓRICO DE FACTURAS DE VEHÍCULOS",0,0,'C');
		...
		while ($rowDetalle = mysql_fetch_assoc($rsDetalle)){
			...
			$pdf->Cell($arrayTamCol[5],12,(($row['condicionDePago'] == 1) ? "CONTADO" : "CRÉDITO"),'LR',0,'C',true);
