...
while ($rowRecibo = mysql_fetch_assoc($rsRecibo)) {
	...
	$pdf->Ln(); $pdf->Ln();
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(562,5,"Nro. Recibo: ".$nroRecibo."  Nro. Nota de Débito: ".$nroNotaCargo."",0,0,'C');
	...
	$pdf->Cell(160,15,"Teléfono: ".$rowNotaCargo['telf']."",0,0,'L');
	...
	$pdf->MultiCell(550,15,"OBSERVACIÓN: ".$rowNotaCargo['observacionNotaCargo'], 0, 'L');
	$pdf->Cell(20,5,"",0,0,'L');
