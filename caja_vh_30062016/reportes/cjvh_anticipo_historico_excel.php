...
$objPHPExcel->getActiveSheet()->getStyle("N".$contFila.":".($contColumFP).$contFila)->applyFromArray($styleArrayColumna);
$objPHPExcel->getActiveSheet()->mergeCells("N".$contFila.":".($contColumFP).$contFila);
