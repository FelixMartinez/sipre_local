...
if(!(validaAcceso("cj_devolucion_vehiculos_list"))) {
...
include("controladores/ac_cj_devolucion_vehiculos_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Devolución de Vehículos</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
        	<td class="tituloPaginaCaja">Notas de Crédito de Vehículos</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
