...
function cargarRetencion($idRetencion){
	...
	$objResponse->script("
		$('txtDescripcion').className = 'inputHabilitado';
		$('txtImporte').className = 'inputHabilitado';
		$('txtUnidadTributaria').className = 'inputHabilitado';
		$('txtRetencion').className = 'inputHabilitado';
		$('txtSustraendo').className = 'inputHabilitado';
		$('txtCodigo').className = 'inputHabilitado';
		$('selActivo').className = 'inputHabilitado';
	");
...
function listarRetenciones($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	$htmlTblIni .= "<table border=\"0\" width=\"100%\">";
		...
		$htmlTh .= ordenarCampo("xajax_listarRetenciones", "", $pageNum, "codigo", $campOrd, $tpOrd, $valBusq, $maxRows, "C&oacute;digo Concepto");
	...
	while ($rowRetencion = mysql_fetch_assoc($rsLimitRetenciones)) {
            ...
            $htmlTb .= "<tr class=\"".$clase."\">";            
					...
					if($rowRetencion["id"] == 1){//SIN RETENCION
						$htmlTb .= "<td></td>";
					}else{
