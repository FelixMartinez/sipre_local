...
include("controladores/ac_te_nota_debito.php");
//modificado Ernesto
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>.: SIPRE <?php echo cVERSION; ?> :. Tesoreria - Notas de Debito</title>
...
function validarFormInsertar(){
    ...
    {
            if (parseFloat(document.getElementById('txtImporteMovimiento').value)+parseFloat(document.getElementById('hddDiferido').value) > parseFloat(document.getElementById('hddSaldoCuenta').value)){
                    if (confirm('El monto de la Nota de Debito es mayor que el saldo en la cuenta Desea Sobregirar la Cuenta?') == true){
                        ...
                        document.getElementById('tdFlotanteTitulo3').innerHTML = 'Aprobación';
                        desbloquearAceptarClave();
                        return false;					
                    }else{
                        desbloquearGuardado();
                        return false;   
                ...
                xajax_guardar(xajax.getFormValues('frmNotaDebito'));//este guarda y hay otro aparte el verificar clave sobregirar
            }
...
function validarClaveAprobacion(){
        if (validarCampo('txtClaveAprobacion','t','') == true){
                xajax_verificarClave(xajax.getFormValues('frmClave'),xajax.getFormValues('frmNotaDebito'));
         }else{
...
function desbloquearAceptarClave(){                    
    document.getElementById("btnAceptarClave").disabled = false;        
}
    		...
    		<td>
                ...
                <tr>
                    <td align="right" class="tituloCampo" width="120">Saldo Cuenta:</td>
                        <td colspan="3"><input type="text" id="txtSaldoCuenta" name="txtSaldoCuenta" size="25" readonly="readonly"/>
                         <input type="hidden" id="hddSaldoCuenta" name="hddSaldoCuenta" />
                         <input type="hidden" id="hddDiferido" name="hddDiferido" /></td>
                ...
                <fieldset><legend><span style="color:#990000">Datos Nota Debito</span></legend>
            <table>
                <tr>
                    ...
                    <td align="left">
                    	<table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                        <input style="width:100px" type="text" name="txtFechaRegistro" id="txtFechaRegistro" readonly="readonly"/>
                                </td>
                                <td>
                               </td>
                           </tr>
                 ...
                 <tr>
                        <td align="right" class="tituloCampo" width="120"><span class="textoRojoNegrita">*</span>Numero Nota Debito:</td>
                ...
                <tr>
                    <td align="right" class="tituloCampo" width="120"><span class="textoRojoNegrita">*</span>Tipo Nota Debito</td>
                    <td colspan="3">
...
<div id="divFlotante3" class="root" style="position:absolute; cursor:auto; display:none; left:0px;; top:0px; z-index:3;">
	...
	<table border="0" id="tblClaveAprobacionOrden">
		...
		<tr>
			...
			<hr>
			<input type="submit" id="btnAceptarClave" name="btnAceptarClave" onclick="this.disabled = true; validarClaveAprobacion();" value="Aceptar" />
			<input type="button" onclick="desbloquearGuardado(); document.getElementById('divFlotante3').style.display='none';" value="Cancelar">
			</td>
		</tr>
	</table>
    </form>
...
xajax_listadoNotaDebito(0,'id_nota_debito','DESC','' + '|' + -1 + '|' + 0 + '|' + '' + '|' + '' + '|' + '');
