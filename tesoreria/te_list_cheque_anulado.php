...
include("controladores/ac_te_list_cheque_anulado.php");
...
function verificarImpresion()
{
	...
	{
		xajax_enviar(document.getElementById('hddId').value,document.getElementById('hddacc').value);
	}
	else
		return false;
}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
		<table width="100%">
            ...
            <tr>
                <td align="right">
                    <form id="frmBuscar" name="frmBuscar" onsubmit="xajax_buscarCheque(xajax.getFormValues('frmBuscar')); return false;" style="margin:0">
                    <table width="100%" border="0" align="right">
                        ...
                        <td width="120" align="right" co class="tituloCampo" >Fecha Cheque:</td>
                        <td>
                        ...
                        <tr align="right">
                            ...
                            <td align="right"  width="120" class="tituloCampo" >Nº Cheque:</td>
                            ...
                            <td width="350">
                                <button type="button" name="btnBuscar" id="btnBuscar" onclick="xajax_buscarCheque(xajax.getFormValues('frmBuscar'));" >Buscar</button>
...
<script>
xajax_listarChequeAnulado(0,'fecha_registro','DESC','-1|0||');
