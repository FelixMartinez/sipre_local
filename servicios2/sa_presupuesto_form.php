        ...
        <form id="frmDatosPaquete" name="frmDatosPaquete" style="margin:0">
            ...
            <tr>
                <td id="tdBtnAccionesPaq" align="right">
                    ...
                    <input type="button" id="btnAsignarPaquete" onclick="validarPaquete();" value="Aceptar"/>
        ...
        <form id="frmDatosTempario" name="frmDatosTempario" style="margin:0" onsubmit="return false;">
            ...
            <tr>
            	<td align="right" colspan="6">
                    <hr/>
                    <input type="submit" id="btnAsignarTemp" onclick="validarTempario();" value="Aceptar"/>
...
<!--                    <input type="hidden" id="hddIdIvaRepuesto" name="hddIdIvaRepuesto" readonly="readonly"/>
            ...
            <tr>
                <td align="right" colspan="5">
                    <hr>
                    <input type="submit" id="btnInsertarArticulo" name="btnInsertarArticulo" onclick="validarFormArt();" value="Aceptar">
                    <input type="button" onclick="$('divFlotante2').style.display = 'none'; $('divFlotante').style.display = 'none';" value="Cerrar">
                </td>
            </tr>
            </table>
...
<form id="frmDatosNotas" name="frmDatosNotas" style="margin:0">
    ...
    <tr>
        <td align="right" colspan="2">
        	<hr/>
            <input type="button" id="btnGuardarNota" name="btnGuardarNota" onclick="validarNota();" value="Guardar"/>
    ...
    <tr>
        <td align="right">
            <hr/>
            <input type="button" id="btnAsignarTot" onclick="validarTot();" value="Aceptar"><!-- validarTot(); -->
