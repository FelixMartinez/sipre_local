...
<head>
	...
	function cargarFecha(){
		...
		$('txtFechaOrigen').value = dia  + "-" + mes + "-" + fecha.getFullYear();
	}
	
	function validarTodoForm(){
		if ($('auxiliar').value == 0){//costo total subtotal
	...
	function tot(){
		...
		xajax_contribuyente(<?php echo $_GET['id']; ?>);
		//borrarFormularios();
		$('auxiliar').value = 1;
                                ...
                                <td>
                                    <table border="0" width="100%">
                                        <tr>
                                            ...
                                            <td align="right">
                                            	<input class="noprint" type="button" value="Imprimir" onclick="window.print();"/>
                                          	</td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td valign="top">
                                    <table border="0" width="100%">
										...
										<tr>
											...
											<td class="noprint"><button type="button" id="btnInsertarProveedor" name="btnInsertarProveedor" onclick=" $('txtIdProv').value = ''; $('txtNombreProv').value = ''; $('txtContactoProv').value = ''; $('txtEmailContactoProv').value = ''; $('txtDireccionProv').value = ''; $('txtTelefonosProv').value = ''; $('txtFaxProv').value = ''; $('txtCriterioBusqueda').value = '';
                                    ...
                                    <table border="0" width="100%">
                                        ...
                                        <tr>
											...
											<td align="left" width="5%" class="noprint">
                                            	<button type="button" id="btnInsertarVehiculo" name="btnInsertarVehiculo" onclick="document.forms['frmDatosVehiculo'].reset(); $('txtCriterioBusqueda').value = '';
  xajax_buscarVehiculos(xajax.getFormValues('frmBuscar'), document.getElementById('selEmpresa').value);" title="Seleccionar Orden"><img src="../img/iconos/ico_pregunta.gif"/></button>
                    ...
                    <form id="frmDatosFactura" name="frmDatosFactura">
                        <table border="0" width="100%">
                            ...
                            <tr>
                            	...
                            	<td align="left" width="17%"><input type="text" id="txtNumeroFacturaProveedor" name="txtNumeroFacturaProveedor" size="20"/></td>
                            	<td align="right" class="tituloCampo" width="14%"><span class="textoRojoNegrita">*</span>Nº Control:</td>
                            	<td align="left" width="14%">
						<div style="float:left">
							<input type="text" id="txtNumeroControl" name="txtNumeroControl" size="20"/>
						</div>
						<div style="float:left">
							<img src="../img/iconos/ico_pregunta.gif" title="Formato Ej.: 00-000000"/>
                            	...
                            	<td width="14%">
                            		<div style="float:left"><input type="text" id="txtFechaProveedor" name="txtFechaProveedor" size="16" readonly="readonly"/></div>
                            ...
                            <tr>
                                ...
                                <td align="left" id="tdSelTipoPago">
                                    <label>
                                        <select name="slctTipoPago" id="slctTipoPago">
                                ...
                                <td width="14%" align="left" id="tdSelAplicaLibros">
                                    <label>
                                        <select name="slctAplicaLibros" id="slctAplicaLibros">
                                ...
                                <td>
                                	<div style="float:left"><input type="text" id="txtFechaOrigen" name="txtFechaOrigen" size="16" readonly="readonly"/></div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3" rowspan="2" align="left">
                                	<label>
                                		<textarea name="txtObservacionFactura" id="txtObservacionFactura" cols="59" rows="2"></textarea>
                                	</label>
                                </td>
							</tr>
                            <tr>
                                	...
                                	<table width="100%" >
                                    	<tr>
                                        	<td width="50%" class="noprint">
                                            	<button type="button" style="display:none" id="btnInsertarTrabajoRequerido" name="btnInsertarTrabajoRequerido" onclick="$('tblTrabajoRequeridos').style.display = ''; $('divFlotante').style.display = ''; $('divFlotanteTitulo').innerHTML = 'Agregar Detalle'; $('tblListados').style.display = 'none'; centrarDiv($('divFlotante')); document.forms['frmTrabajoRequerido'].reset();" title="Agregar Detalle"><img src="../img/iconos/ico_agregar.gif"/></button>
                                            	<button type="button" style="display:none" id="btnInsertarAccesorios" name="btnInsertarAccesorios" onclick="abrirAccesorios();" title="Agregar Detalle"><img src="../img/iconos/ico_agregar.gif"/></button>
                    &nbsp;
                                ...
                                <td rowspan="2" width="55%">
                                    <table border="0" width="100%">
                                        <tr align="right">
                                            ...
                                            <td width="26%"></td>
                                            <td width="12%"></td>
                                            <td align="right" width="25%"><input type="text" id="txtSubTotal" name="txtSubTotal" size="17" style="text-align:right" onkeypress="return validarSoloNumerosReales(event);" onkeyup="xajax_calcularTotal(xajax.getFormValues('frmTotalFactura'),xajax.getFormValues('frmDetallesTrabajoRequeridos'),0);" /></td>
                                        </tr>
                                        <tr align="right">
                                            <td class="tituloCampo" width="37%"><span class="textoRojoNegrita">*</span>Monto Exento:</td>
                                            <td width="26%"></td>
                                            <td width="12%"></td>
                                            <td align="right" width="25%"><input type="text" id="txtMontoExento" name="txtMontoExento" size="17" style="text-align:right" onkeyup="xajax_calcularTotal(xajax.getFormValues('frmTotalFactura'),xajax.getFormValues('frmDetallesTrabajoRequeridos'),0);" /></td>
                                        </tr>
                                        <tr id="trPieFactura">
                                            <td colspan="4"><hr></td>
                                        </tr>
            ...
            <tr>
                <td align="right" width="50%">
                    <hr>
                    <input type="button" id="btnGuardar" name="btnGuardar" onclick="validarTodoForm();" value="Guardar" />
                    <?php
                        if($_GET['acc']==0){
                    ...
                    ?>
                    <input type="button" id="btnCancelar" name="btnCancelar" value="Cancelar" onclick="window.open(<?php echo $boton_cancelar; ?>);" class="noprint">
                </td>
            </tr>
        </table>
    </div>
...
<div id="divFlotante" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
    ...
    <tr>
        ...
        <td id="tdCriterioBusquedaButton">
            <button class="noprint" type="button" id="btnBuscar" name="btnBuscar" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/find.png"/></td><td>&nbsp;</td><td>Buscar</td></tr></table></button>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td>
                	<textarea id="txtDescripcionTrabajoRequerido" name="txtDescripcionTrabajoRequerido" cols="60" rows="3"></textarea>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td align="right" width="15%">
            <hr>
            <input type="button" id="bttGuardarDivFlotante" name="bttGuardarDivFlotante" onclick="validarForm();" value="Guardar">
            <input type="button" id="bttCancelarDivFlotante" name="bttCancelarDivFlotante" onclick="$('divFlotante').style.display='none';" value="Cancelar">
        </td>
    </tr>
    </table>
    </form>
    ...
    <table border="0" id="tblListadoAccesorios" width="500px" >
        ...
        <tr>
            <td align="right" colspan="6">
                <hr/>
                <input type="button" onclick="$('divFlotante2').style.display='none';" value="Cerrar"/>
            </td>
        </tr>
    </table>
