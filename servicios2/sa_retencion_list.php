    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="xajax_buscarRetenciones(xajax.getFormValues('frmBuscar')); return false;" style="margin:0">
                ...
                <tr>
					<td align="right" width="10%" class="tituloCampo">Empresa/Sucursal: </td>
                    <td align="left" id="tdSelEmpresa">
                    	<!--<select id="selEmpresa" name="selEmpresa">
                        </select>-->
                    </td>
                    <td align="right" class="tituloCampo" width="13%">
                    Criterio de busqueda
                    </td>
                    <td align="left" width="12%">
                    	<select id="criterioBusqueda" name="criterioBusqueda">
                        	<option value="0">N&deg; Retencion</option>
                            <option value="1">N&deg; Control Fact.</option>
                            <option value="2">Proveedor</option>
                            <option value="3">N&deg; Factura</option>
                        </select>
                    </td>
					<td align="left" width="13%"><input type="text" name="txtBusq" id="txtBusq" onkeyup="xajax_buscarRetenciones(xajax.getFormValues('frmBuscar'));"/></td>
...
xajax_listadoRetencion(0,'idRetencionCabezera','DESC','' + '|' + -1 + '|' + 0);
</script>