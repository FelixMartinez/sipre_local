...
<head>
	...
	<title>.: Sistema ERP :. .: Módulo de Crm :. - Actividades</title>
	...
	function abrirFrom(idObj, valor, valor2){
		...
		if(valor == 0) { 
			...
			xajax_comboxTipoDeActividad('<?php $result = buscaTipo(); echo $result[1]; ?>');
			//xajax_comboPosicion();
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                 ...
                 <tr>
                    ...
                    <td colspan="3">
                       <input type="text" id="textCriterio" name="textCriterio" class="inputHabilitado" onclick="byId('btnBuscar').click();" style="width:98%" /> 
                    </td>
                 </tr>
                 <tr>
...
<form id="frmActividad" name="frmActividad" style="margin:0" onsubmit="return false;">
    <table border="0" id="tblClaveEspecial" width="760">
        ...
        <tr align="left">
            ...
            <td><input type="text" id="txtNombreAbreviado" name="txtNombreAbreviado" size="55"/></td>
        </tr>
        <tr align="left">
...
xajax_listadoActividad(0,'tipo','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>'+'|||1');
