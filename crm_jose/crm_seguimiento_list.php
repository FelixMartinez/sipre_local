...
<head>
    ...
    <title>.: Sistema ERP :. .: Módulo de CRM :. - Control de Trafico</title>
...
function abrirFrom(idObj, forms, IdObjTitulo, valor, valor2){ 
	...
	if(IdObjTitulo == "tdFlotanteTitulo"){
			...
			xajax_asignarEmpleado('<?php echo $_SESSION['idEmpleadoSysGts']; ?>', byId('lstEmpresa').value);
		...
		xajax_listaModelo(0, "", "", byId('lstEmpresa').value);
		xajax_cargaLstMedio();
		xajax_cargaLstPlanPago();
	}else if (IdObjTitulo == "tdFlotanteTitulo5"){
		byId('lstTipoCuentaCliente').onchange = function() {
			selectedOption(this.id,valor);
		}
		xajax_listaCliente( 0, "","",byId('lstEmpresa').value+"||||"+valor);
		...
		xajax_cargaLstEquipo("","Postventa");
		...
		xajax_listaPosibleCierre(0, "", "", byId('lstEmpresa').value +"|"+ valor);
	}
	openImg(idObj);
                	...
                	<table border="0" width="100%">
                    	<tr>
                            <td valign="top" align="left" width="50%">
                                ...
                                <!--<a class="modalImg" id="" rel="#" onclick="">
                                    <button type="button" id="btnHojaTrabajo" style="cursor:default">
                                        <table align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td><img class="puntero" src="../img/iconos/pdf_ico.png" title="Editar"/></td>
                                                <td>&nbsp;</td>
                            	...
                            	<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                                    <table border="0" width="80%">
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="textCriterio" name="textCriterio" class="inputHabilitado" style="width:97%" onblur="byId('btnBuscar').click();" /></td>
                                        </tr>
                                        <tr>
	...
	<div class="pane" style="max-height:520px; overflow:auto; width:960px;">
                    ...
                    <div class="pane">
                        ...
                        <tr align="left">
                            <td colspan="6">
                                ...
                                <button id="btnEliminarModelo" name="btnEliminarModelo" onclick="xajax_eliminarModelo(xajax.getFormValues('frmSeguimiento'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/delete.png"/></td><td>&nbsp;</td><td>Quitar</td></tr></table></button>
                            </td>
                        </tr>
        ...
        <tr>
            <td align="right"><hr>
                ...
                <button type="button" id="btnCancelarProspecto" name="btnCancelarProspecto" class="close" onclick="">Cancelar</button> 
            </td>
        </tr>
        </table>
	</div>
                ...
                <form id="frmBusCliente" name="frmBusCliente" style="margin:0" onsubmit="return false;">
                    <table align="right" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="lstTipoCuentaCliente" name="lstTipoCuentaCliente" class="inputHabilitado">
                                    <option value="-1">[ Seleccione ]</option>
                ...
                <form id="frmBusPosibleCierre" name="frmBusPosibleCierre" style="margin:0" onsubmit="return false;"> 
                	<table width="50%">
                        ...
                        <tr>
                            ...
                            <td>
                            	<input id="textCriterioPosibleCierre" name="textCriterioPosibleCierre" class="inputHabilitado" onblur="byId('btnBuscar').click();" style="width:97%" >
                            </td>
                        </tr>
                        <tr align="right">
                        	<td colspan="2">
                                ...
                                <button id="btnLimPosibleCierre" name="btnLimPosibleCierre" onclick="document.forms['frmBusPosibleCierre'].reset();byId('btnBusPosibleCierre').click();">Limpiar</button>
                            </td>
                        </tr>
                        <tr>
                        	<td colspan="2">&nbsp;</td>
...
xajax_lstSeguimiento(0,"","","||||"+"<?php echo date("Y-m-d"); ?>"+"|"+"<?php echo date("Y-m-d"); ?>");
