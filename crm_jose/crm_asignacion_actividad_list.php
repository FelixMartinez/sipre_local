                    ...
                    <form id="fromTipoEquipo" name="fromTipoEquipo" onsubmit="false;">
                        <table align="right" border="0">
                            <tr align="left">
                                ...
                                <td><input id="fechaSelectEquipo" class="inputHabilitado" type="text" size="20" readonly="readonly" name="fechaSelectEquipo" globalnumber="656" value = "<?php echo date("d-m-Y"); ?>"> </td>
                                <td  align="right" class="tituloCampo">Tipo de Equipo:</td>
                                <td id="tdTipoEquipo"></td>
                            </tr>
                            <tr>
                                <td align="right" class="tituloCampo">Equipos:</td>
                        	...
                        	<fieldset>
                                ...
                                <table border="0" align="right">
                                    ...
                                    <tr align="right">
                                        ...
                                        <td align="left" colspan="3">Desde: <input type="text" id="fechaInicio" name="fechaInicio" readonly="readonly" class="inputHabilitado" size="20"/> Hasta: <input type="text" id="fechaFin" name="fechaFin" readonly="readonly" class="inputHabilitado" size="20"/></td>
                                    </tr>
                                    <tr align="right">
                                        <td colspan="4">
                                ...
                                <form id="formGenerarGrafico2" name="formGenerarGrafico2">
                                    <table border="0" align="right">
                                        ...
                                        <td align="left" colspan="3">
                                            Desde:<input type="text" id="fechaInicio2" name="fechaInicio2" readonly="readonly" class="inputHabilitado" size="20"/>
                                            Hasta:<input type="text" id="fechaFin2" name="fechaFin2" readonly="readonly" class="inputHabilitado" size="20"/>
                                        </td>
                                        </tr>
                                        <tr>                           
                        ...
                        <form  id="formBuscar" name="formBuscar" onsubmit="retunr false" style="margin:0">
                            <table align="right" border="0">
                                ...
                                <tr >
                                    ...
                                    <button type="button" id="butLimpiaServicior" name="butLimpiar" onclick="this.form.reset(); byId('butBuscarServicio').click();">
                                    Limpiar
                                    </button>
                                    </td>
                                </tr>
