...
function comprobar(){
	...
	if($rows['id_ofrecer_servicio']){ //tiene servicio ofrecido
		$fechaEvaluar = $rows['fecha_envio']; //envio del uiltimo servicio ofrecido
		...
		$kmIngreso = $rows['Km'];//km entrda por servicio
	}
...
//PARA ENVIAR EL CORREO DE SERVICIO (OFRESER UN SERVICIO NUEVO)			   
function enviarCorreoOfrecimiento($datosCliente ="", $datosEmpresa= "",$nomMarca = "", $tipo){
	...
	//PARA MOSTAR LAS FECHA COMPLETA EN ESPAÃƒ'OL
	...
	$textMail = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
				...
				<title>.: Sistema ERP :. .: M&oacutedulo de CRM :. - Ofreser Nuevo Servicio</title>
				</head>
				...
				contamos con un personal altamente calificado en los Departamentos de Venta, Post-Venta y Respuestos, para ofrecerle el Servicio y la Calidad Superior que 
				...
				<p>De igual manera contamos con el agrado de informarle que su veh&iacuteculo <b>". $Datos[4]."</b> modelo <b>".$Datos[5]."</b> de la placa <b>".$Datos[3]."</b>  ya ha cumplido ".$Datos[7]." ".$mese. " desde el  &uacuteltimo servicio que realiz&oacute en nuestro taller. Queremos 
				ofrecerle una revisi&oacuten de <strong>" .$siguienteKmOfrecer. " Km</strong>; si est&aacute interesado en recibir mayor informaci&oacuten sobre los servicios que podamos 
				ofrecerle, no dude en comunicarse o vis&iacutetennos personalmente que lo atenderemos de manera gustosa y muy cordialmente.</p>
				
				<p>Sin m&aacutes, y esperando que haya sido de su inter&eacutes esta informaci&oacuten, le deseamos un feliz dia.</p> <br/>
				
				<p align='center'>
					<b>".ucwords(strtolower($direccionTaller))." <br/>
					Telefono:" .$telefonoTaller1."/ ".$telefonoTaller2."/ ".$telefonoTaller3."/ " .$telefonoTaller3." <br/>
					Web: ".$web."</b>
				</p>
				</body>
				</html>";
		...
		$Subject = "Felicitacidades en su Cumplea&ntildeo";
...
<h3 align='right'>Caracas. " .$fechaActual."</h3>
				...
				<p> De parte de <b>" .ucwords(strtolower($nombreEmpresa)). "</b>; es muy grato para nosotros felicitarlo por su cuimple&ntilde;o numero <b>".$Datos[3]."</b>, y 
				desearle que en este dia tan especial, este llene de mucha felicidades, exito, oportunidaes y logros en su vida personal y entodo aquello que se proponga,
				ahnele y desees. Son nuestros mas sinceros deseos.
					<p align='center'><img src='cid:imgTorota' xsrc='cid:imgTorota' /> <h3>&iexcl;FELIZ CUMPLEA&NtildeOS! le desea " .ucwords(strtolower($nombreEmpresa)). "</h3> </p>
