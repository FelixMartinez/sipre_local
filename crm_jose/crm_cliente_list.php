...
<head>
	...
	<title>.: Sistema ERP :. .: Módulo de Crm Cliente :.</title>
        ...
        <tr>
        	<td>
                <table align="left" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                        	<button type="button" onclick="abreDocumento('Excel');" style="cursor:default">
                ...
                <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                    <table align="right" border="0">			
                        <tr align="left">
                         ...
                         <tr align="left">
                            <td align="right" class="tituloCampo">Ver Cliente:</td>
                            <td>
                            ...
                            <td align="right" class="tituloCampo">Tipo de Cliente:</td>
                         	<td>
                         ...
                         <td align="right" class="tituloCampo">Fecha:</td>
                            <td colspan="3">
                            	Desde:<input id="textFechaDesde" name="textFechaDesde" size="15px" class="inputHabilitado" type="text" onkeyup="">
                            	Hasta:<input id="textFechaHasta" name="textFechaHasta" size="15px" class="inputHabilitado" type="text" onkeyup="">    
                            </td>
                         </tr>
                         <tr>
                         	<td  align="right" class="tituloCampo">Criterio:</td>
                            <td colspan="3"><input id="txtCriterio" name="txtCriterio" size="35px"class="inputHabilitado" type="text" onkeyup=""></td>
                         </tr>
                         <tr align="right">
                            <td colspan="4">
