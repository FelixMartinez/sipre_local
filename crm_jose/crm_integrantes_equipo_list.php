...
function abrirNuevo(idEquipo) {
	document.getElementById("fomrEquipo").reset();
	$("#comboxTipoEquipo").remove();
	xajax_eliminarIntegrante(xajax.getFormValues('fomrEquipo'));
                	...
                	<table border="0" width="100%">
                    	<tr>
                            <td align="left" valign="top">
                                <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="abrirNuevo('');openImg(this);">
                            ...
                            <td>
                                <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                                    <table align="right" border="0"> <!--contien el buscador-->			
                                        <tr align="left">
                                            <td align="right" class="tituloCampo">Empresa:</td>
                                            <td id="tdlstEmpresa"></td>
                                        </tr>
                                        <tr align="left">
                                            <td align="right" class="tituloCampo">Tipo Equipo:</td>
                                            <td id="tdBusLstTipaEquipo"></td>
                                        </tr>
                                        <tr align="left">
                                            <td align="right" class="tituloCampo">Creiterio:</td>
                                            <td><input type="text" id="textCriterio" name="textCriterio" class="inputHabilitado" size="40"/></td>
                                        </tr>
                                        <tr align="right">
                                            <td colspan="2">
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <a class="modalImg" rel="#divFlotante3" onclick="openImg(this);">
                                    <button id="buttonJefeEquipo" name="buttonJefeEquipo" title="Listar" onclick="xajax_listaEmpleado('','','',document.getElementById('txtIdEmpresa').value+'|'+document.getElementById('comboxTipoEquipo').value+'||'+'asignarJefeEquipo');" type="button" disabled="disabled">
                                        <img src="../img/iconos/ico_pregunta.gif"/>
                                    </button>
                                </a>
                        	</td>
            	 ...
            	 <td colspan="2">
                 	<fieldset>	<legend class="legend">Integrante Equipo</legend>
                    	<table width="100%">
                        	<tr align="left">
                            	<td>
                                <a class="modalImg" id="aAgrIntegrante" rel="#divFlotante3" onclick="validarForm(1);">
...
<div id="divFlotante2" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;" class="root">
	<div id="divFlotanteTitulo2" class="handle">
    	<table><tr><td id="tdFlotanteTitulo2" width="100%">lista Empresas</td></tr></table>
    </div>
...
<div id="divFlotante3" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo3" class="handle"><table><tr><td id="tdTituloJefeEquipo" width="100%">Seleccion Empleado</td></tr></table></div>
        <table border="0" width="760">
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td>
                    <form id="frmEmpleado" name="frmEmpleado" style="margin:0" onsubmit="return false;">
                        <table align="right" border="0">
                            <tr align="left">
                                ...
                                <td>
                                    <input type="text" id="textCriterioBus" name="textCriterioBus" class="inputHabilitado" size="40%" onkeyup="byId('butBuscarCriterio').click();"/>
                                </td>
                            </tr>
                            <tr align="right">
                                <td colspan="2">
                                    <button type="button" id="butBuscarCriterio" name="butBuscarCriterio"
onclick="xajax_buscarEmpleado(xajax.getFormValues('frmEmpleado'),xajax.getFormValues('fomrEquipo'));">Buscar</button>
