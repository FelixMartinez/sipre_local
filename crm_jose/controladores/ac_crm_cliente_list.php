...
function combListModelo(){
	$objResponse = new xajaxResponse();
		...
		$selectModelo .= "<select name=\"listModelo\" id=\"listModelo\" class=\"inputHabilitado\"  onchange=\"byId('btnBuscar').click();\">";
...
//$objResponse->alert($queryLimit);	
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaCliente", "5%", $pageNum, "fecha_nacimiento", $campOrd, $tpOrd, $valBusq, $maxRows, htmlentities("Fecha Nacimiento"));
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" onmouseover=\"this.className='trSobre';\" onmouseout=\"this.className='".$clase."';\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"center\">";
				$htmlTb .= sprintf("<button type=\"button\" id= \"butShowModelo%s\" name=\"butShowModelo\" title=\"Ver Modelo\" onclick=\"mostrarOcultatVehiculo(%s)\" > 
								<img src=\"../img/crm/show_crm.gif\" align=\"right\" title=\"Ver\" class=\"puntero\"  id=\"imgMostrarCliente%s\"/>
				...
				$htmlTb .= sprintf("<button type=\"button\" id=\"butHideModelo%s\" name=\"butHideModelo\" title=\"Ocultar Modelo\" style=\"display:none\" onclick=\"mostrarOcultatVehiculo(%s)\" > 
								<img src=\"../img/crm/hide_crm.gif\" align=\"right\" title=\"Ver\" class=\"puntero\"  id=\"imgMostrarCliente%s\"/>
							</button>",$row['id'],$row['id'],$row['id']);
			$htmlTb .= "</td>";
		$htmlTb .= "</tr>";
