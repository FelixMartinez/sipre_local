...
<head>
	...
	<title>.: Sistema ERP :. .: Módulo de Crm :. - Posibilidad de Cierre</title>
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formPosibilidadCierre(this.id);">
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                <table align="right">			
                    ...
                    <tr align="left">
                        ...
                        <td> <input id="textCriterio" name="textCriterio" class="inputHabilitado" size="45%"/></td>
                    </tr>
                    <tr align="right">
                        <td colspan="2">
    ...
    <tr>
    	<td>
            ...
            <tr align="left">
                ...
                <td><input type="text" id="txtNombre" name="txtNombre" size="45%"/></td>
            </tr>
            <tr align="left">
        ...
        <td>
            <table border="0" width="100%">
                ...
                <tr>
                    <td align="center" class="imgBorde"><img id="imgPosibleCierre" src="../img/logos/logo_gotosystems.jpg" height="100"/></td>
                </tr>
                <tr>
                    <td>
...
xajax_listadoPosibilidadCierre(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>'+'|'+byId('lstEstatusBus').value);
