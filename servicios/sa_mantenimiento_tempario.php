...
unidad_add({
	...
	function guardar($form){
		...
		if($form['precio'] == 0){ return $r->alert("El Precio no puede ser cero"); }						
		if($form['costo'] == 0){ return $r->alert("El costo no puede ser cero"); }
		...
		$sa_tempario->add(new field('codigo_tempario','',field::tString,trim($form['codigo_tempario'])));
		$sa_tempario->add(new field('descripcion_tempario','',field::tString,trim($form['descripcion_tempario'])));
