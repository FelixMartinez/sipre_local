...
<table width="70%" border="0" cellpadding="0" cellspacing="0" style="margin:auto; ">  
  ...
  <tr>
    <td colspan="2"><iframe src="<?php echo sprintf("reportes/sa_imprimir_presupuesto_pdf.php?valBusq=%s|%s|%s", $_GET['id'], $_GET['doc_type'], $_GET['acc']);?>" width="100%" height="800" ></iframe></td>
  </tr>
</table>
</body>
</html>
