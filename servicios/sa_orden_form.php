...
require("controladores/ac_sa_orden_form.php");
...
<link rel="icon" type="image/png" href="../img/login/icono_sipre_png.png" />
	...
	function validarMaximoDescuento(){
		var hddMaximoDescuento = byId('hddMaximoDescuento').value.replace(",","");
		var descuento = byId('txtDescuento').value.replace(",","");
		byId('txtDescuento').value = descuento;

		if(validarMaximoDescuento != ""){
			if(parseFloat(descuento) > parseFloat(hddMaximoDescuento)){
				 byId('txtDescuento').value = hddMaximoDescuento;
				alert("El porcentaje de descuento supera al maximo permitido: "+hddMaximoDescuento+"%");
			}
		}
	...
	function cambiarPorcentajePmu(valor){
		if(valor == ""){//vacio selecciono MANUAL
			if ($('txtPorcentajePmu').readOnly == true){
				xajax_formValidarPermisoEdicion('sa_porcentaje_pmu');
			}
		}
		
		byId('txtPorcentajePmu').value = valor;		
		calcularPmu();
	}
	
	function calcularPmu(){
		txtPorcentajePmu = parseFloat(($('txtPorcentajePmu').value).replace(",", ""));
		txtBasePmu = parseFloat(($('txtBasePmu').value).replace(",", ""));
		
		txtMontoPmu = (txtPorcentajePmu*txtBasePmu)/100;
		if(isNaN(txtMontoPmu)){ txtMontoPmu = 0; }
		
		$('txtMontoPmu').value = txtMontoPmu.toFixed(2);
	}
    ...
    <div id="divGeneralVehiculos" class="print">
        	...
        	<td align="right">
                ...
                <tr>
                    ...
                    <button style="cursor:default; float:left;" class="noprint" onclick="window.print();" type="button"><table cellspacing="0" cellpadding="0" align="center"><tbody><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_print.png"></td><td>&nbsp;</td><td>Imprimir</td></tr></tbody></table></button>
                 	...
                 	<button style="cursor:default; float:left;" class="noprint" onclick="verVentana('reportes/sa_imprimir_presupuesto_pdf.php?valBusq=<?php echo $_GET['id']; ?>|<?php echo $_GET['doc_type']; ?>', 950, 600);" type="button"><table cellspacing="0" cellpadding="0" align="center"><tbody><tr><td>&nbsp;</td><td><img src="../img/iconos/pdf_ico.png"></td><td>&nbsp;</td><td>Exportar</td></tr></tbody></table></button>
                    
                    <?php } } ?>
                    	<!-- <input type="button" name="btnImprimirDoc" id="btnImprimirDoc" value="Imprimir" onclick="verVentana('reportes/sa_imprimir_presupuesto_pdf.php?valBusq=<?php echo $_GET['id']; ?>|<?php echo $_GET['doc_type']; ?>', 950, 600);" style="display:none"/>  -->     
                                     </td>
                    <td>
        ...
        <tr>
            ...
            <form id="frmPresupuesto" name="frmPresupuesto" style="margin:0">
                ...
                <input type="hidden" name="hddMaximoDescuento" id="hddMaximoDescuento" readonly="readonly" />
            	...
            	<?php
					...
					echo "<table class=\"tabla\" width=\"100%\" cellpadding=\"2\" border=\"1\" >";
						...
						echo "<tr align=\"center\">";
							echo "<td>".utf8_encode($rowOrdenInformacion['nombre_creador'])."</td>";
							echo "<td>".fechaComun($rowOrdenInformacion['tiempo_orden'])."</td>";
							echo "<td>".utf8_encode($rowOrdenInformacion['nombre_aprobacion'])."</td>";
					...
					while($row = mysql_fetch_assoc($queryOrdenFactura)){
						...
						echo "<br><table class=\"tabla\" width=\"100%\" cellpadding=\"2\" border=\"1\" >";
							...
							echo "<tr align=\"center\">";
								...
								echo "<td>".utf8_encode($row['nombre_factura'])."</td>";
								echo "<td>".$row['anulada']."</td>";
								echo "<td>".$aplicaLibros."</td>";	
								echo "<td>".utf8_encode($row['nombre_anulacion'])."</td>";
					...
					while($row = mysql_fetch_assoc($queryValeSalida)){
						...
						echo "<tr class=\"tituloColumna\" align=\"center\"><td colspan=\"10\"> INFORMACI&Oacute;N DE VALE DE SALIDA</td></tr>";
							...
							echo "<tr align=\"center\">";
								...
								echo "<td>".utf8_encode($row['nombre_vale'])."</td>";							
								echo "<td>".$estadoVale."</td>";
								echo "<td>".utf8_encode($row['nombre_devolucion'])."</td>";
        ...
        <tr>
            ...
            <form id="frmListaArticulo" name="frmListaArticulo" style="margin:0">
                ...
                <tr align="left">
                    <td width="12%">
						...
						&& validarCampo('lstTipoOrden','t','lista') == true
                            ...
                            $('txtCodigoArticulo0').className = 'inputHabilitado';
                        } else {
                            validarCampo('txtIdValeRecepcion','t','');
                            validarCampo('lstTipoOrden','t','lista');
                ...
                <tr align="center" class="tituloColumna">
                    ...
                    <td width="5%">PMU Unit.</td>
                    <td width="5%">Total PMU</td>
		...
		<tr>
            ...
            <form id="frmListaManoObra" name="frmListaManoObra" style="margin:0">
                ...
                <tr align="center" class="tituloColumna">
                    ...
                    <td width="10%">Subsecci&oacute;n</td>
                    <td width="12%">Código Tempario</td>
                    <td width="26%">Descripción</td>
                    <td width="4%">Origen</td>
                    <td width="6%">Modo</td>
                    <td width="6%">Operador</td>
                    <td width="6%">UT/Precio</td>
                    <td width="6%">% Impuesto</td>
                    <td width="4%">Total S/I</td>
                    <td width="10%">Total</td>
        ...
        <tr>
            ...
            <form id="frmListaTot" name="frmListaTot" style="margin:0">
                ...
                <tr align="center" class="tituloColumna">
                    ...
                    <td width="34%">Proveedor</td>
                    <td width="10%">Tipo Pago</td>
                    <td width="14%">Monto T.O.T</td>
                    <td width="14%">Porcentaje T.O.T</td>
                    <td width="6%">% Impuesto</td>
                    <td width="4%">Total S/I</td>
                    <td width="10%">Total</td>
                ...
                <tr align="left">
                    <td width="12%">
						...
						&& validarCampo('lstTipoOrden','t','lista') == true
                            ...
                            $('impuestoPorNota').innerHTML = '';
                            xajax_cargarImpuestoNota(xajax.getFormValues('frmPresupuesto'));
                            document.forms['frmDatosNotas'].reset();
                                          
                            $('txtDescripcionNota').className = 'inputHabilitado';
                            $('txtPrecioNota').className = 'inputHabilitado';  
                    ...
                    <td rowspan="6" width="60%">
                        ...
                        <tr align="right">
                            ...
                            <td width="14%">
                                ...
                                onblur="
                                if (byId('txtDescuento').readOnly == false) {
                                	setFormatoRafk(this,2);
                                	validarMaximoDescuento();
                                }"
    ...
    <tr>
    	<td>
            ...
            <tr>
                ...
                <td width="68%">
                	<input type="password" id="txtContrasena" name="txtContrasena" size="30" class="inputHabilitado"/>
    ...
    <tr>
        ...
        <form id="frmBuscarVale" name="frmBuscarVale" onsubmit="return false;" style="margin:0">
            ...
            <tr align="left">
                ...
                <td id="tdlstAno"><input type="text" id="txtPalabra" name="txtPalabra" onkeyup="$('btnBuscar').click();" class="inputHabilitado"></td>
                <td>
    ...
    <tr>
        ...
        <form id="frmBuscarPaquete" name="frmBuscarPaquete" style="margin:0" onsubmit="return false;">
            ...
            <tr align="left">
                ...
                <td><input type="text" id="txtDescripcionBusq" name="txtDescripcionBusq" onkeyup="$('btnBuscarPaquete').click();" class="inputHabilitado"></td>
    ...
    <tr>
        ...
        <form id="frmBuscarTempario" name="frmBuscarTempario" style="margin:0" onsubmit=" return false;">
            ...
            <tr>
                ...
                <td><input type="text" id="txtCriterioTemp" name="txtCriterioTemp" class="inputHabilitado"></td>
                <td>
    ...
    <tr>
        ...
        <form id="frmDatosTempario" name="frmDatosTempario" style="margin:0" onsubmit="return false;">
            ...
            <tr align="left">
                ...
                <td style="display:none" align="right" class="tituloCampo">Secci&oacute;n:</td>
                ...
                <td colspan="2" rowspan="4">
                    <table id="impuestoPorTempario" class="noRomper">
                    </table>
                </td>
            </tr>
            <tr align="left">
                ...
                <td style="display:none" align="right" class="tituloCampo">Subsecci&oacute;n:</td>
                <td style="display:none">
    ...
    <tr>
        ...
        <form id="frmBuscarArticulo" name="frmBuscarArticulo" style="margin:0" onsubmit="return false;">
            ...
            <tr>
                ...
                <td width="26%"><input type="text" id="txtDescripcionBusq" name="txtDescripcionBusq" class="inputHabilitado"></td>
            </tr>
            <tr>
    ...
    <tr>
        ...
        <form id="frmDatosArticulo" name="frmDatosArticulo" style="margin:0" onsubmit="return false;">	
            ...
            <tr>
                ...
                <td rowspan="3" valign="top"><textarea id="txtDescripcionArt" name="txtDescripcionArt" rows="4" readonly="readonly" style="width: 95%;"></textarea></td>
                ...
                <td rowspan="4" valign="top">
                	<table id="impuestoPorArticulo" class="noRomper">
                    </table>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
					<table cellpadding="0" cellspacing="0">
					<tr>
                		<td><input type="text" id="txtCantidadArt" name="txtCantidadArt" maxlength="6" onkeypress="return validarSoloNumeros(event);" size="12" style="text-align:right;" class="inputHabilitado"></td>
                        <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td width="36%">
                    ...
                    <tr>
                        ...
                        <td align="right">
                        	...
                        	<input type="text" id="txtPrecioArtRepuesto" name="txtPrecioArtRepuesto" onkeyup="byId('txtBasePmu').value = this.value; calcularPmu();" maxlength="17" onkeypress="return validarSoloNumerosReales(event);" readonly="readonly" size="12" style="text-align:right"/>
						</td>
                        <td>&nbsp;</td>
                ...
                <td width="20%">
                    <table id="tablaPmu" style="display:none;">
                        <tr>
                        	<td width="100" align="right" class="tituloCampo">Porcentaje PMU:</td>
                            <td><input type="text" id="txtPorcentajePmu" name="txtPorcentajePmu" onkeypress="return validarSoloNumerosReales(event);" onkeyup="calcularPmu();" readonly="readonly" size="12"/></td>
                            <td id="tdSelPorcentajePmu"></td>
                        </tr>
                        <tr>
                            <td width="100" align="right" class="tituloCampo">Base PMU:</td>
                        	<td><input type="text" id="txtBasePmu" name="txtBasePmu" onkeypress="return validarSoloNumerosReales(event);" onkeyup="calcularPmu();" readonly="readonly" size="12"/></td>
                            <td width="100" align="right" class="tituloCampo">Total PMU:</td>
                        	<td><input type="text" id="txtMontoPmu" name="txtMontoPmu" readonly="readonly" size="12"/></td>
                        </tr>
                    </table>
...
<form id="frmDatosNotas" name="frmDatosNotas" style="margin:0">
    <table border="0" id="tblNotas" style="display:none;" width="650">
    <tr align="left">
        <td align="right" class="tituloCampo" width="120">Descripción:</td>
        <td><textarea id="txtDescripcionNota" name="txtDescripcionNota" onkeypress="return sinEnterTab(event);" cols="45" rows="5" class="inputHabilitado"></textarea></td>
        <td rowspan="2">
            <table id="impuestoPorNota" class="noRomper">
            </table>
        </td>
    </tr>
    <tr align="left">
        <td align="right" class="tituloCampo">Precio:</td>
        <td><input type="text" id="txtPrecioNota" name="txtPrecioNota" onkeypress="return validarSoloNumerosReales(event);" class="inputHabilitado"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <form id="frmBuscarTot" name="frmBuscarTot" style="margin:0" onsubmit="return false;">
            ...
            <tr align="left">
            	<td width="86%"></td>
                <td align="right" class="tituloCampo" width="14%">Criterio:</td>
                <td><input type="text" id="txtDescripcionBusq" name="txtDescripcionBusq" onkeyup="$('btnBuscarTot').click();" class="inputHabilitado"></td>
    ...
    <tr>
        ...
        <form id="frmDatosTot" name="frmDatosTot" style="margin:0">
            ...
            <tr align="left">
                ...
                <td></td>
                <td rowspan="6">
					<table id="impuestoPorTot" class="noRomper">
                    </table>
                </td>
            </tr>
            <tr align="left">
            ...
            <tr align="left">
                ...
                <td><input type="text" id="txtPorcentaje" name="txtPorcentaje" onkeypress="if($('listadoPorcentajesTot').value == 'MANUALx') { return validarSoloNumerosReales(event); } else { return false; }" onkeyup="calcularTot();" readonly="readonly"/> 
                    <tagEspecial id="cambioPorcentajeTot">
                    </tagEspecial>
...
<form id="frmConfClave" name="frmConfClave" style="margin:0" onsubmit="return false;">
    ...
    <tr align="left">
        ...
        <td width="68%"><input type="password" id="txtContrasenaAcceso" name="txtContrasenaAcceso" size="30" class="inputHabilitado"></td>
    </tr>
    <tr>
        <td align="right" colspan="2">
        	<hr/>
