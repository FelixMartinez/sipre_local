...
//implementando xajax;
	...
	$c->close();
	$registros=array(5=>5,10=>10,20=>20,30=>30,40=>40,60=>60,80=>80,100=>100,200=>200,400=>400,600=>600,800=>800,1000=>1000, 3000=>3000, 5000=>5000);
?>
	...
	<head>
		...
		<script>
            ...
            function exportarExcelSinUnidad(){
				window.open('reportes/sa_informe_tempario_sin_unidad_excel.php?valBusq='+toPaginator(datos),'_self');				
			}
		</script>
	</head>
	<body>
