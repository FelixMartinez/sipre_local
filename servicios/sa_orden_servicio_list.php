...
require("controladores/ac_sa_orden_servicio_list.php");
...
<head>
	...
	function abrirClaveCambioAsesor(idOrden){
		
		$('idOrdenAsesor').value = idOrden;
		$('idEmpleadoNuevo').value = '';
		$('nombreEmpleadoNuevo').value = '';
		byId('divFlotante2').style.display = 'none';
		
		if($('claveCambioAsesorCorrecta').value == 1){//si ya paso la clave no pedirla nuevamente
			xajax_abrirCambioAsesor(idOrden);
		}else{
			$('key2').value= "";
				...
				<tr>
					...
					<td align="center">
                        ...
                        <tr align="left">
                            ...
                            <td>Generar Presupuesto</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/aprobar_presup.png"/></td>
                            ...
                            <td>Edici&oacute;n Orden</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/chart_organisation.png"/></td>
                            <td>Asociar Fallas</td>
                            <td>&nbsp;</td>
...
<div class="window" id="key_window2" style="z-index:100;top:-1000px;left:0px;max-width:400px;min-width:400px;visibility:hidden;border-color:#FEB300;">
	<div class="title" id="title_key_window2" style="background:#FEE8B3;color:#000000;">
		<div class="key_pass" id="key_title2" style="padding-left:24px;">Cambio de Asesor (Apertura Orden)</div>
	</div>
	<div class="content">
		<div class="nohover">
			<table class="insert_table">
			<tbody>
				<tr>
					<td width="30%"  class="label">Clave:</td>
					<td class="field" style="text-align:center;">
                    	<input type="hidden" id="claveCambioAsesorCorrecta" name="claveCambioAsesorCorrecta" value="" />
						<input style="width:95%;border:0px;" type="password" onkeyup="if(event.keyCode == 13) {  xajax_verificarClaveCambioAsesor($('key2').value, $('idOrdenAsesor').value); }" name="key2" id="key2" maxlength="30" onkeypress="" />
					</td>
				</tr>
				<tr>
					<td colspan="2" style="text-align:right;padding:2px;">
						<span style="padding:2px;">
							<button onclick="xajax_verificarClaveCambioAsesor($('key2').value, $('idOrdenAsesor').value);"><img alt="aceptar" src="../img/iconos/select.png" class="image_button" />Aceptar</button>
						</span>
						<span style="padding:2px;">
							<button onclick="$('key_window2').style.display='none';"><img alt="cerrar" src="../img/iconos/delete.png" class="image_button" />Cancelar</button>
						</span>
					</td>
				</tr>
			</tbody>
	...
	<img class="close_window" src="../img/iconos/close_dialog.png" alt="cerrar" title="Cerrar" style="cursor:pointer;" onClick="$('key_window2').style.display='none';" border="0" />
</div>
...
<div class="window root" id="asesor_window" style="z-index:3;top:-1000px;left:0px; min-width: 300px; display: none;">
	<div class="title" id="title_asesor_window">
		Cambio de Asesor (Apertura Orden): #<span id="spanNumeroOrdenAsesor"></span>
	</div>
	<form id="frmAsesor" name="frmAsesor" onsubmit="return false;">
		<table width="100%">
        <tr>
			<td class="tituloCampo" width="120" align="right">Asesor Actual:</td>
            <td id="nombreAsesorActual"></td>
        </tr>
        <tr>
			<td class="tituloCampo" width="120" align="right">Asesor Nuevo:</td>
            <td>
                <input type="hidden" id="idOrdenAsesor" name="idOrdenAsesor" value=""/>
                <input type="text" readonly="readonly" style="width:200px;" id="nombreEmpleadoNuevo">
                <input type="hidden" value="" name="idEmpleadoNuevo" id="idEmpleadoNuevo">
            </td>
            <td>
            	<button type="button" onclick="xajax_listadoEmpleado();" class="puntero"><table cellspacing="0" cellpadding="0" align="center"><tbody><tr><td><img src="../img/iconos/plus.png"></td></tr></tbody></table></button>
			</td>
		</tr>
		</table>		
	</form>
	<table width="100%">
		<tr>
            <td align="right">
                <hr>
                <button onclick="xajax_guardarCambioAsesor(xajax.getFormValues('frmAsesor'));" type="button"><img border="0" alt="save" src="../img/iconos/save.png">Guardar</button>
            </td>
        </tr>
	</table>
	<img class="close_window" src="../img/iconos/close_dialog.png" alt="cerrar" title="Cerrar" style="cursor:pointer;" onClick="$('asesor_window').style.display='none';" border="0" />
</div>

<div class="window" id="fallas_window" style="z-index:3;top:-1000px;left:0px;max-width:800px;min-width:600px;display: none;">
	<div class="title" id="title_fallas_window">
		Asociar Fallas Orden: <span id="spanNumeroOrdenFalla"></span>
	</div>
	<form id="frmFallas" name="frmFallas" onsubmit="return false;">
		<div id="divFallas">
	...
	<table width="100%">
		<tr>
            <td align="right">
                <hr>
                <button onclick="xajax_guardarAsociarFallas(xajax.getFormValues('frmFallas'));" type="button"><img border="0" alt="save" src="../img/iconos/save.png">Guardar</button>
                <!--<input type="button" onclick="$('fallas_window').style.display='none';" value="Cancelar">-->
            </td>
        </tr>
	</table>
	<img class="close_window" src="../img/iconos/close_dialog.png" alt="cerrar" title="Cerrar" style="cursor:pointer;" onClick="$('fallas_window').style.display='none';" border="0" />
</div>


<div style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:3;" class="root" id="divFlotante2">
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="puntero" onclick="xajax_buscarEmpleado(byId('criterioEmpleado').value);"><img border="0" src="../img/iconos/find.png"></button>
                </td>
            </tr>
        </table>
    </div>
    
    <div id="divListadoEmpleado" style="width:600px;"></div>
    
    <div align="right">
        <hr/>
        <button type="button" class="puntero" onclick="byId('divFlotante2').style.display = 'none';">Cancelar</button>
    </div>
</div>
...
var theHandle = document.getElementById("title_key_window2");
var theRoot   = document.getElementById("key_window2");
Drag.init(theHandle, theRoot);
...
var theHandle = document.getElementById("title_fallas_window");
var theRoot   = document.getElementById("fallas_window");
Drag.init(theHandle, theRoot);

var theHandle = document.getElementById("title_asesor_window");
var theRoot   = document.getElementById("asesor_window");
Drag.init(theHandle, theRoot);
