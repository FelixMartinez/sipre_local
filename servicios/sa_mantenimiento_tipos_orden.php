...
function cargar_articulo($id, $mode='view'){
	...
	if($mode!='delete'){
		...
		if($rec){
			...
			$r->assign('porcentaje_pmu','value',$rec->porcentaje_pmu);
...
function guardar($form){
	...
	$save->insert('porcentaje_pmu',$form['porcentaje_pmu'],field::tFloat);
			...
			<table class="insert_table" style="width:auto;">
				<tbody>
                    ...
                    <tr>
						...
						<td class="field" id="field_porcentaje_pmu">
							<input type="text" name="porcentaje_pmu" id="porcentaje_pmu" onKeyPress="return inputFloat(event);" onChange="set_toNumber(this,2);" />
						</td>
					</tr>
                     <tr>
						<td class="label">
