...
require("controladores/ac_sa_cotizacion_form.php");
    ...
    <div id="divGeneralVehiculos" class="print">
        ...
        <tr style="display:none">
        	<td align="right">
                ...
                <tr>
                    <td >
                    	<input type="button" name="btnImprimirDoc" id="btnImprimirDoc" value="Imprimir" onclick="verVentana('reportes/sa_imprimir_presupuesto_pdf.php?valBusq=<?php echo $_GET['id']; ?>|<?php echo $_GET['doc_type']; ?>', 950, 600);" style="display:none" />                    </td>
                    <td >
