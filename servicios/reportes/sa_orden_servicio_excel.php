...
while ($rowMaestro = mysql_fetch_assoc($rsMaestro)) {
	...
	$arrayCol[$contFila][3] = utf8_encode($rowMaestro['nombre_empleado'])." ";
	$arrayCol[$contFila][4] = utf8_encode($rowMaestro['nombre_tecnico']);
	$arrayCol[$contFila][5] = utf8_encode($rowMaestro['nombre_tipo_orden']);
	$arrayCol[$contFila][6] = utf8_encode($rowMaestro['nombre_cliente']);
	$arrayCol[$contFila][7] = utf8_encode($rowMaestro['nom_uni_bas']);
	$arrayCol[$contFila][8] = utf8_encode($rowMaestro['placa']);
	$arrayCol[$contFila][9] = utf8_encode($rowMaestro['chasis']);
	$arrayCol[$contFila][10] = utf8_encode($rowMaestro['nombre_estado']);
	$arrayCol[$contFila][11] = ($rowMaestro['id_orden_retrabajo']);
	$arrayCol[$contFila][12] = $rowMaestro['total_orden'];
	
	// TOTALES
	$arrayTotalPagina[11] += $arrayCol[$contFila][12];
}
...
$excel->download('Listado ordenes de servicios.xls');
