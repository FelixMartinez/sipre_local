...
require('../js/libGraficos/Code/PHP/Includes/FusionCharts.php');
require('../js/libGraficos/Code/PHP/Includes/FC_Colors.php');
...
require("controladores/ac_sa_resumen_cliente.php");
require("controladores/ac_iv_general.php");//empresa final
