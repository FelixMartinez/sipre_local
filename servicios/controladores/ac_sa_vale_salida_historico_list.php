...
function listadoOrdenes($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "fecha_vale", $campOrd, $tpOrd, $valBusq, $maxRows, ("Fecha"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "numero_vale", $campOrd, $tpOrd, $valBusq, $maxRows, ("N° Vale"));
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb.= "<tr class=\"".$clase."\" onmouseover=\"this.className = 'trSobre';\" onmouseout=\"this.className = '".$clase."';\" height=\"22\">";
			...
			//impresion vale pdf
				$htmlTb .= sprintf("<img class=\"puntero\" onclick=\"verVentana('reportes/sa_imprimir_presupuesto_pdf.php?valBusq=%s|2|3', 1000, 500);\" src=\"../img/iconos/ico_print.png\" title=\"Ver PDF Vale de Salida\"/>",
								$row['id_vale_salida']);
