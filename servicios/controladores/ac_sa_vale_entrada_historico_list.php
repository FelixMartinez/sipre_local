...
//		$htmlTh .= "<td colspan=\"2\"></td>";
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "fecha_creada", $campOrd, $tpOrd, $valBusq, $maxRows, ("Fecha"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "numero_vale_entrada", $campOrd, $tpOrd, $valBusq, $maxRows, ("N° Vale Entrada"));
...
//			$htmlTb .= "<td align=\"center\">".$imgEstatusPedido."</td>";
			...
			$htmlTb .= "<td class=\"noprint\" style=\"white-space:nowrap;\">";
				...
				//impresion vale pdf
				$htmlTb .= sprintf("<img class=\"puntero\" onclick=\"verVentana('reportes/sa_devolucion_vale_salida_pdf.php?valBusq=0|%s', 1000, 500);\" src=\"../img/iconos/page_white_acrobat.png\" title=\"Ver PDF Vale de Entrada\"/>",
					$row['id_vale_salida']);
