...
function listadoOrdenes($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "fechaNotaCredito", $campOrd, $tpOrd, $valBusq, $maxRows, ("Fecha NC"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "numeracion_nota_credito", $campOrd, $tpOrd, $valBusq, $maxRows, ("Nº NC"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "numeroFactura", $campOrd, $tpOrd, $valBusq, $maxRows, ("N° Factura"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "numeroControl", $campOrd, $tpOrd, $valBusq, $maxRows, ("N° Control NC"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "tiempo_orden", $campOrd, $tpOrd, $valBusq, $maxRows, ("Fecha Orden"));
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb.= "<tr class=\"".$clase."\" onmouseover=\"this.className = 'trSobre';\" onmouseout=\"this.className = '".$clase."';\" height=\"22\">";
			...
			$htmlTb .= "<td class=\"noprint\" style=\"white-space:nowrap;\">";
				...
				//ver pdf orden
				$htmlTb .= sprintf("<img class=\"puntero\" title=\"Imprimir Orden PDF\" onclick=\"verVentana('reportes/sa_imprimir_presupuesto_pdf.php?valBusq=%s|2|0', 1000, 500); \" src=\"../img/iconos/ico_print.png\"/>",
					$row['id_orden']);

				$htmlTb .= "&nbsp;";
				
				//impresion nota pdf
				$htmlTb .= sprintf("<img class=\"puntero\" onclick=\"verVentana('reportes/sa_devolucion_venta_pdf.php?valBusq=%s', 1000, 500);\" src=\"../img/iconos/page_white_acrobat.png\" title=\"Ver PDF Nota de Credito\"/>",
					$row['idNotaCredito']);
