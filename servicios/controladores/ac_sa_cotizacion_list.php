...
function listadoPresupuestos($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr class=\"".$clase."\">";
			...
			$htmlTb .= sprintf("<td align=\"center\" class=\"noprint\"><img class=\"puntero\" onclick=\"verVentana('reportes/sa_imprimir_presupuesto_pdf.php?valBusq=%s|1', 950, 600);\" src=\"../img/iconos/print.png\" /></td>",
				$row['id_presupuesto']);	
