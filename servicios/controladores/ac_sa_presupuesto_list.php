...
//				$row['id_empresa']);
			...
			$htmlTb .= sprintf("<td class=\"noprint\"><img class=\"puntero\" onclick=\"verVentana('reportes/sa_imprimir_presupuesto_pdf.php?valBusq=%s|1', 950, 600);\" src=\"../img/iconos/print.png\" /></td>",
				$row['id_presupuesto']);
