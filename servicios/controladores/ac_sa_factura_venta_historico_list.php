...
function listadoOrdenes($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "fechaRegistroFactura", $campOrd, $tpOrd, $valBusq, $maxRows, ("Fecha Factura"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "numeroFactura", $campOrd, $tpOrd, $valBusq, $maxRows, ("N° Factura"));
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "5%", $pageNum, "numeroControl", $campOrd, $tpOrd, $valBusq, $maxRows, ("N° Control"));
		...
		$htmlTh .= ordenarCampo("xajax_listadoOrdenes", "10%", $pageNum, "nombre_tipo_orden", $campOrd, $tpOrd, $valBusq, $maxRows, ("Tipo Orden"));
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb.= "<tr class=\"".$clase."\" height=\"22\">";
			...
			$htmlTb .= "<td class=\"noprint\" style=\"white-space:nowrap;\">";
				...
				$htmlTb .= sprintf("<img class=\"puntero\" onclick=\"verVentana('reportes/sa_factura_venta_pdf.php?valBusq=%s', 1000, 500);\" src=\"../img/iconos/page_white_acrobat.png\"  title=\"Ver PDF Factura\"/>",
					$row['idFactura']);
