...
/*	if ($valCadBusq[0] > 0){
	...
	while ($rowTOT = mysql_fetch_assoc($rsLimitTOT)) {
		...
		$htmlTb .= "<tr class=\"".$clase."\">";
			...
			//ver pdf
			$htmlTb .= sprintf("<td %s class=\"noprint puntero\" ><img src='../img/iconos/page_white_acrobat.png' onclick=\"verVentana('reportes/sa_imprimir_registro_compra_pdf.php?valBusq=".$rowTOT['id_orden_tot']."',900,900);\" title='Ver PDF Registro de Compra' /></td>", $display2);
