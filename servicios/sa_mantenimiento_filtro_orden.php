...
require("controladores/ac_sa_mantenimiento_filtro_orden.php");
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="67%">
                        ...
                        <img class="puntero" src="../img/iconos/information.png" title="<?php echo titleItems(); ?>" style="vertical-align: middle;" />
                    </td>
                </tr>
                <tr>
                    <td width="33%" align="right" class="tituloCampo">Edici&oacute;n de Impuesto:</td>
                    <td width="67%">
                        <input type="text" onkeypress="return validarNumeroComa(event);" name="edicionImpuestoItems" id="edicionImpuestoItems"/>
                        <img class="puntero" src="../img/iconos/information.png" title="<?php echo titleItems(); ?>" style="vertical-align: middle;" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"> Nota: Bloqueo de items y Edici&oacute;n de impuesto separados por coma</td>
                </tr>
                <tr>
