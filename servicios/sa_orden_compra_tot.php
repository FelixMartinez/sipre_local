...
require("controladores/ac_sa_orden_compra_tot.php");
require("controladores/ac_iv_general.php");//necesario para el listado de empresa final
                                        ...
                                        <tr>
                                            ...
                                            <td width="250"><b style="font-size:16px;">
                                             <?php                                              
                                                ...
                                                echo $row["numero_tot"];
                                                getBarcode($row["numero_tot"],'reportes/tmp/img_codigo_tot');                                                
                                             ?></b>
                                            </td>
                                            <td align="right">
                                            <?php
                                                echo "<img src='reportes/tmp/img_codigo_tot.png' />";
                                            }
                                            ?>
                                            </td>
                                            <td align="right">
