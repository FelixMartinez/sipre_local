...
<ul class="menu" id="menu">
	<li><a href="index2.php" class="menulink"><table cellpadding="0" cellspacing="0" width="100%"><tr><td><img src="img/erp/resultset_next.png"></td><td>&nbsp;</td><td width="100%"><?php echo utf8_encode("Inicio"); ?></td></tr></table></a></li>
			...
			if (!$rsMenu2) echo mysql_error()."\n\nLine: ".__LINE__;
			$totalRowsMenu2 = mysql_num_rows($rsMenu2);
			if ($totalRowsMenu2 > 0) { ?>
    <li><a href="#" class="menulink"><table cellpadding="0" cellspacing="0" width="100%"><tr><td><img src="img/erp/resultset_next.png"></td><td>&nbsp;</td><td width="100%"><?php echo utf8_encode("Parámetros"); ?></td></tr></table></a>
		<ul>
			<?php
            }
		...
		<ul>
			...
			while ($rowMenu2 = mysql_fetch_assoc($rsMenu2)) {
				switch ($rowMenu2['modulo']) {
					...
					case "cj": $href = (is_dir("caja_vh")) ? "caja_vh" : "cajax3"; break;
